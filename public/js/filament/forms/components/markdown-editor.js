...
var Cd = (o, p) => () => (o && (p = o((o = 0))), p);
var Ke = (o, p) => () => (p || o((p = { exports: {} }).exports, p), p.exports);
var Ed = (o, p, v, C) => {
    if ((p && typeof p == 'object') || typeof p == 'function')
        for (let b of Td(p))
            !Ld.call(o, b) && b !== v && ss(o, b, { get: () => p[b], enumerable: !(C = Sd(p, b)) || C.enumerable });
    return o;
};
...
var We = Ke((Yo, Qo) => {
    (function (o, p) {
        ...
        var o = navigator.userAgent,
            ...
            S = /Edge\/(\d+)/.exec(o),
            s = C || b || S,
            h = s && (C ? document.documentMode || 6 : +(S || b)[1]),
            g = !S && /WebKit\//.test(o),
            T = g && /Qt\/\d+\.\d+/.test(o),
            x = !S && /Chrome\/(\d+)/.exec(o),
            c = x && +x[1],
        ...
        function oe(e, t) {
            var n;
            return Object.create ? (n = Object.create(e)) : ((fe.prototype = e), (n = new fe())), t && ge(t, n), n;
        }
        var Ue =
            /[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/;
        function we(e) {
            return /\w/.test(e) || (e > '\x80' && (e.toUpperCase() != e.toLowerCase() || Ue.test(e)));
        }
        function Me(e, t) {
            return t ? (t.source.indexOf('\\w') > -1 && we(e) ? !0 : t.test(e)) : we(e);
        }
        function Le(e) {
        ...
        var It = (function () {
            ...
            return function (m, A) {
                ...
                for (var J = m.length, Y = [], ie = 0; ie < J; ++ie) Y.push(n(m.charCodeAt(ie)));
                ...
                for (var _e = 0, be = P; _e < J; ++_e) {
                    var Ce = Y[_e];
                    Ce == '1' && be == 'r' ? (Y[_e] = 'n') : a.test(Ce) && ((be = Ce), Ce == 'r' && (Y[_e] = 'R'));
                }
                for (var Ne = 1, Ie = Y[0]; Ne < J - 1; ++Ne) {
                    var $e = Y[Ne];
                    $e == '+' && Ie == '1' && Y[Ne + 1] == '1'
                        ? (Y[Ne] = '1')
                        : $e == ',' && Ie == Y[Ne + 1] && (Ie == '1' || Ie == 'n') && (Y[Ne] = Ie),
                        (Ie = $e);
                }
                for (var Ve = 0; Ve < J; ++Ve) {
                    ...
                    if (vt == ',') Y[Ve] = 'N';
                        ...
                        for (
                            var Ot = (Ve && Y[Ve - 1] == '!') || (rt < J && Y[rt] == '1') ? '1' : 'N', At = Ve;
                            At < rt;
                            ++At
                        )
                            Y[At] = Ot;
                ...
                return (
                    A == 'ltr' &&
                        (St[0].level == 1 &&
                            (rr = m.match(/^\s+/)) &&
                            ((St[0].from = rr[0].length), St.unshift(new f(0, 0, rr[0].length))),
                        ce(St).level == 1 &&
                            (rr = m.match(/\s+$/)) &&
                            ((ce(St).to -= rr[0].length), St.push(new f(0, J - rr[0].length, J)))),
                    A == 'rtl' ? St.reverse() : St
                );
            };
        })();
        ...
        function ei(e) {
            if (Br == null) {
                ...
                V(e, _('span', [t, document.createTextNode('x')])),
                    e.firstChild.offsetHeight != 0 && (Br = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(s && h < 8));
            }
            var n = Br
                ? _('span', '\u200B')
                : _('span', '\xA0', null, 'display: inline-block; width: 1px; margin-right: -1px');
...
`,
        ...
        var Wr = {},
            Kt = {};
        function Gt(e, t) {
            arguments.length > 2 && (t.dependencies = Array.prototype.slice.call(arguments, 2)), (Wr[e] = t);
        }
        function Cr(e, t) {
            Kt[e] = t;
        }
        function Ur(e) {
            if (typeof e == 'string' && Kt.hasOwnProperty(e)) e = Kt[e];
                ...
                var t = Kt[e.name];
                typeof t == 'string' && (t = { name: t }), (e = oe(t, e)), (e.name = t.name);
            } else {
                if (typeof e == 'string' && /^[\w\-]+\/[\w\-]+\+xml$/.test(e)) return Ur('application/xml');
                if (typeof e == 'string' && /^[\w\-]+\/[\w\-]+\+json$/.test(e)) return Ur('application/json');
            }
            ...
            (at.prototype.column = function () {
                return (
                    this.lastColumnPos < this.start &&
                        ...
                        (this.lastColumnPos = this.start)),
                    this.lastColumnValue - (this.lineStart ? Oe(this.string, this.lineStart, this.tabSize) : 0)
                );
            }),
        ...
        function ne(e, t, n) {
            if ((n === void 0 && (n = null), !(this instanceof ne))) return new ne(e, t, n);
        ...
        function Re(e, t) {
            ...
            return t.line > n ? ne(n, Ae(e, n).text.length) : Sc(t, Ae(e, t.line).text.length);
        }
        function Sc(e, t) {
            var n = e.ch;
        ...
        (Jt.prototype.lookAhead = function (e) {
            ...
            (Jt.fromSaved = function (e, t, n) {
                return t instanceof ri ? new Jt(e, Vt(e.mode, t.state), n, t.lookAhead) : new Jt(e, Vt(e.mode, t), n);
            }),
                        ...
                        (n.state = !0),
                            va(
                                ...
                                function (Y, ie) {
                                    for (var ue = P; J < Y; ) {
                                        var me = i[P];
                                        me > Y && i.splice(P, 1, Y, i[P + 1], me), (P += 2), (J = Math.min(Y, me));
                                    }
                                    if (ie)
                                        if (A.opaque) i.splice(ue, P - ue, Y, 'overlay ' + ie), (P = ue + 2);
                                        else
                                            for (; ue < P; ue += 2) {
                                                var ve = i[ue + 1];
        ...
        function da(e, t, n) {
            if (!t.styles || t.styles[0] != e.state.modeGen) {
                var r = wn(e, k(t)),
                    i = t.text.length > e.options.maxHighlightLength && Vt(e.doc.mode, r.state),
                    a = fa(e, t, r);
                i && (r.state = i),
        ...
        function ro(e, t, n, r) {
            ...
            for (a.start = a.pos = r || 0, t == '' && pa(i, n.state); !a.eol(); ) no(i, a, n.state), (a.start = a.pos);
        }
        function pa(e, t) {
        ...
        function ga(e, t, n, r) {
            ...
            for (r && (A = []); (r || m.pos < t.ch) && !m.eol(); )
                (m.start = m.pos), (l = no(a, m, f.state)), r && A.push(new ha(m, l, Vt(i.mode, f.state)));
            ...
            for (t == '' && ma(pa(n, r.state), a); !A.eol(); ) {
                if (
                    (A.pos > e.options.maxHighlightLength
                        ? ((u = !1), l && ro(e, t, r, A.pos), (A.pos = t.length), (P = null))
        ...
        function Tc(e, t, n) {
            for (var r, i, a = e.doc, l = n ? -1 : t - (e.doc.mode.innerMode ? 1e3 : 100), u = t; u > l; --u) {
                ...
                var f = Ae(a, u - 1),
                    m = f.stateAfter;
                if (m && (!n || u + (m instanceof ri ? m.lookAhead : 0) <= a.modeFrontier)) return u;
            ...
            if (e)
                for (var i = 0; i < e.length; ++i) {
                    ...
                    if (u || (a.from == t && l.type == 'bookmark' && (!n || a.marker.insertLeft))) {
                        ...
                        (r || (r = [])).push(new ni(l, f ? null : a.from - t, a.to == null ? null : a.to - t));
                    }
                }
            return r;
        }
            ...
            if (!m) {
                ...
                if (_e > 0 && u)
                    for (var Ce = 0; Ce < u.length; ++Ce)
                        u[Ce].to == null && (be || (be = [])).push(new ni(u[Ce].marker, null, null));
                ...
                (e.iter(t.line, n.line + 1, function (Y) {
                    if (Y.markedSpans)
                        for (var ie = 0; ie < Y.markedSpans.length; ++ie) {
                            ...
                            ue.readOnly && (!r || Se(r, ue) == -1) && (r || (r = [])).push(ue);
                        }
                }),
                !r)
            )
                ...
                for (var l = r[a], u = l.find(0), f = 0; f < i.length; ++f) {
                    ...
                    if (!(ye(m.to, u.from) < 0 || ye(m.from, u.to) > 0)) {
                        ...
                        (P < 0 || (!l.inclusiveLeft && !P)) && A.push({ from: m.from, to: u.from }),
                            (J > 0 || (!l.inclusiveRight && !J)) && A.push({ from: u.to, to: m.to }),
                            i.splice.apply(i, A),
                            (f += A.length - 3);
                    }
                }
                ...
                for (var u = 0; u < l.length; ++u) {
                    ...
                    if (f.marker.collapsed) {
                        ...
                        if (
                            !((A >= 0 && P <= 0) || (A <= 0 && P >= 0)) &&
                            ((A <= 0 &&
                                (f.marker.inclusiveRight && i.inclusiveLeft ? ye(m.to, n) >= 0 : ye(m.to, n) > 0)) ||
                                (A >= 0 &&
        ...
        function Nc(e) {
            for (var t, n; (t = ai(e)); ) (e = t.find(1, !0).line), (n || (n = [])).push(e);
            return n;
        }
        function ao(e, t) {
            var n = Ae(e, t),
            ...
            if (n) {
                for (var r = void 0, i = 0; i < n.length; ++i)
                    if (((r = n[i]), !!r.marker.collapsed)) {
                        ...
                        if (!r.marker.widgetNode && r.from == 0 && r.marker.inclusiveLeft && lo(e, t, r)) return !0;
                    }
            }
        }
        function lo(e, t, n) {
        ...
        function Ca(e, t) {
            ...
            for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
                ...
                (r.pos = 0),
                    (r.addToken = Bc),
                    pr(e.display.measure) && (l = Pe(a, e.doc.direction)) && (r.addToken = Uc(r.addToken, l)),
                    (r.map = []);
                var u = t != e.display.externalMeasured && k(a);
                $c(a, r, da(e, a, u)),
                    a.styleClasses &&
                        (a.styleClasses.bgClass && (r.bgClass = xe(a.styleClasses.bgClass, r.bgClass || '')),
                        a.styleClasses.textClass && (r.textClass = xe(a.styleClasses.textClass, r.textClass || ''))),
                    r.map.length == 0 && r.map.push(0, 0, r.content.appendChild(ei(e.display.measure))),
                    i == 0
            ...
            return (
                ...
                r.pre.className && (r.textClass = xe(r.pre.className, r.textClass || '')),
                r
            );
        }
        function Hc(e) {
                ...
                if (!f.test(t))
                    ...
                    for (var P = 0; ; ) {
                        ...
                        if (Y) {
                            ...
                            s && h < 9 ? A.appendChild(_('span', [ie])) : A.appendChild(ie),
...
`
                                ? ((ue = A.appendChild(
                                      _('span', J[0] == '\r' ? '\u240D' : '\u2424', 'cm-invalidchar')
                                  )),
                                  ue.setAttribute('cm-text', J[0]),
                                  (e.col += 1))
                                : ((ue = e.cm.options.specialCharPlaceholder(J[0])),
                                  ue.setAttribute('cm-text', J[0]),
                                  s && h < 9 ? A.appendChild(_('span', [ue])) : A.appendChild(ue),
                                  (e.col += 1));
                ...
                if (((e.trailingSpace = u.charCodeAt(t.length - 1) == 32), n || r || i || m || a || l)) {
                    ...
                    if (l)
                        for (var Ce in l)
                            l.hasOwnProperty(Ce) && Ce != 'style' && Ce != 'class' && be.setAttribute(Ce, l[Ce]);
        ...
        function Uc(e, t) {
            return function (n, r, i, a, l, u, f) {
                ...
                for (var m = n.pos, A = m + r.length; ; ) {
                    for (var P = void 0, J = 0; J < t.length && ((P = t[J]), !(P.to > m && P.from <= m)); J++);
        ...
        function $c(e, t, n) {
            var r = e.markedSpans,
                ...
                a = 0;
            if (!r) {
                for (var l = 1; l < n.length; l += 2) t.addToken(t, i.slice(a, (a = n[l])), La(n[l + 1], t.cm.options));
                return;
            }
            for (var u = i.length, f = 0, m = 1, A = '', P, J, Y = 0, ie, ue, me, ve, _e; ; ) {
                if (Y == f) {
                    (ie = ue = me = J = ''), (_e = null), (ve = null), (Y = 1 / 0);
                    for (var be = [], Ce = void 0, Ne = 0; Ne < r.length; ++Ne) {
                        var Ie = r[Ne],
                            $e = Ie.marker;
                        if ($e.type == 'bookmark' && Ie.from == f && $e.widgetNode) be.push($e);
                        else if (
                            Ie.from <= f &&
                            (Ie.to == null || Ie.to > f || ($e.collapsed && Ie.to == f && Ie.from == f))
                        ) {
                            if (
                                (Ie.to != null && Ie.to != f && Y > Ie.to && ((Y = Ie.to), (ue = '')),
                                $e.className && (ie += ' ' + $e.className),
                                $e.css && (J = (J ? J + ';' : '') + $e.css),
                                $e.startStyle && Ie.from == f && (me += ' ' + $e.startStyle),
                                $e.endStyle && Ie.to == Y && (Ce || (Ce = [])).push($e.endStyle, Ie.to),
                                $e.title && ((_e || (_e = {})).title = $e.title),
                                $e.attributes)
                            )
                                for (var Ve in $e.attributes) (_e || (_e = {}))[Ve] = $e.attributes[Ve];
                            $e.collapsed && (!ve || oo(ve.marker, $e) < 0) && (ve = Ie);
                        } else Ie.from > f && Y > Ie.from && (Y = Ie.from);
                    }
                    if (Ce) for (var vt = 0; vt < Ce.length; vt += 2) Ce[vt + 1] == Y && (ue += ' ' + Ce[vt]);
                    if (!ve || ve.from == f) for (var rt = 0; rt < be.length; ++rt) Ea(t, 0, be[rt]);
                    if (ve && (ve.from || 0) == f) {
                        if ((Ea(t, (ve.to == null ? u + 1 : ve.to) - f, ve.marker, ve.from == null), ve.to == null))
                            return;
                        ve.to == f && (ve = !1);
                    }
                }
                ...
                for (var Ot = Math.min(u, Y); ; ) {
                    if (A) {
                        ...
                        if (!ve) {
                            ...
                            t.addToken(t, ut, P ? P + ie : ie, me, f + ut.length == Y ? ue : '', J, _e);
                        }
                        if (At >= Ot) {
                            (A = A.slice(Ot - f)), (f = Ot);
                            break;
        ...
        var Yr = null;
        function Kc(e) {
            Yr ? Yr.ops.push(e) : (e.ownsGroup = Yr = { ops: [e], delayedCallbacks: [] });
        }
        function Gc(e) {
        ...
        function ht(e, t) {
            ...
            if (n.length) {
                var r = Array.prototype.slice.call(arguments, 2),
                    i;
                Yr ? (i = Yr.delayedCallbacks) : Tn ? (i = Tn) : ((i = Tn = []), setTimeout(Xc, 0));
                for (
                    var a = function (u) {
                            i.push(function () {
        ...
        function uo(e, t) {
            Yc(e, t),
                t.line.wrapClass ? (Ln(t).className = t.line.wrapClass) : t.node != t.text && (t.node.className = '');
        ...
        function qa(e, t, n) {
            if ((Ia(e, t.line, t, n, !0), t.rest)) for (var r = 0; r < t.rest.length; r++) Ia(e, t.rest[r], t, n, !1);
        }
        function Ia(e, t, n, r, i) {
            if (t.widgets)
                for (var a = Ln(n), l = 0, u = t.widgets; l < u.length; ++l) {
                    var f = u[l],
                        m = _('div', [f.node], 'CodeMirror-linewidget' + (f.className ? ' ' + f.className : ''));
        ...
        function Na(e, t, n) {
            ...
            if (e.rest) {
                ...
                for (var i = 0; i < e.rest.length; i++)
                    if (k(e.rest[i]) > n) return { map: e.measure.maps[i], cache: e.measure.caches[i], before: !0 };
            }
        }
        function rf(e, t) {
            t = Zt(t);
        ...
        function Qr(e, t) {
            var n = k(t),
                r = po(e, n);
            r && !r.text ? (r = null) : r && r.changes && (Ma(e, r, n, bo(e)), (e.curOp.forceUpdate = !0)),
                r || (r = rf(e, t));
            var i = Na(r, t, n);
        ...
        function of(e, t, n, r) {
            ...
            if (a.nodeType == 3) {
                for (var A = 0; A < 4; A++) {
                    ...
                    for (; i.coverStart + u < i.coverEnd && W(t.line.text.charAt(i.coverStart + u)); ) ++u;
                    if (
            ...
            if (s && h < 9 && !l && (!m || (!m.left && !m.right))) {
                ...
                J ? (m = { left: J.left, right: J.left + Jr(e.display), top: J.top, bottom: J.bottom }) : (m = Pa);
            }
            for (
            ...
            return (
                ...
                e.options.singleCursorHeightPerLine || ((Ce.rtop = Y), (Ce.rbottom = ie)),
                Ce
            );
        }
        function af(e, t) {
            if (!window.screen || screen.logicalXDPI == null || screen.logicalXDPI == screen.deviceXDPI || !to(e))
                return t;
        ...
        function ci(e, t, n, r, i) {
            ...
            r || (r = 'local');
            var l = ar(t);
            if ((r == 'local' ? (l += ui(e.display)) : (l -= e.display.viewOffset), r == 'page' || r == 'window')) {
                var u = e.display.lineSpace.getBoundingClientRect();
                l += u.top + (r == 'window' ? 0 : Wa(L(e)));
                var f = u.left + (r == 'window' ? 0 : Ba(L(e)));
                (n.left += f), (n.right += f);
            }
        ...
        function Xt(e, t, n, r, i, a) {
            ...
            function l(ie, ue) {
                ...
                return ue ? (me.left = me.right) : (me.right = me.left), ci(e, r, me, n);
            }
        ...
        function mo(e, t, n) {
            var r = e.doc;
            if (((n += e.display.viewOffset), n < 0)) return go(r.first, 0, null, -1, -1);
            var i = O(r, n),
                a = r.first + r.size - 1;
            if (i > a) return go(r.first + r.size - 1, Ae(r, a).text.length, null, 1, 1);
            t < 0 && (t = 0);
            for (var l = Ae(r, i); ; ) {
                var u = lf(e, l, i, t, n),
        ...
        function lf(e, t, n, r, i) {
                ...
                ie = De(
                    function (Ne) {
                        ...
                        return (
                            (Ie.top += l),
                            (Ie.bottom += l),
                            vo(Ie, r, i, !1) ? (Ie.top <= i && Ie.left <= r && ((J = Ne), (Y = Ie)), !0) : !1
                        );
                    },
                    u,
                    f
            ...
            if (Y) {
                var _e = r - Y.left < Y.right - r,
                    be = _e == m;
                (ie = J + (be ? 0 : 1)), (me = be ? 'after' : 'before'), (ue = _e ? Y.left : Y.right);
            } else {
                !m && (ie == f || ie == u) && ie++,
                    (me =
                        ie == 0
        ...
        function sf(e, t, n, r, i, a, l) {
            var u = De(
                    function (P) {
                        var J = i[P],
                            Y = J.level != 1;
                        return vo(Xt(e, ne(n, Y ? J.to : J.from, Y ? 'before' : 'after'), 'line', t, r), a, l, !0);
                    },
                    0,
                    i.length - 1
                ),
            ...
            if (u > 0) {
                var m = f.level != 1,
                    A = Xt(e, ne(n, m ? f.from : f.to, m ? 'after' : 'before'), 'line', t, r);
        ...
        function uf(e, t, n, r, i, a, l) {
            ...
            for (var A = null, P = null, J = 0; J < i.length; J++) {
                ...
                if (!(Y.from >= m || Y.to <= f)) {
                    var ie = Y.level != 1,
                        ue = tr(e, r, ie ? Math.min(m, Y.to) - 1 : Math.max(f, Y.from)).right,
        ...
        function Vr(e) {
            ...
            if (zr == null) {
                ...
                for (var t = 0; t < 49; ++t) zr.appendChild(document.createTextNode('x')), zr.appendChild(_('br'));
        ...
        function Za(e) {
            var t = Vr(e.display),
                ...
                r = n && Math.max(5, e.display.scroller.clientWidth / Jr(e.display) - 3);
            return function (i) {
        ...
        function Mr(e, t, n, r) {
            ...
            if (r && f.xRel > 0 && (m = Ae(e.doc, f.line).text).length == f.ch) {
                ...
                f = ne(f.line, Math.max(0, Math.round((a - Fa(e.display).left) / Jr(e.display)) - A));
            }
            return f;
        }
        function Ar(e, t) {
        ...
        function zt(e, t, n, r) {
            ...
            if (
                ...
                or && Ta(e.doc, n + r) > i.viewFrom ? br(e) : ((i.viewFrom += r), (i.viewTo += r));
            else if (t <= i.viewFrom && n >= i.viewTo) br(e);
            else if (t <= i.viewFrom) {
                var a = di(e, n, n + r, 1);
                a ? ((i.view = i.view.slice(a.index)), (i.viewFrom = a.lineN), (i.viewTo += r)) : br(e);
            } else if (n >= i.viewTo) {
                var l = di(e, t, t, -1);
        ...
        function _o(e, t, n) {
            ...
            if (r.other) {
                var u = n.appendChild(_('div', '\xA0', 'CodeMirror-cursor CodeMirror-secondarycursor'));
                (u.style.display = ''),
            ...
            function P(be, Ce, Ne) {
                ...
                function Ot(ut, Dt, yt) {
                    var ft = Ga(e, Ie, null, ut),
                        ...
                        lt = yt == 'after' ? ft.begin : ft.end - (/\s/.test(Ie.text.charAt(ft.end - 1)) ? 2 : 1);
                    return rt(lt, ct)[ct];
                }
                ...
                (t.cursorDiv.style.visibility = ''),
                    e.options.cursorBlinkRate > 0
                        ? (t.blinker = setInterval(function () {
                              e.hasFocus() || en(e), (t.cursorDiv.style.visibility = (n = !n) ? '' : 'hidden');
        ...
        function en(e, t) {
            e.state.delayingBlurEvent ||
                (e.state.focused &&
                    (it(e, 'blur', e, t), (e.state.focused = !1), Q(e.display.wrapper, 'CodeMirror-focused')),
                ...
                if (!u.hidden) {
                    if (((i += u.line.height), s && h < 8)) {
                        ...
                        (m = J.bottom - J.top),
                            !f &&
                                u.text.firstChild &&
                                (A = u.text.firstChild.getBoundingClientRect().right - J.left - 1);
                    }
                    var Y = u.line.height - m;
                    if ((Y > 0.005 || Y < -0.005) && (i < r && (a -= Y), jt(u.line, m), Va(u.line), u.rest))
        ...
        function gi(e, t, n) {
            ...
            if (n && n.ensure) {
                ...
                u < a
                    ...
                    : Math.min(f, t.lastLine()) >= l && ((a = O(t, ar(Ae(t, f)) - e.wrapper.clientHeight)), (l = f));
            }
        ...
        function pf(e, t, n, r) {
            ...
            !e.options.lineWrapping &&
                ...
                (t = t.ch ? ne(t.line, t.sticky == 'before' ? t.ch - 1 : t.ch, 'after') : t));
            for (var a = 0; a < 5; a++) {
                var l = !1,
                    u = Xt(e, t),
                    f = !n || n == t ? u : Xt(e, n);
                ...
                var m = To(e, i),
                    ...
                    P = e.doc.scrollLeft;
                if (
                    (m.scrollTop != null && (An(e, m.scrollTop), Math.abs(e.doc.scrollTop - A) > 1 && (l = !0)),
                    m.scrollLeft != null && (Dr(e, m.scrollLeft), Math.abs(e.doc.scrollLeft - P) > 1 && (l = !0)),
                    !l)
                )
                    break;
            }
        ...
        function hf(e, t) {
            var n = To(e, t);
            n.scrollTop != null && An(e, n.scrollTop), n.scrollLeft != null && Dr(e, n.scrollLeft);
        }
        function To(e, t) {
            var n = e.display,
                r = Vr(e.display);
            ...
            var P = e.options.fixedGutter ? 0 : n.gutters.offsetWidth,
                J = e.curOp && e.curOp.scrollLeft != null ? e.curOp.scrollLeft : n.scroller.scrollLeft - P,
            ...
            return (
                ...
                t.left < 10
                    ...
                    : t.left < J
                      ...
                      : t.right > Y + J - 3 && (l.scrollLeft = t.right + (ie ? 0 : 10) - Y),
                l
            );
        }
        function Lo(e, t) {
            t != null &&
                (mi(e), (e.curOp.scrollTop = (e.curOp.scrollTop == null ? e.doc.scrollTop : e.curOp.scrollTop) + t));
        }
        function tn(e) {
            mi(e);
            var t = e.getCursor();
        ...
        function An(e, t) {
            Math.abs(e.doc.scrollTop - t) < 2 || (v || Eo(e, { top: t }), el(e, t, !0), v && Eo(e), In(e, 100));
        }
        function el(e, t, n) {
        ...
        var qr = function (e, t, n) {
            ...
            (r.tabIndex = i.tabIndex = -1),
                ...
                s && h < 8 && (this.horiz.style.minHeight = this.vert.style.minWidth = '18px');
        };
        ...
        function nl(e) {
            e.display.scrollbars &&
                ...
                e.display.scrollbars.addClass && Q(e.display.wrapper, e.display.scrollbars.addClass)),
        ...
        function bf(e) {
            ...
            Sf(t),
                ...
                (e.update =
                    e.mustUpdate &&
                    new vi(t, e.mustUpdate && { top: e.scrollTop, ensure: e.scrollToPos }, e.forceUpdate));
        }
        function yf(e) {
        ...
        function _f(e) {
            ...
            e.preparedSelection && t.display.input.showSelection(e.preparedSelection, n),
                (e.updatedDisplay || e.startHeight != t.doc.height) && rn(t, e.barMeasure),
        ...
        function kf(e) {
            ...
            if (
                ...
                var i = pf(t, Re(r, e.scrollToPos.from), Re(r, e.scrollToPos.to), e.scrollToPos.margin);
                df(t, i);
            }
            var a = e.maybeHiddenMarkers,
                l = e.maybeUnhiddenMarkers;
            if (a) for (var u = 0; u < a.length; ++u) a[u].lines.length || it(a[u], 'hide');
            if (l) for (var f = 0; f < l.length; ++f) l[f].lines.length && it(l[f], 'unhide');
        ...
        function In(e, t) {
            e.doc.highlightFrontier < e.display.viewTo && e.state.highlight.set(t, Ee(wf, e));
        }
        function wf(e) {
            var t = e.doc;
            if (!(t.highlightFrontier >= e.display.viewTo)) {
                ...
                t.iter(r.line, Math.min(t.first + t.size, e.display.viewTo + 500), function (a) {
                    if (r.line >= e.display.viewFrom) {
                        var l = a.styles,
                            u = a.text.length > e.options.maxHighlightLength ? Vt(t.mode, r.state) : null,
                            f = fa(e, a, r, !0);
        ...
        function Co(e, t) {
            ...
            cf(e, a, l), (n.viewOffset = ar(Ae(e.doc, n.viewFrom))), (e.display.mover.style.top = n.viewOffset + 'px');
            var f = Xa(e);
            if (
                !u &&
                f == 0 &&
            ...
            return (
                ...
                u && ((n.lastWrapHeight = t.wrapperHeight), (n.lastWrapWidth = t.wrapperWidth), In(e, 400)),
        ...
        function il(e, t) {
            for (var n = t.viewport, r = !0; ; r = !1) {
                if (!r || !e.options.lineWrapping || t.oldDisplayWidth == Er(e)) {
                    if (
                        (n && n.top != null && (n = { top: Math.min(e.doc.height + co(e.display) - fo(e), n.top) }),
            ...
            for (var f = r.view, m = r.viewFrom, A = 0; A < f.length; A++) {
                ...
                if (!P.hidden)
                    if (!P.node || P.node.parentNode != a) {
                        ...
                        P.changes && (Se(P.changes, 'gutter') > -1 && (Y = !1), Ma(e, P, m, n)),
                            Y && (j(P.lineNumber), P.lineNumber.appendChild(document.createTextNode(he(e.options, m)))),
        ...
        function Mo(e, t) {
            (e.display.sizer.style.minHeight = t.docHeight + 'px'),
                ...
                (e.display.gutters.style.height = t.docHeight + e.display.barHeight + er(e) + 'px');
        }
        function ol(e) {
            var t = e.display,
                n = t.view;
        ...
        function Ef(e, t, n, r) {
            ...
            (this.input = n),
                ...
                (i.selectionDiv = _('div', null, null, 'position: relative; z-index: 1')),
            ...
            (i.mover = _('div', [a], null, 'position: relative')),
                ...
                (i.sizerWidth = null),
                (i.heightForcer = _('div', null, null, 'position: absolute; height: ' + je + 'px; width: 1px;')),
                (i.gutters = _('div', null, 'CodeMirror-gutters')),
                (i.lineGutter = null),
                (i.scroller = _('div', [i.sizer, i.heightForcer, i.gutters], 'CodeMirror-scroll')),
                i.scroller.setAttribute('tabIndex', '-1'),
                (i.wrapper = _('div', [i.scrollbarFiller, i.gutterFiller, i.scroller], 'CodeMirror')),
                x && c >= 105 && (i.wrapper.style.clipPath = 'inset(0px)'),
                i.wrapper.setAttribute('translate', 'no'),
                s && h < 8 && ((i.gutters.style.zIndex = -1), (i.scroller.style.paddingRight = 0)),
        ...
        function ul(e, t) {
            ...
            if ((r && f) || (i && m)) {
                ...
                if (i && a != null) {
                    ...
                    Y < 0 ? (ie = Math.max(0, ie + Y - 50)) : (ue = Math.min(e.doc.height, ue + Y + 50)),
                          ...
                          setTimeout(function () {
                              if (l.wheelStartX != null) {
                                  var me = u.scrollLeft - l.wheelStartX,
                                      ...
                                      _e = (ve && l.wheelDY && ve / l.wheelDY) || (me && l.wheelDX && me / l.wheelDX);
        ...
        function xr(e) {
            return e.text
                ? ne(e.from.line + e.text.length - 1, ce(e.text).length + (e.text.length == 1 ? e.from.ch : 0))
                : e.to;
        }
        function cl(e, t) {
        ...
        function fl(e, t, n) {
            return e.line == t.line ? ne(n.line, e.ch - t.ch + n.ch) : ne(n.line + (e.line - t.line), e.ch);
        }
        function Mf(e, t, n) {
        ...
        function Io(e, t, n, r) {
            ...
            function l(_e, be) {
                for (var Ce = [], Ne = _e; Ne < be; ++Ne) Ce.push(new Xr(m[Ne], i(Ne), r));
                return Ce;
            }
            var u = t.from,
                f = t.to,
            ...
            if (t.full) e.insert(0, l(0, m.length)), e.remove(m.length, e.size - m.length);
                ...
                a(P, P.text, Y), ie && e.remove(u.line, ie), ue.length && e.insert(u.line, ue);
            } else if (A == P)
                if (m.length == 1) a(A, A.text.slice(0, u.ch) + J + A.text.slice(f.ch), Y);
                else {
                ...
                a(A, A.text.slice(0, u.ch) + m[0] + P.text.slice(f.ch), i(0)), e.remove(u.line + 1, ie);
            else {
                a(A, A.text.slice(0, u.ch) + m[0], i(0)), a(P, J + P.text.slice(f.ch), Y);
        ...
        function Df(e, t) {
            ...
            if (e.done.length > 1 && !e.done[e.done.length - 2].ranges) return e.done.pop(), ce(e.done);
        }
        function ml(e, t, n, r) {
            var i = e.history;
            i.undone.length = 0;
            ...
            if (
                ...
                (u = ce(l.changes)),
                    ye(t.from, t.to) == 0 && ye(t.from, u.to) == 0 ? (u.to = xr(t)) : l.changes.push(Fo(e, t));
            else {
                var f = ce(i.done);
                for (
        ...
        function If(e, t, n, r) {
            ...
            (a &&
                i.lastSelOrigin == a &&
                ((i.lastModTime == i.lastSelTime && i.lastOrigin == a) || qf(e, a, ce(i.done), t)))
        ...
        function Of(e, t, n) {
            var r = {
                ...
                update: function (i) {
                    this.ranges = [];
                    for (var a = 0; a < i.length; a++) this.ranges[a] = new Ye(Re(e, i[a].anchor), Re(e, i[a].head));
                },
                origin: n && n.origin,
            };
            return (
        ...
        function ki(e, t, n) {
            (Ft(e, 'beforeSelectionChange') || (e.cm && Ft(e.cm, 'beforeSelectionChange'))) && (t = Of(e, t, n));
            var r = (n && n.bias) || (ye(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1);
            kl(e, Sl(e, t, r, !0)),
                !(n && n.scroll === !1) && e.cm && e.cm.getOption('readOnly') != 'nocursor' && tn(e.cm);
        }
        function kl(e, t) {
            t.equals(e.sel) ||
                ((e.sel = t),
                e.cm && ((e.cm.curOp.updateInput = 1), (e.cm.curOp.selectionChanged = !0), Ht(e.cm)),
                    ...
                    if (
                        ...
                        if (n) {
                            var P = f.find(r < 0 ? 1 : -1),
                                J = void 0;
                            if (
                                ((r < 0 ? A : m) && (P = Tl(e, P, -r, P && P.line == t.line ? a : null)),
                                P && P.line == t.line && (J = ye(P, n)) && (r < 0 ? J < 0 : J > 0))
                            )
                                return on(e, P, t, r, i);
                        }
        ...
        function an(e, t, n) {
            ...
            if (!((Ft(e, 'beforeChange') || (e.cm && Ft(e.cm, 'beforeChange'))) && ((t = Cl(e, t, !0)), !t))) {
                var r = ba && !n && qc(e, t.from, t.to);
                if (r)
                    for (var i = r.length - 1; i >= 0; --i)
                        El(e, { from: r[i].from, to: r[i].to, text: i ? [''] : t.text, origin: t.origin });
                else El(e, t);
            }
        }
        function El(e, t) {
            if (!(t.text.length == 1 && t.text[0] == '' && ye(t.from, t.to) == 0)) {
                ...
                var r = [];
                _r(e, function (i, a) {
                    !a && Se(r, i.history) == -1 && (Dl(i.history, t), r.push(i.history)), On(i, t, null, io(i, t));
                });
            }
        }
        function Si(e, t, n) {
                ...
                if (m != u.length) {
                    ...
                    for (
                        var P = Ft(e, 'beforeChange') || (e.cm && Ft(e.cm, 'beforeChange')),
                            J = function (ue) {
                                var me = a.changes[ue];
                                if (((me.origin = t), P && !Cl(e, me, !1))) return (u.length = 0), {};
                                A.push(Fo(e, me));
                                var ve = ue ? Do(e, me) : ce(u);
                                On(e, me, ve, bl(e, me)),
                                    !ue && e.cm && e.cm.scrollIntoView({ from: me.from, to: xr(me) });
                                var _e = [];
                                _r(e, function (be, Ce) {
                                    !Ce && Se(_e, be.history) == -1 && (Dl(be.history, me), _e.push(be.history)),
            ...
            if (
                ...
                (e.sel = new Rt(
                    Be(e.sel.ranges, function (i) {
                        return new Ye(ne(i.anchor.line + t, i.anchor.ch), ne(i.head.line + t, i.head.ch));
                    }),
                    e.sel.primIndex
                )),
                e.cm)
        ...
        function On(e, t, n, r) {
            ...
            if (!(t.from.line > e.lastLine())) {
                ...
                var a = e.lastLine();
                t.to.line > a &&
                    (t = { from: t.from, to: ne(a, Ae(e, a).text.length), text: [t.text[0]], origin: t.origin }),
        ...
        function Pf(e, t, n) {
            ...
            e.options.lineWrapping ||
                ...
                e.options.lineWrapping ||
                    (r.iter(f, a.line + t.text.length, function (Y) {
                        var ie = li(Y);
                        ie > i.maxLineLength &&
                            ((i.maxLine = Y), (i.maxLineLength = ie), (i.maxLineChanged = !0), (u = !1));
                    }),
            ...
            var A = Ft(e, 'changes'),
                P = Ft(e, 'change');
            if (P || A) {
                var J = { from: a, to: l, text: t.text, removed: t.removed, origin: t.origin };
                P && ht(e, 'change', e, J), A && (e.curOp.changeObjs || (e.curOp.changeObjs = [])).push(J);
            }
        ...
        function Al(e, t, n, r) {
            for (var i = 0; i < e.length; ++i) {
                ...
                for (var f = 0; f < a.changes.length; ++f) {
                    var m = a.changes[f];
                    if (n < m.from.line) (m.from = ne(m.from.line + r, m.from.ch)), (m.to = ne(m.to.line + r, m.to.ch));
                    else if (t <= m.to.line) {
                        l = !1;
                        break;
                    }
        ...
        (Hn.prototype.clear = function () {
            ...
            (Hn.prototype.changed = function () {
                ...
                i &&
                    ...
                    n &&
                        Nt(n, function () {
                            (n.curOp.forceUpdate = !0), ql(n, r, i), ht(n, 'lineWidgetChanged', n, e, k(r));
                        }));
            }),
            Wt(Hn);
        function ql(e, t, n) {
            ...
            return (
                ...
                Pn(e, t, 'widget', function (l) {
                    ...
                    if (
                        ...
                        jt(l, l.height + Cn(i)), f && Lo(a, i.height), (a.curOp.forceUpdate = !0);
                    }
                    return !0;
                }),
        ...
        (kr.prototype.clear = function () {
            if (!this.explicitlyCleared) {
                ...
                for (var r = null, i = null, a = 0; a < this.lines.length; ++a) {
                    ...
                    e && !this.collapsed
                        ...
                        u.from == null && this.collapsed && !mr(this.doc, l) && e && jt(l, Vr(e.display));
                }
                ...
                r != null && e && this.collapsed && zt(e, r, i + 1),
                    ...
                    this.atomic && this.doc.cantEdit && ((this.doc.cantEdit = !1), e && wl(e.doc)),
            ...
            (kr.prototype.find = function (e, t) {
                ...
                for (var n, r, i = 0; i < this.lines.length; ++i) {
                    ...
                    if (l.from != null && ((n = ne(t ? a : k(a), l.from)), e == -1)) return n;
                ...
                !t ||
                    ...
                    Nt(r, function () {
                        var i = t.line,
                            ...
                            l = po(r, a);
                        if (
                            (l && (Ra(l), (r.curOp.selectionChanged = r.curOp.forceUpdate = !0)),
        ...
        function sn(e, t, n, r, i) {
            ...
            var a = new kr(e, i),
                l = ye(t, n);
            if ((r && ge(r, a, !1), l > 0 || (l == 0 && a.clearWhenEmpty !== !1))) return a;
            if (
                (a.replacedWith &&
                    ((a.collapsed = !0),
                ...
                if (Sa(e, t.line, t, n, a) || (t.line != n.line && Sa(e, n.line, t, n, a)))
                    throw new Error('Inserting collapsed marker partially overlapping an existing one');
                Ec();
            }
            a.addToHistory && ml(e, { from: t, to: n, origin: 'markText' }, e.sel, NaN);
            var u = t.line,
                f = e.cm,
                m;
            if (
                (e.iter(u, n.line + 1, function (P) {
                    f && a.collapsed && !f.options.lineWrapping && Zt(P) == f.display.maxLine && (m = !0),
                        a.collapsed && u != t.line && jt(P, 0),
                        Mc(P, new ni(a, u == t.line ? t.ch : null, u == n.line ? n.ch : null), e.cm && e.cm.curOp),
                        ++u;
                }),
                a.collapsed &&
                ...
                a.readOnly && (Cc(), (e.history.done.length || e.history.undone.length) && e.clearHistory()),
                a.collapsed && ((a.id = ++Il), (a.atomic = !0)),
                f)
            ) {
                if ((m && (f.curOp.updateMaxLine = !0), a.collapsed)) zt(f, t.line, n.line + 1);
        ...
        function Rf(e, t, n, r, i) {
            ...
            return (
                _r(e, function (f) {
                    u && (r.widgetNode = u.cloneNode(!0)), a.push(sn(f, Re(f, t), Re(f, n), r, i));
        ...
        function Fl(e) {
            return e.findMarks(ne(e.first, 0), e.clipPos(ne(e.lastLine())), function (t) {
                return t.parent;
            });
        }
        function Hf(e, t) {
            ...
            for (
                var t = function (r) {
                        ...
                        for (var l = 0; l < i.markers.length; l++) {
                            var u = i.markers[l];
                            Se(a, u.doc) == -1 && ((u.parent = null), i.markers.splice(l--, 1));
                        }
                    },
                    n = 0;
                n < e.length;
        ...
        (Mt.prototype = oe(Rn.prototype, {
            ...
            setSelections: mt(function (e, t, n) {
                if (e.length) {
                    for (var r = [], i = 0; i < e.length; i++)
                        r[i] = new Ye(Re(this, e[i].anchor), Re(this, e[i].head || e[i].anchor));
                    t == null && (t = Math.min(e.length - 1, this.sel.primIndex)), wt(this, Yt(this.cm, r, t), n);
                }
            }),
            addSelection: mt(function (e, t, n) {
                var r = this.sel.ranges.slice(0);
                r.push(new Ye(Re(this, e), Re(this, t || e))), wt(this, Yt(this.cm, r, r.length - 1), n);
            }),
            ...
            replaceSelections: mt(function (e, t, n) {
                ...
                for (var u = t && t != 'end' && Mf(this, r, t), f = r.length - 1; f >= 0; f--) an(this, r[f]);
                ...
                this.iter(function (n) {
                    n.gutterMarkers &&
                        ...
                        Pn(t, n, 'gutter', function () {
                            return (n.gutterMarkers[e] = null), Le(n.gutterMarkers) && (n.gutterMarkers = null), !0;
                        });
                });
            }),
            lineInfo: function (e) {
            ...
            linkedDoc: function (e) {
                ...
                var r = new Mt(kn(this, t, n), e.mode || this.modeOption, t, this.lineSep, this.direction);
                return (
...
`
                                ...
                                u = function () {
                                    ++l == i &&
                                        gt(t, function () {
                                            ...
                                            an(t.doc, Y), _l(t.doc, yr(Re(t.doc, n), Re(t.doc, xr(Y))));
                                        })();
                                },
                                f = function (Y, ie) {
                                    if (
                        ...
                        try {
                            ...
                            if (A) {
                                ...
                                if (
                                    ...
                                    for (var J = 0; J < P.length; ++J) ln(t.doc, '', P[J].anchor, P[J].head, 'drag');
        ...
        function Bl(e, t) {
            ...
            var n = wr[e.keyCode];
            return n == null || e.altGraphKey ? !1 : (e.keyCode == 3 && e.code && (n = e.code), Hl(n, e, t));
        }
        function Li(e) {
        ...
        function cn(e, t) {
            ...
            Nt(e, function () {
                for (var u = r.length - 1; u >= 0; u--) ln(e.doc, '', r[u].from, r[u].to, '+delete');
                tn(e);
            });
        }
        function Po(e, t, n) {
        ...
        function Vf(e, t, n, r) {
            ...
            if (e.doc.direction == 'rtl' || l.level == 1) {
                var P = (l.level == 1) == r < 0,
                    J = u(n, P ? 1 : -1);
                if (J != null && (P ? J <= l.to && J <= A.end : J >= l.from && J >= A.begin)) {
            ...
            var ie = function (ve, _e, be) {
                    for (
                        var Ce = function (Ve, vt) {
                            return vt ? new ne(n.line, u(Ve, 1), 'before') : new ne(n.line, Ve, 'after');
                        };
                        ve >= 0 && ve < i.length;
                        ve += _e
                    ) {
                        ...
                        if (
                            (Ne.from <= $e && $e < Ne.to) ||
                            (($e = Ie ? Ne.from : u(Ne.to, -1)), be.begin <= $e && $e < be.end)
                        )
                            return Ce($e, Ie);
                    }
                },
            ...
            return me != null && !(r > 0 && me == t.text.length) && ((ue = ie(r > 0 ? 0 : i.length - 1, r, m(me))), ue)
                ? ue
                : null;
        }
        var $n = {
            ...
            deleteLine: function (e) {
                return cn(e, function (t) {
                    return { from: ne(t.from().line, 0), to: Re(e.doc, ne(t.to().line + 1, 0)) };
                });
            },
                ...
                return Nt(e, function () {
                    for (var t = e.listSelections(), n = [], r = 0; r < t.length; r++)
                        if (t[r].empty()) {
                            ...
                            if (a) {
                                if ((i.ch == a.length && (i = new ne(i.line, i.ch - 1)), i.ch > 0))
...
`,
        ...
        function Ci(e, t, n) {
            ...
            var r = e.display.shift,
                i = !1;
            try {
                e.isReadOnly() && (e.state.suppressEdits = !0), n && (e.display.shift = !1), (i = t(e) != Ze);
            } finally {
        ...
        function ed(e, t, n) {
            ...
            return (e.options.extraKeys && un(t, e.options.extraKeys, n, e)) || un(t, e.options.keyMap, n, e);
        }
        var td = new qe();
        function Kn(e, t, n, r) {
        ...
        function Gl(e) {
            var t = this;
            if (!(e.target && e.target != t.display.input.getField()) && ((t.curOp.focus = B(de(t))), !ot(t, e))) {
                ...
                d &&
                    ((Ho = r ? n : null),
                    !r && n == 88 && !ti && (H ? e.metaKey : e.ctrlKey) && t.replaceSelection('', null, 'cut')),
                    v &&
                        !H &&
                        !r &&
                        n == 46 &&
                    ...
                    n == 18 && !/\bCodeMirror-crosshair\b/.test(t.display.lineDiv.className) && nd(t);
            }
        }
        function nd(e) {
            ...
            function n(r) {
                (r.keyCode == 18 || !r.altKey) &&
                    (Q(t, 'CodeMirror-crosshair'), _t(document, 'keyup', n), _t(document, 'mouseover', n));
            }
        ...
        function Xl(e) {
            ...
            if (
                ...
                !(lr(t.display, e) || ot(t, e) || (e.ctrlKey && !e.altKey) || (H && e.metaKey))
            ) {
                var n = e.keyCode,
                    r = e.charCode;
                if (d && n == Ho) {
            ...
            var i = e.display,
                ...
                l = gt(e, function (m) {
                    g && (i.scroller.draggable = !1),
                        ...
                        e.state.delayingBlurEvent && (e.hasFocus() ? (e.state.delayingBlurEvent = !1) : wo(e)),
        ...
        function Ql(e, t, n) {
            ...
            if (n == 'line') return new Ye(ne(t.line, 0), Re(e.doc, ne(t.line + 1, 0)));
            var r = n(e, t);
        ...
        function cd(e, t, n, r) {
            ...
            r.addNew
                ? u == -1
                    ? ((u = m.length), wt(a, Yt(e, m.concat([l]), u), { scroll: !1, origin: '*mouse' }))
                    : m.length > 1 && m[u].empty() && r.unit == 'char' && !r.extend
                      ? (wt(a, Yt(e, m.slice(0, u).concat(m.slice(u + 1)), 0), { scroll: !1, origin: '*mouse' }),
                        (f = a.sel))
                      : Oo(a, u, l, Je)
                    ...
                    if (((P = be), r.unit == 'rectangle')) {
                        for (
                            ...
                            Ve == vt
                                ...
                                : At.length > ut && Ce.push(new Ye(ne(rt, ut), ne(rt, Ge(At, vt, Ne))));
                        }
                        Ce.length || Ce.push(new Ye(n, n)),
                            wt(a, Yt(e, f.ranges.slice(0, u).concat(Ce), u), { origin: '*mouse', scroll: !1 }),
                            e.scrollIntoView(be);
                    } else {
                        var Dt = l,
                            yt = Ql(e, be, r.unit),
        ...
        function fd(e, t) {
            ...
            var J = a[f + (m ? -1 : 0)],
                ...
                ie = Y ? J.from : J.to,
                ue = Y ? 'after' : 'before';
            return n.ch == ie && n.sticky == ue ? t : new Ye(new ne(n.line, ie, ue), r);
        }
        function Vl(e, t, n, r) {
            var i, a;
        ...
        function Jl(e, t) {
            lr(e.display, t) || dd(e, t) || ot(e, t, 'contextmenu') || F || e.display.input.onContextMenu(t);
        }
        function dd(e, t) {
            return Ft(e, 'gutterContextMenu') ? Vl(e, t, 'gutterContextMenu', !1) : !1;
        }
        function es(e) {
            ...
            (e.defineOption = n),
                ...
                n('lineSeparator', null, function (r, i) {
                    if (((r.doc.lineSep = i), !!i)) {
                        ...
                        for (var u = a.length - 1; u >= 0; u--) ln(r.doc, i, a[u], ne(a[u].line, a[u].ch + i.length));
                    }
                }),
                n(
                    'specialChars',
                ...
                n(
                    ...
                    !0,
                    function (r, i) {
                        (r.display.gutters.style.left = i ? yo(r.display) + 'px' : '0'), r.refresh();
                    },
                    !0
                ),
                n(
                ...
                n('readOnly', !1, function (r, i) {
                    i == 'nocursor' && (en(r), r.display.input.blur()), r.display.input.readOnlyChanged(i);
                }),
        ...
        function md(e) {
            ...
            Fe(t.scroller, 'touchstart', function (f) {
                ...
                Fe(t.scroller, 'touchend', function (f) {
                    var m = t.activeTouch;
                    if (m && !lr(t, f) && m.left != null && !m.moved && new Date() - m.start < 300) {
                ...
                Fe(t.scroller, 'scroll', function () {
                    t.scroller.clientHeight &&
                        (An(e, t.scroller.scrollTop), Dr(e, t.scroller.scrollLeft, !0), it(e, 'scroll', e));
                }),
        ...
        function Xn(e, t, n, r) {
            var i = e.doc,
                a;
            n == null && (n = 'add'), n == 'smart' && (i.mode.indent ? (a = wn(e, t).state) : (n = 'prev'));
            ...
            else if (n == 'smart' && ((A = i.mode.indent(a, u.text.slice(m.length), u.text)), A == Ze || A > 150)) {
                if (!r) return;
                n = 'prev';
            }
            n == 'prev'
            ...
            var P = '',
                J = 0;
            if (e.options.indentWithTabs) for (var Y = Math.floor(A / l); Y; --Y) (J += l), (P += '	');
            if ((J < A && (P += G(A - J)), P != m))
                return ln(i, P, ne(t, 0), ne(t, m.length), '+input'), (u.stateAfter = null), !0;
...
`) == t
                    ...
                    if (r.ranges.length % Qt.text.length == 0) {
                        m = [];
                        for (var A = 0; A < Qt.text.length; A++) m.push(a.splitLines(Qt.text[A]));
                    }
                } else
            ...
            for (var P = e.curOp.updateInput, J = r.ranges.length - 1; J >= 0; J--) {
                ...
                Y.empty() &&
                    (n && n > 0
                        ...
                        : e.state.overwrite && !u
                          ? (ue = ne(ue.line, Math.min(Ae(a, ue.line).text.length, ue.ch + ce(f).length)))
                          : u &&
                            Qt &&
                            Qt.lineWise &&
                            Qt.text.join(`
...
`) &&
                ...
                for (var n = e.doc.sel, r = n.ranges.length - 1; r >= 0; r--) {
                    ...
                    if (!(i.head.ch > 100 || (r && n.ranges[r - 1].head.line == i.head.line))) {
                        ...
                        if (a.electricChars) {
                            ...
                            a.electricInput &&
                                a.electricInput.test(Ae(e.doc, i.head.line).text.slice(0, i.head.ch)) &&
                                (l = Xn(e, i.head.line, 'smart'));
        ...
        function vd(e) {
            ...
            (e.prototype = {
                ...
                getStateAfter: function (r, i) {
                    var a = this.doc;
                    return (r = ua(a, r ?? a.first + a.size - 1)), wn(this, r + 1, i).state;
                },
                ...
                lineAtHeight: function (r, i) {
                    return (
                        (r = Ua(this, { top: r, left: 0 }, i || 'page').top), O(this.doc, r + this.display.viewOffset)
                    );
                },
                heightAtLine: function (r, i, a) {
                    ...
                    if (typeof r == 'number') {
                        ...
                        r < this.doc.first ? (r = this.doc.first) : r > f && ((r = f), (l = !0)), (u = Ae(this.doc, r));
                    } else u = r;
                    return (
                        ci(this, u, { top: 0, left: 0 }, i || 'page', a || l).top + (l ? this.doc.height - ar(u) : 0)
                    );
                },
                    ...
                    (i.style.top = m + 'px'),
                        ...
                        u == 'right'
                            ...
                            : (u == 'left' ? (A = 0) : u == 'middle' && (A = (f.sizer.clientWidth - i.offsetWidth) / 2),
                              (i.style.left = A + 'px')),
                        a && hf(this, { left: A, top: m, right: A + i.offsetWidth, bottom: m + i.offsetHeight });
                },
                ...
                findPosH: function (r, i, a, l) {
                    var u = 1;
                    i < 0 && ((u = -1), (i = -i));
                    for (var f = Re(this.doc, r), m = 0; m < i && ((f = Go(this.doc, f, u, a, l)), !f.hitSide); ++m);
                    return f;
                },
                ...
                findPosV: function (r, i, a, l) {
                    ...
                    for (var m = Re(this.doc, r), A = 0; A < i; ++A) {
                        var P = Xt(this, m, 'div');
                        if ((f == null ? (f = P.left) : (P.left = f), (m = as(this, P, u, a)), m.hitSide)) break;
                    }
                    return m;
                },
                moveV: Tt(function (r, i) {
                    ...
                    if (
                        (l.extendSelectionsBy(function (A) {
                            ...
                            var J = as(a, P, r, i);
                            return i == 'page' && A == l.sel.primary() && Lo(a, fi(a, J, 'div').top - P.top), J;
                        }, He),
                        u.length)
                    )
                ...
                scrollIntoView: Tt(function (r, i) {
                    r == null
                        ...
                        r.to || (r.to = r.from),
                        (r.margin = i || 0),
                        r.from.line != null ? gf(this, r) : Ja(this, r.from, r.to, r.margin);
                }),
                ...
                refresh: Tt(function () {
                    ...
                    zt(this),
                        ...
                        zo(this.display),
                        (r == null || Math.abs(r - Vr(this.display)) > 0.5 || this.options.lineWrapping) && xo(this),
                        it(this, 'refresh', this);
                }),
        ...
        function Go(e, t, n, r, i) {
            ...
            function A(_e) {
                ...
                if (r == 'codepoint') {
                    ...
                    if (isNaN(Ce)) be = null;
                        ...
                        var Ne = n > 0 ? Ce >= 55296 && Ce < 56320 : Ce >= 56320 && Ce < 57343;
                        be = new ne(t.line, Math.max(0, Math.min(u.text.length, t.ch + n * (Ne ? 2 : 1))), -n);
                    }
            ...
            if (r == 'char' || r == 'codepoint') A();
                ...
                for (
                    var P = null, J = r == 'group', Y = e.cm && e.cm.getHelper(t, 'wordChars'), ie = !0;
                    !(n < 0 && !A(!ie));
                    ie = !1
                ) {
                    var ue =
...
`
        ...
        (Qe.prototype.init = function (e) {
            var t = this,
                ...
                r = n.cm,
                i = (n.div = e.lineDiv);
            (i.contentEditable = !0), Ko(i, r.options.spellcheck, r.options.autocorrect, r.options.autocapitalize);
            function a(u) {
                        ...
                        zi({ lineWise: !0, text: f.text }),
                            u.type == 'cut' &&
                                r.operation(function () {
                                    r.setSelections(f.ranges, 0, ke), r.replaceSelection('', null, 'cut');
                                });
                    } else return;
                    if (u.clipboardData) {
...
`));
                    ...
                    q(P),
                        setTimeout(function () {
                            r.display.lineSpace.removeChild(A), J.focus(), J == i && n.showPrimarySelection();
                        }, 50);
                }
            }
            ...
            (Qe.prototype.showPrimarySelection = function () {
                ...
                if (!(a && !a.bad && l && !l.bad && ye(Zr(a, l), r) == 0 && ye(Et(a, l), i) == 0)) {
                    var u = t.display.view,
                        f = (r.line >= t.display.viewFrom && ls(t, r)) || { node: u[0].measure.map[2], offset: 0 },
                    ...
                    Y &&
                        (!v && t.state.focused
                            ? (e.collapse(f.node, f.offset), Y.collapsed || (e.removeAllRanges(), e.addRange(Y)))
                            : (e.removeAllRanges(), e.addRange(Y)),
                        J && e.anchorNode == null ? e.addRange(J) : v && this.startGracePeriod()),
            ...
            (Qe.prototype.showMultipleSelections = function (e) {
                V(this.cm.display.cursorDiv, e.cursors), V(this.cm.display.selectionDiv, e.selection);
            }),
            ...
            (Qe.prototype.pollSelection = function () {
                if (!(this.readDOMTimeout != null || this.gracePeriod || !this.selectionChanged())) {
                    var e = this.getSelection(),
                        t = this.cm;
                    if (R && x && this.cm.display.gutterSpecs.length && bd(e.anchorNode)) {
                    ...
                    if (!this.composing) {
                        ...
                        n &&
                            r &&
                            Nt(t, function () {
                                wt(t.doc, yr(n, r), ke), (n.bad || r.bad) && (t.curOp.selectionChanged = !0);
                            });
                    }
                }
            }),
            (Qe.prototype.pollContent = function () {
                ...
                var e = this.cm,
                    ...
                    i = n.to();
                if (
                    (r.ch == 0 && r.line > e.firstLine() && (r = ne(r.line - 1, Ae(e.doc, r.line - 1).length)),
                    i.ch == Ae(e.doc, i.line).text.length && i.line < e.lastLine() && (i = ne(i.line + 1, 0)),
                ...
                if (
                    (f == t.view.length - 1
                        ...
                        : ((m = k(t.view[f + 1].line) - 1), (A = t.view[f + 1].node.previousSibling)),
                    !u)
                )
                    return !1;
                for (
                ...
                for (
                    var Y = 0, ie = 0, ue = P[0], me = J[0], ve = Math.min(ue.length, me.length);
                ...
                for (
                    var _e = ce(P),
                        be = ce(J),
                        Ce = Math.min(_e.length - (P.length == 1 ? Y : 0), be.length - (J.length == 1 ? Y : 0));
                    ie < Ce && _e.charCodeAt(_e.length - ie - 1) == be.charCodeAt(be.length - ie - 1);

                )
                    ++ie;
                if (P.length == 1 && J.length == 1 && l == r.line)
                    for (; Y && Y > r.ch && _e.charCodeAt(_e.length - ie - 1) == be.charCodeAt(be.length - ie - 1); )
                        Y--, ie++;
                (P[P.length - 1] = _e.slice(0, _e.length - ie).replace(/^\u200b+/, '')),
                    (P[0] = P[0].slice(Y).replace(/\u200b+$/, ''));
                var Ne = ne(l, Y),
                    Ie = ne(m, J.length ? ce(J).length - ie : 0);
                if (P.length > 1 || P[0] || ye(Ne, Ie)) return ln(e.doc, P, Ne, Ie, '+input'), !0;
            }),
            ...
            (Qe.prototype.onKeyPress = function (e) {
                e.charCode == 0 ||
                    ...
                    (e.preventDefault(),
                    this.cm.isReadOnly() ||
                        gt(this.cm, $o)(this.cm, String.fromCharCode(e.charCode == null ? e.keyCode : e.charCode), 0));
            }),
            ...
            function J(Y) {
                if (Y.nodeType == 1) {
                    ...
                    if (ue) {
                        ...
                        ve.length && (me = ve[0].find(0)) && P(ir(e.doc, me.from, me.to).join(u));
                        return;
                    }
                ...
                } else Y.nodeType == 3 && P(Y.nodeValue.replace(/\u200b/g, '').replace(/\u00a0/g, ' '));
            }
        ...
        function Mi(e, t, n) {
            ...
            if (t == e.display.lineDiv) {
                if (((r = e.display.lineDiv.childNodes[n]), !r)) return dn(e.clipPos(ne(e.display.viewTo - 1)), !0);
                (t = null), (n = 0);
            } else
        ...
        function xd(e, t, n) {
            ...
            function A(me, ve, _e) {
                for (var be = -1; be < (m ? m.length : 0); be++)
                    for (var Ce = be < 0 ? f.map : m[be], Ne = 0; Ne < Ce.length; Ne += 3) {
                        var Ie = Ce[Ne + 2];
                        if (Ie == me || Ie == ve) {
                            var $e = k(be < 0 ? e.line : e.rest[be]),
                                Ve = Ce[Ne] + _e;
                            return (_e < 0 || Ie != me) && (Ve = Ce[Ne + (_e ? 1 : 0)]), ne($e, Ve);
                        }
                    }
            }
            var P = A(l, u, n);
            if (P) return dn(P, i);
            for (var J = u.nextSibling, Y = l ? l.nodeValue.length - n : 0; J; J = J.nextSibling) {
                if (((P = A(J, J.firstChild, 0)), P)) return dn(ne(P.line, P.ch - Y), i);
                Y += J.textContent.length;
            }
            for (var ie = u.previousSibling, ue = n; ie; ie = ie.previousSibling) {
                if (((P = A(ie, ie.firstChild, -1)), P)) return dn(ne(P.line, P.ch + ue), i);
        ...
        (st.prototype.init = function (e) {
            ...
            e.wrapper.insertBefore(this.wrapper, e.wrapper.firstChild),
                y && (i.style.width = '0px'),
                Fe(i, 'input', function () {
                    s && h >= 9 && t.hasSelection && (t.hasSelection = null), n.poll();
                }),
                Fe(i, 'paste', function (l) {
                    ot(r, l) || rs(l, r) || ((r.state.pasteIncoming = +new Date()), n.fastPoll());
                });
            function a(l) {
                if (!ot(r, l)) {
                    if (r.somethingSelected()) zi({ lineWise: !1, text: r.getSelections() });
                    else if (r.options.lineWiseCopyCut) {
                        var u = is(r);
...
`)),
            ...
            (st.prototype.reset = function (e) {
                if (!(this.contextMenuPending || (this.composing && e))) {
                    ...
                    if (((this.resetting = !0), t.somethingSelected())) {
                        ...
                        e || ((this.prevInput = this.textarea.value = ''), s && h >= 9 && (this.hasSelection = null));
                    this.resetting = !1;
                }
            }),
            ...
            (st.prototype.focus = function () {
                if (this.cm.options.readOnly != 'nocursor' && (!M || B(ze(this.textarea)) != this.textarea))
                    try {
                        this.textarea.focus();
                    } catch {}
            }),
            ...
            (st.prototype.poll = function () {
                ...
                if ((s && h >= 9 && this.hasSelection === i) || (H && /[\uf700-\uf7ff]/.test(i)))
                ...
                return (
                    Nt(t, function () {
                        $o(t, i.slice(l), r.length - l, null, e.composing ? '*compose' : null),
                            i.length > 1e3 ||
                            i.indexOf(`
`) > -1
                                ? (n.value = e.prevInput = '')
      ...
      outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);`);
                ...
                function Y() {
                    if (
                        ...
                        (i.style.cssText = f),
                        s && h < 9 && r.scrollbars.setScrollTop((r.scroller.scrollTop = l)),
        ...
        return (
            ...
            (tt.defineMode = function (e) {
                !tt.defaults.mode && e != 'null' && (tt.defaults.mode = e), Gt.apply(this, arguments);
            }),
            (tt.defineMIME = Cr),
    ...
    (function (o) {
        ...
        o.overlayMode = function (p, v, C) {
            return {
                ...
                token: function (b, S) {
                    return (
                        (b != S.streamSeen || Math.min(S.basePos, S.overlayPos) < b.start) &&
                            ((S.streamSeen = b), (S.basePos = S.overlayPos = b.start)),
                        b.start == S.basePos && ((S.baseCur = p.token(b, S.base)), (S.basePos = b.pos)),
                        b.start == S.overlayPos &&
                            ((b.pos = b.start), (S.overlayCur = v.token(b, S.overlay)), (S.overlayPos = b.pos)),
                        (b.pos = Math.min(S.basePos, S.overlayPos)),
                        S.overlayCur == null
                            ? S.baseCur
                            : (S.baseCur != null && S.overlay.combineTokens) || (C && S.overlay.combineTokens == null)
        ...
        o.commands.newlineAndIndentContinueMarkdownList = function (S) {
            ...
            for (var s = S.listSelections(), h = [], g = 0; g < s.length; g++) {
                ...
                if (v.test(E)) {
                    var R = w && />\s*$/.test(E),
                        M = !/>\s*$/.test(E);
                    (R || M) && S.replaceRange('', { line: T.line, ch: 0 }, { line: T.line, ch: T.ch + 1 }),
                        (h[g] = `
`);
                } else {
                    var H = z[1],
...
var ms = Ke((hs, gs) => {
    (function (o) {
        ...
        o.defineOption('placeholder', '', function (h, g, T) {
            ...
            if (g && !x)
                ...
                h.off('blur', b),
                    h.off('change', S),
                    h.off('swapDoc', S),
                    o.off(h.getInputField(), 'compositionupdate', h.state.placeholderCompose),
                    p(h);
                var c = h.getWrapperElement();
        ...
        function p(h) {
            h.state.placeholder &&
                (h.state.placeholder.parentNode.removeChild(h.state.placeholder), (h.state.placeholder = null));
        }
        function v(h) {
            p(h);
            var g = (h.state.placeholder = document.createElement('pre'));
            ...
            var T = h.getOption('placeholder');
            typeof T == 'string' && (T = document.createTextNode(T)),
                g.appendChild(T),
                h.display.lineSpace.insertBefore(g, h.display.lineSpace.firstChild);
        }
        function C(h) {
            setTimeout(function () {
                var g = !1;
                if (h.lineCount() == 1) {
                    var T = h.getInputField();
                    g =
                        T.nodeName == 'TEXTAREA'
                            ? !h.getLine(0).length
                            : !/[^\u200b]/.test(T.querySelector('.CodeMirror-line').textContent);
                }
                g ? v(h) : p(h);
            }, 20);
        }
        ...
        function S(h) {
            var g = h.getWrapperElement(),
                T = s(h);
            (g.className = g.className.replace(' CodeMirror-empty', '') + (T ? ' CodeMirror-empty' : '')),
                T ? v(h) : p(h);
        }
        function s(h) {
...
var ys = Ke((vs, bs) => {
    (function (o) {
        ...
        o.defineOption('styleSelectedText', !1, function (x, c, d) {
            ...
            c && !w
                ? ((x.state.markedSelection = []),
                  (x.state.markedSelectionStyle = typeof c == 'string' ? c : 'CodeMirror-selectedtext'),
                  g(x),
        ...
        function s(x, c, d, w) {
            if (S(c, d) != 0)
                for (var E = x.state.markedSelection, z = x.state.markedSelectionStyle, y = c.line; ; ) {
        ...
        function h(x) {
            for (var c = x.state.markedSelection, d = 0; d < c.length; ++d) c[d].clear();
            c.length = 0;
        }
        function g(x) {
            h(x);
            for (var c = x.listSelections(), d = 0; d < c.length; d++) s(x, c[d].from(), c[d].to());
        }
        function T(x) {
            ...
            var E = w[0].find(),
                z = w[w.length - 1].find();
            if (!E || !z || d.line - c.line <= C || S(c, z.to) >= 0 || S(d, E.from) <= 0) return g(x);
            for (; S(c, E.from) > 0; ) w.shift().clear(), (E = w[0].find());
            for (
                S(c, E.from) < 0 &&
                (E.to.line - c.line < C ? (w.shift().clear(), s(x, c, E.to, 0)) : s(x, c, E.from, 0));
                S(d, z.to) < 0;

            )
                w.pop().clear(), (z = w[w.length - 1].find());
            S(d, z.to) > 0 && (d.line - z.from.line < C ? (w.pop().clear(), s(x, z.from, d)) : s(x, z.to, d));
        }
    });
});
var ks = Ke((xs, _s) => {
    (function (o) {
        ...
        function v(y) {
            var R = y.flags;
            return R ?? (y.ignoreCase ? 'i' : '') + (y.global ? 'g' : '') + (y.multiline ? 'm' : '');
        }
        function C(y, R) {
            for (var M = v(y), H = M, Z = 0; Z < R.length; Z++) H.indexOf(R.charAt(Z)) == -1 && (H += R.charAt(Z));
        ...
        function S(y, R, M) {
            ...
            for (var H = M.line, Z = M.ch, ee = y.lastLine(); H <= ee; H++, Z = 0) {
                ...
                var re = y.getLine(H),
                    N = R.exec(re);
                if (N) return { from: p(H, N.index), to: p(H, N.index + N[0].length), match: N };
            }
        }
        function s(y, R, M) {
...
`),
                    ...
                    return {
                        from: p(V, _),
                        to: p(V + j.length - 1, j.length == 1 ? _ + j[0].length : j[j.length - 1].length),
                        match: D,
                    };
                }
            }
        ...
        function T(y, R, M) {
            ...
            R = C(R, 'gm');
            for (var H, Z = 1, ee = y.getLine(M.line).length - M.ch, re = M.line, N = y.firstLine(); re >= N; ) {
...
`),
                    ...
                    return {
                        from: p(_, K),
                        to: p(_ + V.length - 1, V.length == 1 ? K + V[0].length : V[V.length - 1].length),
                        match: Q,
                    };
                }
            }
        ...
        function w(y, R, M, H) {
            ...
            var Z = H ? x : c,
                ee = Z(R).split(/\r|\n\r?/);
            e: for (var re = M.line, N = M.ch, F = y.lastLine() + 1 - ee.length; re <= F; re++, N = 0) {
                ...
                if (ee.length == 1) {
                    ...
                    if (j == -1) continue e;
                    var M = d(D, Q, j, Z) + N;
                    return { from: p(re, d(D, Q, j, Z) + N), to: p(re, d(D, Q, j + ee[0].length, Z) + N) };
                } else {
                    var V = Q.length - ee[0].length;
                    if (Q.slice(V) != ee[0]) continue e;
                    for (var _ = 1; _ < ee.length - 1; _++) if (Z(y.getLine(re + _)) != ee[_]) continue e;
                    var K = y.getLine(re + ee.length - 1),
                        X = Z(K),
                        I = ee[ee.length - 1];
                    if (X.slice(0, I.length) != I) continue e;
                    return { from: p(re, d(D, Q, V, Z) + N), to: p(re + ee.length - 1, d(K, X, I.length, Z)) };
                }
            }
        }
        function E(y, R, M, H) {
            ...
            var Z = H ? x : c,
                ee = Z(R).split(/\r|\n\r?/);
            e: for (var re = M.line, N = M.ch, F = y.firstLine() - 1 + ee.length; re >= F; re--, N = -1) {
                var D = y.getLine(re);
                N > -1 && (D = D.slice(0, N));
                var Q = Z(D);
                if (ee.length == 1) {
                    ...
                    if (j == -1) continue e;
                    return { from: p(re, d(D, Q, j, Z)), to: p(re, d(D, Q, j + ee[0].length, Z)) };
                } else {
                    ...
                    return {
                        from: p(re + 1 - ee.length, d(K, X, K.length - ee[0].length, Z)),
        ...
        (z.prototype = {
            ...
            find: function (y) {
                ...
                if (
                    ...
                    ((R = p(R.line, R.ch)),
                    y
                        ? (R.ch--, R.ch < 0 && (R.line--, (R.ch = (this.doc.getLine(R.line) || '').length)))
                        : (R.ch++, R.ch > (this.doc.getLine(R.line) || '').length && ((R.ch = 0), R.line++)),
                ...
                var H = p(y ? this.doc.firstLine() : this.doc.lastLine() + 1, 0);
...
var Vo = Ke((ws, Ss) => {
    (function (o) {
        ...
        function C(I) {
            ...
            return (
                (B == ')' || B == ']' || B == '}') && (I.indented = I.context.indented), (I.context = I.context.prev)
            );
        }
        function b(I, B, le) {
            if (
        ...
        o.defineMode('clike', function (I, B) {
            var le = I.indentUnit,
                ...
                Je = B.numberStart || /[\d\.]/,
                He = B.number || /^(?:0x[a-f\d]+|0b[01]+|(?:\d+\.?\d*|\.\d+)(?:e[-+]?\d+)?)(u|ll?|l|f)?/i,
                Ge = B.isOperatorChar || /[+\-*&%=<>!?|\/]/,
            ...
            function te(we, Me) {
                ...
                if (Le == '"' || Le == "'") return (Me.tokenize = fe(Le)), Me.tokenize(we, Me);
                if (Je.test(Le)) {
                ...
                var W = we.current();
                return h(L, W)
                    ? (h(pe, W) && (ce = 'newstatement'), h(Ee, W) && (Be = !0), 'keyword')
                    : h(de, W)
                      ? 'type'
                      : h(ze, W) || (G && G(W))
            ...
            function Ue(we, Me) {
                B.typeFirstDefinitions && we.eol() && S(Me.context) && (Me.typeAtEndOfLine = b(we, Me, we.pos));
            }
            return {
                ...
                token: function (we, Me) {
                    ...
                    if (
                        ...
                        for (Le.type == '}' && (Le = C(Me)); Le.type == 'statement'; ) Le = C(Me);
                    } else
                        ce == Le.type
                            ? C(Me)
                            : Se &&
                ...
                indent: function (we, Me) {
                    if ((we.tokenize != te && we.tokenize != null) || (we.typeAtEndOfLine && S(we.context)))
                        return o.Pass;
                    var Le = we.context,
                        $ = Me && Me.charAt(0),
                        W = $ == Le.type;
                    if ((Le.type == 'statement' && $ == '}' && (Le = Le.prev), B.dontIndentStatements))
                        for (; Le.type == 'statement' && B.dontIndentStatements.test(Le.info); ) Le = Le.prev;
                    if (Oe.indent) {
                    ...
                    return Le.type == 'statement'
                        ...
                        : Le.align && (!q || Le.type != ')')
                          ...
                          : Le.type == ')' && !W
                            ? Le.indented + xe
                            : Le.indented + (W ? 0 : le) + (!W && De && !/^(?:case|default)\b/.test(Me) ? le : 0);
                },
                electricInput: je ? /^\s*(?:case .*?:|default:|\{\}?|\})$/ : /^\s*[{}]$/,
                blockCommentStart: '/*',
                blockCommentEnd: '*/',
        ...
        function s(I) {
            for (var B = {}, le = I.split(' '), xe = 0; xe < le.length; ++xe) B[le[xe]] = !0;
            return B;
        }
        function h(I, B) {
        ...
        function re(I, B) {
            if ((I.backUp(1), I.match(/^(?:R|u8R|uR|UR|LR)/))) {
                ...
                return le ? ((B.cpp11RawStringDelim = le[1]), (B.tokenize = D), D(I, B)) : !1;
            }
        ...
        function Q(I, B) {
            ...
            var le = [];
            function xe(L) {
                if (L) for (var de in L) L.hasOwnProperty(de) && le.push(de);
            }
            xe(B.keywords),
                xe(B.types),
                xe(B.builtin),
                xe(B.atoms),
                le.length && ((B.helperType = I[0]), o.registerHelper('hintWords', I[0], le));
        ...
        Q(['text/x-csrc', 'text/x-c', 'text/x-chdr'], {
                ...
                hooks: {
                    ...
                    token: function (I, B, le) {
                        if (
                            le == 'variable' &&
                            I.peek() == '(' &&
                            (B.prevToken == ';' || B.prevToken == null || B.prevToken == '}') &&
                            N(I.current())
                        )
                            return 'def';
                    },
            ...
            Q('text/x-csharp', {
                ...
                hooks: {
                    '@': function (I, B) {
                        return I.eat('"') ? ((B.tokenize = F), F(I, B)) : (I.eatWhile(/[\w\$_]/), 'meta');
                    },
                },
            });
        function j(I, B) {
        ...
        function V(I) {
            return function (B, le) {
                for (var xe; (xe = B.next()); )
                    ...
                    else if (xe == '/' && B.eat('*')) return (le.tokenize = V(I + 1)), le.tokenize(B, le);
                return 'comment';
            };
        }
        Q('text/x-scala', {
            ...
            hooks: {
                ...
                '=': function (I, B) {
                    ...
                    return le.type == '}' && le.align && I.eat('>')
                        ? ((B.context = new p(le.indented, le.column, le.type, le.info, null, le.prev)), 'operator')
                        : !1;
                },
                '/': function (I, B) {
        ...
        function _(I) {
            return function (B, le) {
                for (var xe = !1, q, L = !1; !B.eol(); ) {
                    ...
                    (q = B.next()), !xe && q == '$' && B.match('{') && B.skipTo('}'), (xe = !xe && q == '\\' && !I);
                }
        ...
        Q('text/x-kotlin', {
            ...
            hooks: {
                ...
                indent: function (I, B, le, xe) {
                    ...
                    if (B.align && B.type == '}') return B.indented + (I.context.type == (le || '').charAt(0) ? 0 : xe);
                },
            },
            ...
            Q('text/x-objectivec++', {
                ...
                defKeywords: s(R + ' @interface @implementation @protocol @class class namespace'),
                dontIndentStatements: /^@.*$|^template$/,
                typeFirstDefinitions: !0,
                atoms: s('YES NO NULL Nil nil true false nullptr'),
                isReservedIdentifier: Z,
        ...
        Q('text/x-ceylon', {
            ...
            hooks: {
                ...
                '"': function (I, B) {
                    return (B.tokenize = X(I.match('""') ? 'triple' : 'single')), B.tokenize(I, B);
                },
                '`': function (I, B) {
                    return !K || !I.match('`') ? !1 : ((B.tokenize = K), (K = null), B.tokenize(I, B));
                },
                "'": function (I) {
                    return I.eatWhile(/[\w\$_\xa1-\uffff]/), 'atom';
                },
                token: function (I, B, le) {
                    if ((le == 'variable' || le == 'type') && B.prevToken == '.') return 'variable-2';
                },
            },
...
var Cs = Ke((Ts, Ls) => {
    (function (o) {
        ...
        o.defineMode('cmake', function () {
            var p = /({)?[a-zA-Z0-9_]+(})?/;
            function v(b, S) {
                for (var s, h, g = !1; !b.eol() && (s = b.next()) != S.pending; ) {
                    if (s === '$' && h != '\\' && S.pending == '"') {
                        g = !0;
                        break;
                    }
                ...
                return g && b.backUp(1), s == S.pending ? (S.continueString = !1) : (S.continueString = !0), 'string';
            }
            function C(b, S) {
                var s = b.next();
                return s === '$'
    ...
    (function (o) {
        ...
        o.defineMode('css', function (F, D) {
            ...
            function je(te, fe) {
                ...
                if (oe == '=' || ((oe == '~' || oe == '|') && te.eat('='))) return Se(null, 'compare');
                if (oe == '"' || oe == "'") return (fe.tokenize = Ze(oe)), fe.tokenize(te, fe);
                if (oe == '#') return te.eatWhile(/[\w\\\-]/), Se('atom', 'hash');
                if (oe == '!') return te.match(/^\s*\w*/), Se('keyword', 'important');
                if (/\d/.test(oe) || (oe == '.' && te.eat(/\d/))) return te.eatWhile(/[\w.%]/), Se('number', 'unit');
                if (oe === '-') {
                    if (/[\d.]/.test(te.peek())) return te.eatWhile(/[\w.%]/), Se('number', 'unit');
                    if (te.match(/^-[\w\\\-]*/))
                        return (
                            te.eatWhile(/[\w\\\-]/),
                            te.match(/^\s*:/, !1)
                    ...
                    return /[,+>*\/]/.test(oe)
                        ...
                        : oe == '.' && te.match(/^-?[_a-z][_a-z0-9-]*/i)
                          ...
                          : /[:;{}\[\]\(\)]/.test(oe)
                            ? Se(null, oe)
                            : te.match(/^[\w-.]+(?=\()/)
                              ? (/^(url(-prefix)?|domain|regexp)$/i.test(te.current()) && (fe.tokenize = ke),
            ...
            function Ze(te) {
                return function (fe, oe) {
                    ...
                    return (we == te || (!Ue && te != ')')) && (oe.tokenize = null), Se('string', 'string');
                };
            }
            function ke(te, fe) {
                return (
                    te.next(),
                    te.match(/^\s*[\"\')]/, !1) ? (fe.tokenize = null) : (fe.tokenize = Ze(')')),
                    Se(null, '(')
                );
            }
            ...
            function He(te, fe, oe, Ue) {
                return (te.context = new Je(oe, fe.indentation() + (Ue === !1 ? 0 : j), te.context)), oe;
            }
            function Ge(te) {
            ...
            function ce(te) {
                ...
                de.hasOwnProperty(fe) ? (qe = 'atom') : L.hasOwnProperty(fe) ? (qe = 'keyword') : (qe = 'variable');
            }
            var Be = {};
            return (
                (Be.top = function (te, fe, oe) {
                    ...
                    if (Ee && /@component/i.test(te)) return He(oe, fe, 'atComponentBlock');
                    if (/^@(-moz-)?document$/i.test(te)) return He(oe, fe, 'documentTypes');
                    if (/^@(media|supports|(-moz-)?document|import)$/i.test(te)) return He(oe, fe, 'atBlock');
                    ...
                    if (te == 'word') {
                        ...
                        return B.hasOwnProperty(Ue)
                            ...
                            : le.hasOwnProperty(Ue)
                              ...
                              : ze
                                ? ((qe = fe.match(/^\s*:(?:\s|$)/, !1) ? 'property' : 'tag'), 'block')
                                : ((qe += ' error'), 'maybeprop');
                    } else
                        return te == 'meta'
                            ? 'block'
                ...
                (Be.prop = function (te, fe, oe) {
                    ...
                    if (te == 'hash' && !/^#([0-9a-fA-F]{3,4}|[0-9a-fA-F]{6}|[0-9a-fA-F]{8})$/.test(fe.current()))
                        qe += ' error';
                ...
                (Be.propBlock = function (te, fe, oe) {
                    return te == '}' ? Ge(oe) : te == 'word' ? ((qe = 'property'), 'maybeprop') : oe.context.type;
                }),
                ...
                (Be.atBlock_parens = function (te, fe, oe) {
                    return te == ')' ? Ge(oe) : te == '{' || te == '}' ? G(te, fe, oe, 2) : Be.atBlock(te, fe, oe);
                }),
                ...
                (Be.restricted_atBlock = function (te, fe, oe) {
                    return te == '}'
                        ...
                        : te == 'word'
                          ? ((oe.stateArg == '@font-face' && !xe.hasOwnProperty(fe.current().toLowerCase())) ||
                            (oe.stateArg == '@counter-style' && !q.hasOwnProperty(fe.current().toLowerCase()))
                                ? (qe = 'error')
                                : (qe = 'property'),
                            'maybeprop')
                          : 'restricted_atBlock';
                ...
                (Be.at = function (te, fe, oe) {
                    return te == ';'
                        ...
                        : te == '{' || te == '}'
                          ? G(te, fe, oe)
                          : (te == 'word' ? (qe = 'tag') : te == 'hash' && (qe = 'builtin'), 'at');
                }),
                        ...
                        return (
                            ...
                            oe.prev &&
                                ...
                                (oe.type == 'block' ||
                                    ...
                                    : ((Ue == ')' && (oe.type == 'parens' || oe.type == 'atBlock_parens')) ||
                                          (Ue == '{' && (oe.type == 'at' || oe.type == 'atBlock'))) &&
        ...
        var v = ['domain', 'regexp', 'url', 'url-prefix'],
            ...
            ee = p(Z),
            re = v.concat(b).concat(s).concat(g).concat(x).concat(d).concat(M).concat(Z);
    ...
    (function (o) {
        ...
        o.defineMode('xml', function (C, b) {
                        ...
                        ? _.eat('[')
                            ...
                            : _.match('--')
                              ...
                              : _.match('DOCTYPE', !0, !0)
                                ...
                                : null
                        : _.eat('?')
                          ? (_.eatWhile(/[\w\._\-]/), (K.tokenize = E('meta', '?>')), 'meta')
                          : ((T = _.eat('/') ? 'closeTag' : 'openTag'), (K.tokenize = d), 'tag bracket');
                if (I == '&') {
                    var B;
                    return (
                        _.eat('#')
            ...
            function d(_, K) {
                var X = _.next();
                if (X == '>' || (X == '/' && _.eat('>')))
                    return (K.tokenize = c), (T = X == '>' ? 'endTag' : 'selfcloseTag'), 'tag bracket';
                ...
                if (X == '<') {
                    ...
                    return /[\'\"]/.test(X)
                        ? ((K.tokenize = w(X)), (K.stringStartCol = _.column()), K.tokenize(_, K))
                        : (_.match(/^[^\s\u00a0=<>\"\']*[^\s\u00a0=<>\"\'\/]/), 'word');
            }
            function w(_) {
                var K = function (X, I) {
            ...
            function R(_, K, X) {
                (this.prev = _.context),
                    ...
                    (this.startOfLine = X),
                    (s.doNotIndent.hasOwnProperty(K) || (_.context && _.context.noIndent)) && (this.noIndent = !0);
            }
            function M(_) {
            ...
            function H(_, K) {
                for (var X; ; ) {
                    if (
                        !_.context ||
                        ((X = _.context.tagName),
                        !s.contextGrabbers.hasOwnProperty(y(X)) || !s.contextGrabbers[y(X)].hasOwnProperty(y(K)))
                    )
                        return;
                    M(_);
                }
            ...
            function Z(_, K, X) {
                return _ == 'openTag' ? ((X.tagStart = K.column()), ee) : _ == 'closeTag' ? re : Z;
            }
            function ee(_, K, X) {
                return _ == 'word'
            ...
            function Q(_, K, X) {
                return _ == 'equals' ? j : (s.allowMissing || (x = 'error'), D(_, K, X));
            }
            function j(_, K, X) {
                return _ == 'string'
                    ? V
            ...
            return {
                startState: function (_) {
                    var K = { tokenize: c, state: Z, indented: _ || 0, tagName: null, tagStart: null, context: null };
                    return _ != null && (K.baseIndent = _), K;
                },
                token: function (_, K) {
                    if ((!K.tagName && _.sol() && (K.indented = _.indentation()), _.eatSpace())) return null;
                    T = null;
                    var X = K.tokenize(_, K);
                    return (
                        (X || T) &&
                            X != 'comment' &&
                            ((x = null), (K.state = K.state(T || X, _, K)), x && (X = x == 'error' ? X + ' error' : x)),
                        X
                    );
                },
                indent: function (_, K, X) {
                    ...
                    if (_.tokenize.isInAttribute)
                        return _.tagStart == _.indented ? _.stringStartCol + 1 : _.indented + S;
                    if (I && I.noIndent) return o.Pass;
                    if (_.tokenize != d && _.tokenize != c) return X ? X.match(/^(\s*)/)[0].length : 0;
                    if (_.tagName)
                ...
                xmlCurrentTag: function (_) {
                    return _.tagName ? { name: _.tagName, close: _.type == 'closeTag' } : null;
                },
...
var vn = Ke((Fs, Ns) => {
    (function (o) {
        ...
        o.defineMode('javascript', function (p, v) {
            ...
            function R(k, O) {
                var ae = k.next();
                if (ae == '"' || ae == "'") return (O.tokenize = M(ae)), O.tokenize(k, O);
                if (ae == '.' && k.match(/^\d[\d_]*(?:[eE][+\-]?[\d_]+)?/)) return y('number', 'number');
                if (ae == '.' && k.match('..')) return y('spread', 'meta');
                if (/[\[\]{}\(\),;\:\.]/.test(ae)) return y(ae);
                if (ae == '=' && k.eat('>')) return y('=>', 'operator');
                if (ae == '0' && k.match(/^(?:x[\dA-Fa-f_]+|o[0-7_]+|b[01_]+)n?/)) return y('number', 'number');
                if (/\d/.test(ae))
                    return k.match(/^[\d_]*(?:n|(?:\.[\d_]*)?(?:[eE][+\-]?[\d_]+)?)?/), y('number', 'number');
                if (ae == '/')
                    return k.eat('*')
                        ? ((O.tokenize = H), H(k, O))
                        : k.eat('/')
                          ...
                          : jt(k, O, 1)
                            ? (w(k), k.match(/^\b(([gimyus])(?![gimyus]*\2))+\b/), y('regexp', 'string-2'))
                            : (k.eat('='), y('operator', 'operator', k.current()));
                if (ae == '`') return (O.tokenize = Z), Z(k, O);
                if (ae == '#' && k.peek() == '!') return k.skipToEnd(), y('meta', 'meta');
                if (ae == '#' && k.eatWhile(T)) return y('variable', 'property');
                if (
                    (ae == '<' && k.match('!--')) ||
                ...
                if (c.test(ae))
                    return (
                        (ae != '>' || !O.lexical || O.lexical.type != '>') &&
                            (k.eat('=')
                                ? (ae == '!' || ae == '=') && k.eat('=')
                                : /[<>*+\-|&?]/.test(ae) && (k.eat(ae), ae == '>' && k.eat(ae))),
                        ae == '?' && k.eat('.') ? y('.') : y('operator', 'operator', k.current())
                    );
                if (T.test(ae)) {
                    k.eatWhile(T);
                    var he = k.current();
            ...
            function M(k) {
                return function (O, ae) {
                    var he = !1,
                        ne;
                    if (S && O.peek() == '@' && O.match(d)) return (ae.tokenize = R), y('jsonld-keyword', 'meta');
                    for (; (ne = O.next()) != null && !(ne == k && !he); ) he = !he && ne == '\\';
            ...
            function re(k, O) {
                ...
                if (!(ae < 0)) {
                    if (g) {
                        var he = /:\s*(?:\w+(?:<[^>]*>|\[\])?|\{[^}]*\})\s*$/.exec(k.string.slice(k.start, ae));
                        he && (ae = he.index);
                    }
            ...
            function D(k, O) {
                if (!h) return !1;
                for (var ae = k.localVars; ae; ae = ae.next) if (ae.name == O) return !0;
            ...
            function Q(k, O, ae, he, ne) {
                ...
                for (
                    ...
                    if (Xe(ae, he)) {
                        ...
                        return j.marked ? j.marked : ae == 'variable' && D(k, he) ? 'variable-2' : O;
                    }
                }
            }
            ...
            function X(k) {
                ...
                if (((j.marked = 'def'), !!h)) {
                    ...
                    v.globalVars && !K(k, O.globalVars) && (O.globalVars = new xe(k, O.globalVars));
                }
            }
            function I(k, O) {
                if (O)
                    ...
                    } else return K(k, O.vars) ? O : new le(O.prev, new xe(k, O.vars), !1);
                else return null;
            }
            function B(k) {
                return k == 'public' || k == 'private' || k == 'protected' || k == 'abstract' || k == 'readonly';
            }
            function le(k, O, ae) {
            ...
            function pe(k, O) {
                var ae = function () {
                    ...
                    else for (var ye = he.lexical; ye && ye.type == ')' && ye.align; ye = ye.prev) ne = ye.indented;
            ...
            function Ee() {
                var k = j.state;
                k.lexical.prev &&
                    (k.lexical.type == ')' && (k.indented = k.lexical.indented), (k.lexical = k.lexical.prev));
            }
            Ee.lex = !0;
            function ge(k) {
                function O(ae) {
                    return ae == k ? _() : k == ';' || ae == '}' || ae == ')' || ae == ']' ? V() : _(O);
                }
                return O;
            }
            function Oe(k, O) {
                                  ...
                                  : k == 'function'
                                    ...
                                    : k == 'for'
                                      ...
                                      : k == 'class' || (g && O == 'interface')
                                        ? ((j.marked = 'keyword'), _(pe('form', k == 'class' ? k : O), Wr, Ee))
                                        : k == 'variable'
                                          ? g && O == 'declare'
                                                ...
                                                ? ((j.marked = 'keyword'),
                                                  O == 'enum'
                                                      ...
                                                      : O == 'type'
                                                        ...
                                                        : _(pe('form'), Ct, ge('{'), pe('}'), De, Ee, Ee))
                                                : g && O == 'namespace'
                                                  ? ((j.marked = 'keyword'), _(pe('form'), Se, Oe, Ee))
                                                  : g && O == 'abstract'
                                                    ? ((j.marked = 'keyword'), _(Oe))
                                                    : _(pe('stat'), Ue)
                                          : k == 'switch'
                                            ? _(pe('form'), Ze, ge('{'), pe('}', 'switch'), de, De, Ee, Ee, ze)
                                            : k == 'case'
                                              ? _(Se, ge(':'))
                                              : k == 'default'
                                                ? _(ge(':'))
                                                : k == 'catch'
                                                  ? _(pe('form'), L, qe, Oe, Ee, ze)
                                                  : k == 'export'
                                                    ? _(pe('stat'), Ur, Ee)
                                                    : k == 'import'
                                                      ? _(pe('stat'), gr, Ee)
            ...
            function ke(k, O, ae) {
                if (j.state.fatArrowAt == j.stream.start) {
                    var he = ae ? Be : ce;
                    if (k == '(') return _(L, pe(')'), W($t, ')'), Ee, ge('=>'), he, ze);
            ...
            function U(k, O) {
                return k != 'quasi' ? V() : O.slice(O.length - 2) != '${' ? _(U) : _(Je, G);
            }
            function G(k) {
                if (k == '}') return (j.marked = 'string-2'), (j.state.tokenize = Z), _(U);
            }
            function ce(k) {
            ...
            function te(k) {
                return function (O) {
                    return O == '.' ? _(k ? oe : fe) : O == 'variable' && g ? _(Ft, k ? Ge : He) : V(k ? je : Se);
                };
            }
            function fe(k, O) {
            ...
            function W(k, O, ae) {
                function he(ne, ye) {
                    ...
                    return ne == O || ye == O ? _() : ae && ae.indexOf(';') > -1 ? V(k) : _(ge(O));
                }
            ...
            function Pt(k) {
                if (g && k == ':') return j.stream.match(/^\s*\w+\s+is\b/, !1) ? _(Se, It, Pe) : _(Pe);
            }
            function It(k, O) {
            ...
            function Fe(k) {
                return k.match(/[\}\)\]]/) ? _() : k == ',' || k == ';' ? _(Fe) : V(nr, Fe);
            }
            function nr(k, O) {
                if (k == 'variable' || j.style == 'keyword') return (j.marked = 'property'), _(nr);
            ...
            function _t(k, O) {
                return k != 'quasi' ? V() : O.slice(O.length - 2) != '${' ? _(_t) : _(Pe, it);
            }
            function it(k) {
                if (k == '}') return (j.marked = 'string-2'), (j.state.tokenize = Z), _(_t);
            }
            function ot(k, O) {
            ...
            function Ht(k, O) {
                ...
                if (O == 'extends' || O == 'implements') return (j.marked = 'keyword'), _(Pe);
            ...
            function Hr(k, O) {
                return O == 'enum' ? ((j.marked = 'keyword'), _(Ae)) : V(Ct, nt, Ut, eo);
            }
            function Ct(k, O) {
            ...
            function Br(k, O) {
                if (k == 'keyword b' && O == 'else') return _(pe('form', 'else'), Oe, Ee);
            }
            function ei(k, O) {
            ...
            function ti(k, O) {
                if (k == 'keyword' || k == 'variable') return (j.marked = 'type'), _(ti);
            ...
            function Kt(k, O) {
                ...
                if (O == 'extends' || O == 'implements' || (g && k == ','))
                    return O == 'implements' && (j.marked = 'keyword'), _(g ? Pe : Se, Kt);
            ...
            function Gt(k, O) {
                ...
                if (k == 'variable' || j.style == 'keyword') return (j.marked = 'property'), _(Cr, Gt);
            ...
            function gr(k) {
                return k == 'string' ? _() : k == '(' ? V(Se) : k == '.' ? V(He) : V(Kr, Vt, Gr);
            }
            function Kr(k, O) {
                return k == '{' ? se(Kr, '}') : (k == 'variable' && X(O), O == '*' && (j.marked = 'keyword'), _(_n));
            }
            function Vt(k) {
                if (k == ',') return _(Kr, Vt);
            }
            ...
            function kn(k, O) {
                return k.lastType == 'operator' || k.lastType == ',' || c.test(O.charAt(0)) || /[,.]/.test(O.charAt(0));
            }
            function jt(k, O, ae) {
                return (
                    (O.tokenize == R &&
                    ...
                    (O.lastType == 'quasi' && /\{\s*$/.test(k.string.slice(0, k.pos - (ae || 0))))
                );
            }
            return {
                startState: function (k) {
                    ...
                    return v.globalVars && typeof v.globalVars == 'object' && (O.globalVars = v.globalVars), O;
                },
                token: function (k, O) {
                    if (
                        (k.sol() &&
                    ...
                    return E == 'comment'
                        ? ae
                        : ((O.lastType = E == 'operator' && (z == '++' || z == '--') ? 'incdec' : E),
                          Q(O, ae, E, z, k));
                },
                indent: function (k, O) {
                    ...
                    for (
                        ...
                        (ae == '}' ||
                            ((ne = k.cc[k.cc.length - 1]) && (ne == He || ne == Ge) && !/^[,\.=+\-*:?[\(]/.test(O)));
                    ...
                    var pt = he.type,
                        Et = ae == pt;
                    return pt == 'vardef'
                        ? he.indented + (k.lastType == 'operator' || k.lastType == ',' ? he.info.length + 1 : 0)
                        : pt == 'form' && ae == '{'
                          ? he.indented
                          : pt == 'form'
                            ? he.indented + C
    ...
    (function (o) {
        ...
        function v(T, x, c) {
            ...
            return (
                w > -1
                    ? T.backUp(d.length - w)
                    : d.match(/<\/?$/) && (T.backUp(d.length), T.match(x, !1) || T.match(d)),
                c
            );
        }
        var C = {};
        function b(T) {
            var x = C[T];
            return x || (C[T] = new RegExp('\\s+' + T + `\\s*=\\s*('|")?([^'"]+)('|")?\\s*`));
        }
        function S(T, x) {
            var c = T.match(b(x));
        ...
        function h(T, x) {
            for (var c in T) for (var d = x[c] || (x[c] = []), w = T[c], E = w.length - 1; E >= 0; E--) d.unshift(w[E]);
        }
        function g(T, x) {
        ...
        o.defineMode(
            ...
            function (T, x) {
                ...
                function y(R, M) {
                    ...
                    } else M.inTag && ((M.inTag += R.current()), R.eol() && (M.inTag += ' '));
                    return H;
                }
                return {
                    startState: function () {
                        var R = o.startState(c);
                        return { token: y, inTag: null, localMode: null, localState: null, htmlState: R };
                    },
                    ...
                    innerMode: function (R) {
                        return { state: R.localState || R.htmlState, mode: R.localMode || c };
                    },
                };
            },
            'xml',
                    ...
                    : c.match(/\b(\w+)\b/)
                      ...
                      : c.match('%}')
                        ? ((d.waitProperty = null),
                          ...
                          (d.waitDot = null),
                          (d.waitPipe = null),
                          d.blockCommentTag ? ((d.blockCommentTag = !1), (d.tokenize = x)) : (d.tokenize = S),
                          'tag')
                        : (c.next(), 'null');
            }
            function T(c, d) {
...
var Di = Ke((Bs, Ws) => {
    (function (o) {
            ...
            (o.simpleMode = function (x, c) {
                ...
                var Z = {
                    ...
                    copyState: function (re) {
                        ...
                        re.localState && (N.localState = o.copyState(re.local.mode, re.localState)),
                            re.stack && (N.stack = re.stack.slice(0));
                        for (var F = re.persistentStates; F; F = F.next)
                            N.persistentStates = {
                                mode: F.mode,
                                spec: F.spec,
                                state: F.state == re.localState ? N.localState : o.copyState(F.mode, F.state),
        ...
        function p(x, c) {
            if (!x.hasOwnProperty(c)) throw new Error('Undefined state ' + c + ' in simple mode');
        }
        function v(x, c) {
            if (!x) return /(?:)/;
            var d = '';
        ...
        function C(x) {
            ...
            for (var c = [], d = 0; d < x.length; d++) c.push(x[d] && x[d].replace(/\./g, ' '));
            return c;
        }
        function b(x, c) {
        ...
        function S(x, c) {
            return function (d, w) {
                if (w.pending) {
                    ...
                    return w.pending.length == 0 && (w.pending = null), (d.pos += E.text.length), E.token;
                }
                if (w.local)
                    if (w.local.end && d.match(w.local.end)) {
                        ...
                        var z = w.local.mode.token(d, w.localState),
                            y;
                        return (
                            w.local.endScan && (y = w.local.endScan.exec(d.current())) && (d.pos = d.start + y.index), z
                        );
                    }
                    ...
                    if (Z) {
                        H.data.next
                            ...
                            : H.data.push
                              ...
                              : H.data.pop && w.stack && w.stack.length && (w.state = w.stack.pop()),
                            H.data.mode && h(c, w, H.data.mode, H.token),
                            H.data.indent && w.indent.push(d.indentation() + c.indentUnit),
                            H.data.dedent && w.indent.pop();
                        var ee = H.token;
                        if ((ee && ee.apply && (ee = ee(Z)), Z.length > 2 && H.token && typeof H.token != 'string')) {
                            for (var re = 2; re < Z.length; re++)
                                Z[re] && (w.pending || (w.pending = [])).push({ text: Z[re], token: H.token[re - 1] });
        ...
        function h(x, c, d, w) {
            ...
            d.persistent && !E && (c.persistentStates = { mode: y, spec: d.spec, state: R, next: c.persistentStates }),
                (c.localState = R),
                (c.local = {
                    mode: y,
                    end: d.end && v(d.end),
        ...
        function T(x, c) {
            return function (d, w, E) {
                if (d.local && d.local.mode.indent) return d.local.mode.indent(d.localState, w, E);
                if (d.indent == null || d.local || (c.dontIndentStates && g(d.state, c.dontIndentStates) > -1))
                    return o.Pass;
                ...
                e: for (;;) {
                    for (var R = 0; R < y.length; R++) {
                        ...
                        if (M.data.dedent && M.data.dedentIfLineStart !== !1) {
                            ...
                            if (H && H[0]) {
                                z--, (M.next || M.push) && (y = x[M.next || M.push]), (w = w.slice(H[0].length));
                                continue e;
                            }
                        }
                    }
...
var Ks = Ke((Us, $s) => {
    (function (o) {
        ...
        var p = 'from',
            ...
            g = [p, S].concat(C).concat(h),
            T = '(' + g.join('|') + ')',
            x = new RegExp('^(\\s*)' + T + '(\\s*)(#.*)?$', 'i'),
            c = new RegExp('^(\\s*)' + T + '(\\s+)', 'i');
    ...
    (function (o) {
        ...
        (o.findModeByMIME = function (C) {
            ...
            for (var b = 0; b < o.modeInfo.length; b++) {
                ...
                if (S.mimes) {
                    for (var s = 0; s < S.mimes.length; s++) if (S.mimes[s] == C) return S;
                }
            }
            ...
            (o.findModeByFileName = function (C) {
                ...
                var s = C.lastIndexOf('.'),
                    h = s > -1 && C.substring(s + 1, C.length);
            ...
            (o.findModeByName = function (C) {
                ...
                for (var b = 0; b < o.modeInfo.length; b++) {
                    ...
                    if (S.alias) {
                        for (var s = 0; s < S.alias.length; s++) if (S.alias[s].toLowerCase() == C) return S;
                    }
                }
            });
    });
    ...
    (function (o) {
        ...
        o.defineMode(
            ...
            function (p, v) {
                ...
                for (var h in s) s.hasOwnProperty(h) && v.tokenTypeOverrides[h] && (s[h] = v.tokenTypeOverrides[h]);
                var g = /^([*\-_])(?:\s*\1){2,}\s*$/,
                    T = /^(?:[*\-+]|^[0-9]+([.)]))\s+/,
                    x = /^\[(x| )\](?=\s)/i,
                ...
                function re(q, L) {
                    var de = q.column() === L.indentation,
                        ze = Z(L.prevLine.stream),
                        pe = L.indentedCode,
                        Ee = L.prevLine.hr,
                        ge = L.list !== !1,
                        Oe = (L.listStack[L.listStack.length - 1] || 0) + 3;
                    L.indentedCode = !1;
                    var qe = L.indentation;
                    if (L.indentationDiff === null && ((L.indentationDiff = L.indentation), ge)) {
                        for (L.list = null; qe < L.listStack[L.listStack.length - 1]; )
                            L.listStack.pop(),
                                L.listStack.length
                                    ? (L.indentation = L.listStack[L.listStack.length - 1])
                                    : (L.list = !1);
                        L.list !== !1 && (L.indentationDiff = qe - L.listStack[L.listStack.length - 1]);
                    }
                    var Se = !ze && !Ee && !L.prevLine.header && (!ge || !pe) && !L.prevLine.fencedCodeEnd,
                        je = (L.list === !1 || Ee || ze) && L.indentation <= Oe && q.match(g),
                        Ze = null;
                    if (L.indentationDiff >= 4 && (pe || L.prevLine.fencedCodeEnd || L.prevLine.header || ze))
                        return q.skipToEnd(), (L.indentedCode = !0), s.code;
                    if (q.eatSpace()) return null;
                    if (de && L.indentation <= Oe && (Ze = q.match(c)) && Ze[1].length <= 6)
                        return (
                            (L.quote = 0),
                    ...
                    if (!je && !L.setext && de && L.indentation <= Oe && (Ze = q.match(T))) {
                        var ke = Ze[1] ? 'ol' : 'ul';
                        return (
                            ...
                            (L.f = L.inline),
                            v.highlightFormatting && (L.formatting = ['list', 'list-' + ke]),
                            D(L)
                        );
                    } else {
                        if (de && L.indentation <= Oe && (Ze = q.match(E, !0)))
                            return (
                                (L.quote = 0),
                                (L.fencedEndRE = new RegExp(Ze[1] + '+ *$')),
                                (L.localMode =
                                    v.fencedCodeBlockHighlighting && S(Ze[2] || v.fencedCodeBlockDefaultMode)),
                                L.localMode && (L.localState = o.startState(L.localMode)),
                                (L.f = L.block = F),
                            ...
                            return (
                                L.setext
                                    ? ((L.header = L.setext),
                                      ...
                                      q.skipToEnd(),
                                      v.highlightFormatting && (L.formatting = 'header'))
                                    : ((L.header = Ze[0].charAt(0) == '=' ? 1 : 2), (L.setext = L.header)),
                                (L.thisLine.header = !0),
                                (L.f = L.inline),
                                D(L)
                            );
                        if (je) return q.skipToEnd(), (L.hr = !0), (L.thisLine.hr = !0), s.hr;
                        if (q.peek() === '[') return M(q, L, I);
                    }
                    return M(q, L, L.inline);
                }
                function N(q, L) {
                    var de = C.token(q, L.htmlState);
                    if (!b) {
                        var ze = o.innerMode(C, L.htmlState);
                        ((ze.mode.name == 'xml' &&
                ...
                function F(q, L) {
                    var de = L.listStack[L.listStack.length - 1] || 0,
                        ze = L.indentation < de,
                        pe = de + 3;
                    if (L.fencedEndRE && L.indentation <= pe && (ze || q.match(L.fencedEndRE))) {
                        v.highlightFormatting && (L.formatting = 'code-block');
                        var Ee;
                        return (
                            ze || (Ee = D(L)),
                    ...
                    } else return L.localMode ? L.localMode.token(q, L.localState) : (q.skipToEnd(), s.code);
                }
                function D(q) {
                    var L = [];
                    if (q.formatting) {
                        L.push(s.formatting), typeof q.formatting == 'string' && (q.formatting = [q.formatting]);
                        for (var de = 0; de < q.formatting.length; de++)
                            L.push(s.formatting + '-' + q.formatting[de]),
                                q.formatting[de] === 'header' &&
                                    L.push(s.formatting + '-' + q.formatting[de] + '-' + q.header),
                                q.formatting[de] === 'quote' &&
                                    (!v.maxBlockquoteDepth || v.maxBlockquoteDepth >= q.quote
                                        ? L.push(s.formatting + '-' + q.formatting[de] + '-' + q.quote)
                                        : L.push('error'));
                    }
                    if (q.taskOpen) return L.push('meta'), L.length ? L.join(' ') : null;
                    if (q.taskClosed) return L.push('property'), L.length ? L.join(' ') : null;
                    if (
                        (q.linkHref
                        ...
                        ze ? (ze === 1 ? L.push(s.list2) : L.push(s.list3)) : L.push(s.list1);
                    }
                    return (
                        q.trailingSpaceNewLine
                            ? L.push('trailing-space-new-line')
                            : q.trailingSpace && L.push('trailing-space-' + (q.trailingSpace % 2 ? 'a' : 'b')),
                ...
                function j(q, L) {
                    ...
                    if (((L.taskOpen = !1), (L.taskClosed = !1), L.header && q.match(/^#+$/, !0)))
                        return v.highlightFormatting && (L.formatting = 'header'), D(L);
                    var pe = q.next();
                    if (L.linkTitle) {
                        L.linkTitle = !1;
                        var Ee = pe;
                        pe === '(' && (Ee = ')'), (Ee = (Ee + '').replace(/([.?*+^\[\]\\(){}|-])/g, '\\$1'));
                        var ge = '^\\s*(?:[^' + Ee + '\\\\]+|\\\\\\\\|\\\\.)' + Ee;
                        if (q.match(new RegExp(ge), !0)) return s.linkHref;
                    }
                    if (pe === '`') {
                        var Oe = L.formatting;
                        v.highlightFormatting && (L.formatting = 'code'), q.eatWhile('`');
                        var qe = q.current().length;
                        if (L.code == 0 && (!L.quote || qe == 1)) return (L.code = qe), D(L);
                        if (qe == L.code) {
                            var Se = D(L);
                            return (L.code = 0), Se;
                    ...
                    if (pe === ']' && L.imageAltText) {
                        v.highlightFormatting && (L.formatting = 'image');
                        var je = D(L);
                        return (L.imageAltText = !1), (L.image = !1), (L.inline = L.f = _), je;
                    }
                    if (pe === '[' && !L.image)
                        return (
                            (L.linkText && q.match(/^.*?\]/)) ||
                                ((L.linkText = !0), v.highlightFormatting && (L.formatting = 'link')),
                            D(L)
                        );
                    if (pe === ']' && L.linkText) {
                        v.highlightFormatting && (L.formatting = 'link');
                        var je = D(L);
                        return (L.linkText = !1), (L.inline = L.f = q.match(/\(.*?\)| ?\[.*?\]/, !1) ? _ : j), je;
                    }
                    if (pe === '<' && q.match(/^(https?|ftps?):\/\/(?:[^\\>]|\\.)+>/, !1)) {
                        (L.f = L.inline = V), v.highlightFormatting && (L.formatting = 'link');
                        var je = D(L);
                    ...
                    if (
                        ...
                        if (ke != -1) {
                            ...
                            /markdown\s*=\s*('|"){0,1}1('|"){0,1}/.test(Je) && (L.md_inside = !0);
                        }
                        return q.backUp(1), (L.htmlState = o.startState(C)), H(q, L, N);
                    }
                    if (v.xml && pe === '<' && q.match(/^\/\w*?>/)) return (L.md_inside = !1), 'tag';
                    if (pe === '*' || pe === '_') {
                        for (var He = 1, Ge = q.pos == 1 ? ' ' : q.string.charAt(q.pos - 2); He < 3 && q.eat(pe); )
                            He++;
                        var U = q.peek() || ' ',
                        ...
                        if (
                            (He % 2 &&
                                (!L.em && G && (pe === '*' || !ce || y.test(Ge))
                                    ? (Be = !0)
                                    : L.em == pe && ce && (pe === '*' || !G || y.test(U)) && (Be = !1)),
                            He > 1 &&
                                (!L.strong && G && (pe === '*' || !ce || y.test(Ge))
                                    ? (te = !0)
                                    : L.strong == pe && ce && (pe === '*' || !G || y.test(U)) && (te = !1)),
                            te != null || Be != null)
                        ) {
                            v.highlightFormatting &&
                                (L.formatting = Be == null ? 'strong' : te == null ? 'em' : 'strong em'),
                                Be === !0 && (L.em = pe),
                                te === !0 && (L.strong = pe);
                            var Se = D(L);
                            return Be === !1 && (L.em = !1), te === !1 && (L.strong = !1), Se;
                        }
                    ...
                    if (v.strikethrough) {
                        if (pe === '~' && q.eatWhile(pe)) {
                            if (L.strikethrough) {
                                v.highlightFormatting && (L.formatting = 'strikethrough');
                                var Se = D(L);
                    ...
                    if (v.emoji && pe === ':' && q.match(/^(?:[a-z_\d+][a-z_\d+-]*|\-[a-z_\d+][a-z_\d+-]*):/)) {
                        (L.emoji = !0), v.highlightFormatting && (L.formatting = 'emoji');
                        var fe = D(L);
                        return (L.emoji = !1), fe;
                    }
                    return (
                        pe === ' ' &&
                            (q.match(/^ +$/, !1)
                                ? L.trailingSpace++
                                : L.trailingSpace && (L.trailingSpaceNewLine = !0)),
                        D(L)
                    );
                }
                function V(q, L) {
                    var de = q.next();
                    if (de === '>') {
                        (L.f = L.inline = j), v.highlightFormatting && (L.formatting = 'link');
                        var ze = D(L);
                ...
                function _(q, L) {
                    ...
                    return de === '(' || de === '['
                        ? ((L.f = L.inline = X(de === '(' ? ')' : ']')),
                          v.highlightFormatting && (L.formatting = 'link-string'),
                          (L.linkHref = !0),
                          D(L))
                        : 'error';
                }
                ...
                function B(q, L) {
                    if (q.match(']:', !0)) {
                        (L.f = L.inline = le), v.highlightFormatting && (L.formatting = 'link');
                        var de = D(L);
                ...
                var xe = {
                    ...
                    token: function (q, L) {
                        if (((L.formatting = !1), q != L.thisLine.stream)) {
                            if (((L.header = 0), (L.hr = !1), q.match(/^\s*$/, !0))) return ee(L), null;
                            if (
                                ...
                                if (((L.indentation = de), (L.indentationDiff = null), de > 0)) return null;
                            }
                        }
                        return L.f(q, L);
                    },
                ...
                var s = {
                        ...
                        token: function (T, x) {
                            if (((x.combineTokens = null), x.codeBlock))
                                return T.match(/^```+/) ? ((x.codeBlock = !1), null) : (T.skipToEnd(), null);
                            if ((T.sol() && (x.code = !1), T.sol() && T.match(/^```+/)))
                            ...
                            if (T.peek() === '`') {
                                ...
                                T.eatWhile('`');
                                var d = 1 + T.pos - c;
                                return x.code ? d === b && (x.code = !1) : ((b = d), (x.code = !0)), null;
                            } else if (x.code) return T.next(), null;
                            if (T.eatSpace()) return (x.ateSpace = !0), null;
                            if ((T.sol() || x.ateSpace) && ((x.ateSpace = !1), C.gitHubSpice !== !1)) {
                                if (
                                    T.match(
                                ...
                                if (T.match(/^(?:[a-zA-Z0-9\-_]+\/)?(?:[a-zA-Z0-9\-_]+)?#[0-9]+\b/))
                                    return (x.combineTokens = !0), 'link';
                            }
                            return T.match(p) &&
                    ...
                    h = { taskLists: !0, strikethrough: !0, emoji: !0 };
...
var nu = Ke((tu, ru) => {
    (function (o) {
        ...
        o.defineMode('go', function (p) {
            ...
            function h(w, E) {
                var z = w.next();
                if (z == '"' || z == "'" || z == '`') return (E.tokenize = g(z)), E.tokenize(w, E);
                if (/[\d\.]/.test(z))
                    return (
                        z == '.'
            ...
            function g(w) {
                return function (E, z) {
                    ...
                    return (M || !(y || w == '`')) && (z.tokenize = h), 'string';
                };
            }
            function T(w, E) {
            ...
            function x(w, E, z, y, R) {
                (this.indented = w), (this.column = E), (this.type = z), (this.align = y), (this.prev = R);
            }
            function c(w, E, z) {
            ...
            function d(w) {
                if (w.context.prev) {
                    ...
                    return (
                        (E == ')' || E == ']' || E == '}') && (w.indented = w.context.indented),
            ...
            return {
                startState: function (w) {
                    return { tokenize: null, context: new x((w || 0) - v, 0, 'top', !1), indented: 0, startOfLine: !0 };
                },
                token: function (w, E) {
                    var z = E.context;
                    if (
                ...
                indent: function (w, E) {
                    ...
                    var z = w.context,
                        y = E && E.charAt(0);
                    if (z.type == 'case' && /^(?:case|default)\b/.test(E)) return (w.context.type = '}'), z.indented;
                    var R = y == z.type;
...
var au = Ke((iu, ou) => {
    (function (o) {
        ...
        o.defineMode('http', function () {
            ...
            function s(T, x) {
                return T.match(/^HTTP\/\d\.\d$/) ? ((x.cur = h), 'keyword') : p(T, x);
            }
            function h(T) {
                return T.sol() && !T.eat(/[ \t]/)
                    ? T.match(/^.*?:/)
    ...
    (function (o) {
        ...
        o.defineMode('jinja2', function () {
            ...
            function s(h, g) {
                var T = h.peek();
                if (g.incomment)
                    return h.skipTo('#}') ? (h.eatWhile(/\#|}/), (g.incomment = !1)) : h.skipToEnd(), 'comment';
                if (g.intag) {
                    if (g.operator) {
                    ...
                    if (g.instring) return T == g.instring && (g.instring = !1), h.next(), 'string';
                    if (T == "'" || T == '"') return (g.instring = T), h.next(), 'string';
                    if (g.inbraces > 0 && T == ')') h.next(), g.inbraces--;
                    else if (T == '(') h.next(), g.inbraces++;
                    else if (g.inbrackets > 0 && T == ']') h.next(), g.inbrackets--;
                    else if (T == '[') h.next(), g.inbrackets++;
                    else {
                        if (!g.lineTag && (h.match(g.intag + '}') || (h.eat('-') && h.match(g.intag + '}'))))
                            return (g.intag = !1), 'tag';
                        if (h.match(v)) return (g.operator = !0), 'operator';
                        if (h.match(C)) g.sign = !0;
                        else {
                            if (h.column() == 1 && g.lineTag && h.match(p)) return 'keyword';
                            if (h.eat(' ') || h.sol()) {
                    ...
                    if (h.eat('#'))
                        return (
                            (g.incomment = !0),
                            h.skipTo('#}') ? (h.eatWhile(/\#|}/), (g.incomment = !1)) : h.skipToEnd(),
                            'comment'
                        );
                    if ((T = h.eat(/\{|%/)))
                        return (
                    ...
                    if (!h.eol()) return (g.intag = !0), (g.lineTag = !0), (g.inbraces = 0), (g.inbrackets = 0), 'tag';
                }
                h.next();
            }
            return {
    ...
    (function (o) {
        ...
        o.defineMode(
            ...
            function (C, b) {
                ...
                function g(c, d) {
                    return d.context.mode == S ? T(c, d, d.context) : x(c, d, d.context);
                }
                function T(c, d, w) {
                    if (w.depth == 2) return c.match(/^.*?\*\//) ? (w.depth = 1) : c.skipToEnd(), 'comment';
                    if (c.peek() == '{') {
                    ...
                    if (w.depth == 1) {
                        if (c.peek() == '<')
                            return (
                                S.skipAttribute(w.state),
                                (d.context = new p(o.startState(S, h(w.state)), S, 0, d.context)),
                                null
                            );
                ...
                function x(c, d, w) {
                    if (c.peek() == '<' && !c.match(/^<([^<>]|<[^>]*>)+,\s*>/, !1) && s.expressionAllowed(c, w.state))
                        return (
                            (d.context = new p(o.startState(S, s.indent(w.state, '', '')), S, 0, d.context)),
                    ...
                    if (!E && w.depth != null) {
                        var z = c.current();
                        z == '{' ? w.depth++ : z == '}' && --w.depth == 0 && (d.context = d.context.prev);
                    }
                    return E;
                }
                return {
...
var gu = Ke((pu, hu) => {
    (function (o) {
        ...
        o.defineMode('nginx', function (p) {
            function v(w) {
                for (var E = {}, z = w.split(' '), y = 0; y < z.length; ++y) E[z[y]] = !0;
                return E;
            }
            var C = v(
            ...
            function d(w) {
                return function (E, z) {
                    for (var y = !1, R; (R = E.next()) != null && !(R == w && !y); ) y = !y && R == '\\';
                    ...
                    return (
                        ...
                        h == '{'
                            ...
                            : h == '}'
                              ...
                              : h == '@media'
                                ? E.stack.push('@media')
                                : y == '{' && h != 'comment' && E.stack.push('rule'),
                        z
                    );
                },
                indent: function (w, E) {
                    var z = w.stack.length;
                    return /^\}/.test(E) && (z -= w.stack[w.stack.length - 1] == 'rule' ? 2 : 1), w.baseIndent + z * s;
                },
                electricChars: '}',
            };
        }),
...
var bu = Ke((mu, vu) => {
    (function (o) {
        ...
        o.defineMode('pascal', function () {
            function p(T) {
                for (var x = {}, c = T.split(' '), d = 0; d < c.length; ++d) x[c[d]] = !0;
                return x;
            }
            var v = p(
            ...
            function S(T, x) {
                ...
                if (c == '"' || c == "'") return (x.tokenize = s(c)), x.tokenize(T, x);
...
var _u = Ke((yu, xu) => {
    (function (o) {
        ...
        o.defineMode('perl', function () {
            ...
            function x(c, d) {
                ...
                if (
                    ...
                    return 'number';
                if (c.match(/^<<(?=[_a-zA-Z])/)) return c.eatWhile(/\w/), T(c, d, c.current().substr(2));
                ...
                if (w == 'q') {
                    ...
                    if (!(y && /\w/.test(y))) {
                        if (((y = p(c, 0)), y == 'x')) {
                            if (((y = p(c, 1)), y == '(')) return b(c, 2), g(c, d, [')'], s, h);
                            if (y == '[') return b(c, 2), g(c, d, [']'], s, h);
                            if (y == '{') return b(c, 2), g(c, d, ['}'], s, h);
                            if (y == '<') return b(c, 2), g(c, d, ['>'], s, h);
                            if (/[\^'"!~\/]/.test(y)) return b(c, 1), g(c, d, [c.eat(y)], s, h);
                        } else if (y == 'q') {
                            if (((y = p(c, 1)), y == '(')) return b(c, 2), g(c, d, [')'], 'string');
                            if (y == '[') return b(c, 2), g(c, d, [']'], 'string');
                            if (y == '{') return b(c, 2), g(c, d, ['}'], 'string');
                            if (y == '<') return b(c, 2), g(c, d, ['>'], 'string');
                            if (/[\^'"!~\/]/.test(y)) return b(c, 1), g(c, d, [c.eat(y)], 'string');
                        } else if (y == 'w') {
                            if (((y = p(c, 1)), y == '(')) return b(c, 2), g(c, d, [')'], 'bracket');
                            if (y == '[') return b(c, 2), g(c, d, [']'], 'bracket');
                            if (y == '{') return b(c, 2), g(c, d, ['}'], 'bracket');
                            if (y == '<') return b(c, 2), g(c, d, ['>'], 'bracket');
                            if (/[\^'"!~\/]/.test(y)) return b(c, 1), g(c, d, [c.eat(y)], 'bracket');
                        } else if (y == 'r') {
                            if (((y = p(c, 1)), y == '(')) return b(c, 2), g(c, d, [')'], s, h);
                            if (y == '[') return b(c, 2), g(c, d, [']'], s, h);
                            if (y == '{') return b(c, 2), g(c, d, ['}'], s, h);
                ...
                if (w == '/') return /~\s*$/.test(v(c)) ? g(c, d, [w], s, h) : 'operator';
                if (w == '$') {
                    var E = c.pos;
                ...
                if (/[$@%&]/.test(w) && (c.eatWhile(/[\w$]/) || (c.eat('{') && c.eatWhile(/[\w$]/) && c.eat('}')))) {
                    var y = c.current();
                    return S[y] ? 'variable-2' : 'variable';
                }
                if (w == '#' && p(c, -2) != '$') return c.skipToEnd(), 'comment';
                if (/[:+\-\^*$&%@=<>!?|\/~\.]/.test(w)) {
                    var E = c.pos;
                    if ((c.eatWhile(/[:+\-\^*$&%@=<>!?|\/~\.]/), S[c.current()])) return 'operator';
                    c.pos = E;
                }
                if (w == '_' && c.pos == 1) {
        ...
        function b(S, s) {
            var h = S.pos + s,
                g;
            h <= 0 ? (S.pos = 0) : h >= (g = S.string.length - 1) ? (S.pos = g) : (S.pos = h);
        }
    });
});
var Su = Ke((ku, wu) => {
    (function (o) {
        ...
        function v(T, x, c) {
            return T.length == 0
                ? C(x)
                : function (d, w) {
                      for (var E = T[0], z = 0; z < E.length; z++)
                          if (d.match(E[z][0])) return (w.tokenize = v(T.slice(1), x)), E[z][1];
        ...
        function b(T, x, c, d) {
            if ((d !== !1 && T.match('${', !1)) || T.match('{$', !1)) return (x.tokenize = null), 'string';
            ...
            for (
                var w = !1;
                !T.eol() && (w || d === !1 || (!T.match('{$', !1) && !T.match(/^(\$[a-zA-Z_][a-zA-Z0-9_]*|\$\{)/, !1)));
            ...
            hooks: {
                ...
                '<': function (T, x) {
                    ...
                    if ((c = T.match(/^<<\s*/))) {
                        var d = T.eat(/['"]/);
                        T.eatWhile(/[\w\.]/);
                        var w = T.current().slice(c[0].length + (d ? 2 : 1));
                        if ((d && T.eat(d), w))
                            return (
                                (x.tokStack || (x.tokStack = [])).push(w, 0), (x.tokenize = C(w, d != "'")), 'string'
                            );
                    }
                    return !1;
                },
                ...
                '"': function (T, x) {
                    return (x.tokStack || (x.tokStack = [])).push('"', 0), (x.tokenize = C('"')), 'string';
                },
                '{': function (T, x) {
                    return x.tokStack && x.tokStack.length && x.tokStack[x.tokStack.length - 1]++, !1;
                },
                '}': function (T, x) {
                    return (
                        x.tokStack &&
        ...
        o.defineMode(
            'php',
            function (T, x) {
                var c = o.getMode(T, (x && x.htmlMode) || 'text/html'),
                    d = o.getMode(T, g);
                function w(E, z) {
                    var y = z.curMode == d;
                ...
                return {
                    ...
                    copyState: function (E) {
                        ...
                        return (
                            E.curMode == c ? (H = y) : (H = M),
                            { html: y, php: M, curMode: E.curMode, curState: H, pending: E.pending }
                        );
                    },
                    token: w,
    ...
    (function (o) {
        ...
        o.defineMode('python', function (h, g) {
            ...
            if (y) {
                ...
                (E = E.concat(['nonlocal', 'None', 'aiter', 'anext', 'async', 'await', 'breakpoint', 'match', 'case'])),
            ...
            function ee(K, X) {
                ...
                if ((I && (X.indent = K.indentation()), I && S(X).type == 'py')) {
                    ...
                    if (K.eatSpace()) {
                        ...
                        return le > B ? D(X) : le < B && j(K, X) && K.peek() != '#' && (X.errorToken = !0), null;
                    } else {
                        var xe = re(K, X);
                    ...
                    return function (L, de) {
                        ...
                        return (
                            ze == 'punctuation' &&
                                (L.current() == '{'
                                    ? (de.tokenize = le(q + 1))
                                    : L.current() == '}' && (q > 1 ? (de.tokenize = le(q - 1)) : (de.tokenize = xe))),
                            ze
                        );
                    };
                }
                function xe(q, L) {
                    for (; !q.eol(); )
                        if ((q.eatWhile(/[^'"\{\}\\]/), q.eat('\\'))) {
                            ...
                            if (q.match('{{')) return B;
                            if (q.match('{', !1)) return (L.tokenize = le(0)), q.current() ? B : L.tokenize(q, L);
                            if (q.match('}}')) return B;
                            if (q.match('}')) return T;
                            q.eat(/['"]/);
                        }
            ...
            function D(K) {
                ...
                K.scopes.push({ offset: S(K).offset + h.indentUnit, type: 'py', align: null });
            }
            function Q(K, X, I) {
            ...
            function j(K, X) {
                for (var I = K.indentation(); X.scopes.length > 1 && S(X).offset > I; ) {
            ...
            function V(K, X) {
                ...
                var I = X.tokenize(K, X),
                    B = K.current();
                if (X.beginningOfLine && B == '@') return K.match(R, !1) ? 'meta' : y ? 'operator' : T;
                if (
                    (/\S/.test(B) && (X.beginningOfLine = !1),
                    (I == 'variable' || I == 'builtin') && X.lastToken == 'meta' && (I = 'meta'),
                    (B == 'pass' || B == 'return') && (X.dedent = !0),
                    B == 'lambda' && (X.lambda = !0),
                    B == ':' && !X.lambda && S(X).type == 'py' && K.match(/^\s*(?:#|$)/, !1) && D(X),
                    B.length == 1 && !/string|comment/.test(I))
                ) {
                    var le = '[({'.indexOf(B);
                    if ((le != -1 && Q(K, X, '])}'.slice(le, le + 1)), (le = '])}'.indexOf(B)), le != -1))
                        if (S(X).type == B) X.indent = X.scopes.pop().offset - w;
                        else return T;
                }
                return X.dedent && K.eol() && S(X).type == 'py' && X.scopes.length > 1 && X.scopes.pop(), I;
            }
            var _ = {
                startState: function (K) {
                    return {
                ...
                token: function (K, X) {
                    ...
                    var B = V(K, X);
                    return (
                        B && B != 'comment' && (X.lastToken = B == 'keyword' || B == 'punctuation' ? K.current() : B),
                ...
                indent: function (K, X) {
                    ...
                    var I = S(K),
                        B =
                            I.type == X.charAt(0) ||
                            (I.type == 'py' && !K.dedent && /^(else:|elif |except |finally:)/.test(X));
                    return I.align != null ? I.align - (B ? 1 : 0) : I.offset - (B ? w : 0);
                },
...
var qu = Ke((Au, Du) => {
    (function (o) {
        ...
        o.defineMode('ruby', function (g) {
            ...
            function c(M, H) {
                if (M.sol() && M.match('=begin') && M.eol()) return H.tokenize.push(R), 'comment';
                if (M.eatSpace()) return null;
                var Z = M.next(),
                    ee;
                if (Z == '`' || Z == "'" || Z == '"') return x(z(Z, 'string', Z == '"' || Z == '`'), M, H);
                ...
                if (Z == '%') {
                    ...
                    var F = M.eat(/[^\w\s=]/);
                    return F ? (s.propertyIsEnumerable(F) && (F = s[F]), x(z(F, re, N, !0), M, H)) : 'operator';
                } else {
                    if (Z == '#') return M.skipToEnd(), 'comment';
                    if (Z == '<' && (ee = M.match(/^<([-~])[\`\"\']?([a-zA-Z_?]\w*)[\`\"\']?(?:;|$)/)))
                    ...
                    if (/\d/.test(Z)) return M.match(/^[\d_]*(?:\.[\d_]+)?(?:[eE][+\-]?[\d_]+)?/), 'number';
                    if (Z == '?') {
                        for (; M.match(/^\\[CM]-/); );
                        ...
                        if (Z == '|' && (H.varList || H.lastTok == '{' || H.lastTok == 'do')) return (T = '|'), null;
            ...
            function d(M) {
                for (var H = M.pos, Z = 0, ee, re = !1, N = !1; (ee = M.next()) != null; )
                    if (N) N = !1;
                    else {
                        if ('[{('.indexOf(ee) > -1) Z++;
            ...
            function w(M) {
                return (
                    ...
                    function (H, Z) {
                        if (H.peek() == '}') {
                            if (M == 1) return Z.tokenize.pop(), Z.tokenize[Z.tokenize.length - 1](H, Z);
                            Z.tokenize[Z.tokenize.length - 1] = w(M - 1);
                        } else H.peek() == '{' && (Z.tokenize[Z.tokenize.length - 1] = w(M + 1));
                        return c(H, Z);
                    }
                );
            }
            function E() {
                var M = !1;
                return function (H, Z) {
                    return M ? (Z.tokenize.pop(), Z.tokenize[Z.tokenize.length - 1](H, Z)) : ((M = !0), c(H, Z));
                };
            }
            function z(M, H, Z, ee) {
                return function (re, N) {
                    var F = !1,
                        D;
                    for (
                        N.context.type === 'read-quoted-paused' && ((N.context = N.context.prev), re.eat('}'));
                        (D = re.next()) != null;
            ...
            function y(M, H) {
                return function (Z, ee) {
                    return H && Z.eatSpace(), Z.match(M) ? ee.tokenize.pop() : Z.skipToEnd(), 'string';
                };
            }
            function R(M, H) {
                return M.sol() && M.match('=end') && M.eol() && H.tokenize.pop(), M.skipToEnd(), 'comment';
            }
            return {
                startState: function () {
                    return {
                ...
                token: function (M, H) {
                    ...
                    return (
                        ...
                        ee == 'indent' || /[\(\[\{]/.test(T)
                            ? (H.context = { prev: H.context, type: T || Z, indented: H.indented })
                            : (ee == 'dedent' || /[\)\]\}]/.test(T)) && H.context.prev && (H.context = H.context.prev),
                        M.eol() && (H.continuedLine = T == '\\' || Z == 'operator'),
                        Z
                    );
                },
                indent: function (M, H) {
                    ...
                    var Z = H && H.charAt(0),
                        ...
                        re =
                            ee.type == h[Z] ||
                            (ee.type == 'keyword' && /^(?:end|until|else|elsif|when|rescue)\b/.test(H));
                    return ee.indented + (re ? 0 : g.indentUnit) + (M.continuedLine ? g.indentUnit : 0);
                },
    ...
    (function (o) {
        ...
        o.defineMode(
            ...
            function (p) {
                ...
                function y(N, F) {
                    return function (D, Q) {
                        return D.sol() && D.indentation() <= N
                            ...
                            : (F && D.skipTo('*/') ? (D.next(), D.next(), (Q.tokenizer = ee)) : D.skipToEnd(),
                              'comment');
                    };
                }
                function R(N, F) {
                    ...
                    function D(Q, j) {
                        var V = Q.next(),
                            ...
                            X = (V !== '\\' && _ === N) || (V === N && K !== '\\');
                        return X
                            ? (V !== N && F && Q.next(), E(Q) && (j.cursorHalf = 0), (j.tokenizer = ee), 'string')
                            : V === '#' && _ === '{'
                ...
                function M(N) {
                    return function (F, D) {
                        return F.peek() === '}' ? (F.next(), (D.tokenizer = N), 'operator') : ee(F, D);
                    };
                }
                function H(N) {
                    if (N.indentCount == 0) {
                ...
                function ee(N, F) {
                    ...
                    if (D === '"' || D === "'") return N.next(), (F.tokenizer = R(D)), 'string';
                    if (F.cursorHalf) {
                        if (
                        ...
                        if (N.match(T)) return E(N) && (F.cursorHalf = 0), 'keyword';
                        ...
                        if (N.eatWhile(/[\w-]/))
                            if (N.match(/ *: *[\w-\+\$#!\("']/, !1)) {
                                ...
                                return N.match(/ *:/, !1)
                                    ? (H(F), (F.cursorHalf = 1), (F.prevProp = N.current().toLowerCase()), 'property')
                                    : (N.match(/ *,/, !1) || H(F), 'tag');
                ...
                function re(N, F) {
                    ...
                    if (((Q === '@return' || Q === '}') && Z(F), D !== null)) {
                        for (
                            var j = N.pos - Q.length, V = j + p.indentUnit * F.indentCount, _ = [], K = 0;
                            K < F.scopes.length;
                            K++
                        ) {
                            var X = F.scopes[K];
...
var Hu = Ke((ju, Ru) => {
    (function (o) {
        ...
        o.defineMode('shell', function () {
            ...
            o.registerHelper('hintWords', 'shell', C.concat(b, S)), v('atom', C), v('keyword', b), v('builtin', S);
            function s(d, w) {
                ...
                if (z === "'" || z === '"' || z === '`')
                    return w.tokens.unshift(h(z, z === '`' ? 'quote' : 'string')), c(d, w);
                ...
                d.eatWhile(/[\w-]/);
                var R = d.current();
                return d.peek() === '=' && /\w+/.test(R) ? 'def' : p.hasOwnProperty(R) ? p[R] : null;
            }
            function h(d, w) {
                var E = d == '(' ? ')' : d == '{' ? '}' : d;
                return function (z, y) {
                    for (var R, M = !1; (R = z.next()) != null; ) {
                        if (R === E && !M) {
                            ...
                            if (!M && d !== E && R === d) return y.tokens.unshift(h(d, w)), c(z, y);
                            if (!M && /['"]/.test(R) && !/['"]/.test(d)) {
            ...
            var T = function (d, w) {
                ...
                var E = d.next();
                return /['"({]/.test(E)
                    ? ((w.tokens[0] = h(E, E == '(' ? 'quote' : E == '{' ? 'def' : 'string')), c(d, w))
                    : (/\d/.test(E) || d.eatWhile(/\w/), w.tokens.shift(), 'def');
            };
            function x(d) {
                return function (w, E) {
                    return w.sol() && w.string == d && E.tokens.shift(), w.skipToEnd(), 'string-2';
                };
            }
            function c(d, w) {
...
var Uu = Ke((Bu, Wu) => {
    (function (o) {
        ...
        o.defineMode('sql', function (g, T) {
            var x = T.client || {},
                c = T.atoms || { false: !0, true: !0, null: !0 },
                d = T.builtin || s(h),
                w = T.keywords || s(S),
                E = T.operatorChars || /^[*+\-%<>!=&|~^\/]/,
                z = T.support || {},
                y = T.hooks || {},
                R = T.dateSQL || { date: !0, time: !0, timestamp: !0 },
                M = T.backslashStringEscapes !== !1,
                H = T.brackets || /^[\{}\(\)\[\]]/,
                Z = T.punctuation || /^[;.,:]/;
            function ee(Q, j) {
                var V = Q.next();
                ...
                if (
                    z.binaryNumber &&
                    (((V == 'b' || V == 'B') && Q.match(/^'[01]*'/)) || (V == '0' && Q.match(/^b[01]+/)))
                )
                    return 'number';
                ...
                if (V == '?' && (Q.eatSpace() || Q.eol() || Q.eat(';'))) return 'variable-3';
                if (V == "'" || (V == '"' && z.doubleQuote)) return (j.tokenize = re(V)), j.tokenize(Q, j);
                if (
                    ((z.nCharCast && (V == 'n' || V == 'N')) ||
                ...
                if (z.commentSlashSlash && V == '/' && Q.eat('/')) return Q.skipToEnd(), 'comment';
                if ((z.commentHash && V == '#') || (V == '-' && Q.eat('-') && (!z.commentSpaceRequired || Q.eat(' '))))
                    return Q.skipToEnd(), 'comment';
                if (V == '/' && Q.eat('*')) return (j.tokenize = N(1)), j.tokenize(Q, j);
                if (V == '.') {
                    if (z.zerolessFloat && Q.match(/^(?:\d+(?:e[+-]?\d+)?)/i)) return 'number';
                    ...
                    return R.hasOwnProperty(K) && (Q.match(/^( )+'[^']*'/) || Q.match(/^( )+"[^"]*"/))
                        ? 'number'
                        : c.hasOwnProperty(K)
                          ? 'atom'
                          : d.hasOwnProperty(K)
            ...
            function F(Q, j, V) {
                j.context = { prev: j.context, indent: Q.indentation(), col: Q.column(), type: V };
            }
            function D(Q) {
            ...
            return {
                ...
                token: function (Q, j) {
                    ...
                    var _ = Q.current();
                    return (
                        _ == '(' ? F(Q, j, ')') : _ == '[' ? F(Q, j, ']') : j.context && j.context.type == _ && D(j), V
                    );
                },
                indent: function (Q, j) {
                    var V = Q.context;
                    ...
                    return V.align ? V.col + (_ ? 0 : 1) : V.indent + (_ ? 0 : g.indentUnit);
                },
                blockCommentStart: '/*',
                blockCommentEnd: '*/',
        ...
        function p(g) {
            for (var T; (T = g.next()) != null; ) if (T == '`' && !g.eat('`')) return 'variable-2';
            return g.backUp(g.current().length - 1), g.eatWhile(/\w/) ? 'variable-2' : null;
        }
        function v(g) {
            for (var T; (T = g.next()) != null; ) if (T == '"' && !g.eat('"')) return 'variable-2';
            return g.backUp(g.current().length - 1), g.eatWhile(/\w/) ? 'variable-2' : null;
        ...
        function C(g) {
            return (
                g.eat('@') && (g.match('session.'), g.match('local.'), g.match('global.')),
                g.eat("'")
                    ? (g.match(/^.*'/), 'variable-2')
                    : g.eat('"')
                      ? (g.match(/^.*"/), 'variable-2')
        ...
        function b(g) {
            return g.eat('N') ? 'atom' : g.match(/^[a-zA-Z.#!?]/) ? 'variable-2' : null;
        }
        var S =
        ...
        function s(g) {
            for (var T = {}, x = g.split(' '), c = 0; c < x.length; ++c) T[x[c]] = !0;
            return T;
        }
        var h =
...
var ta = Ke(($u, Ku) => {
    (function (o) {
        ...
        o.defineMode('stylus', function (M) {
            ...
            function Oe($, W) {
                if (
                    ...
                    (W.context.line.firstWord = L ? L[0].replace(/^\s*/, '') : ''),
                ...
                if (ze == '"' || ze == "'") return $.next(), (W.tokenize = Se(ze)), W.tokenize($, W);
                if (ze == '@') return $.next(), $.eatWhile(/[\w\\-]/), ['def', $.current()];
                if (ze == '#') {
            ...
            function Se($) {
                return function (W, se) {
                    ...
                    return (nt == $ || (!De && $ != ')')) && (se.tokenize = null), ['string', 'string'];
                };
            }
            function je($, W) {
                return $.next(), $.match(/\s*[\"\')]/, !1) ? (W.tokenize = null) : (W.tokenize = Se(')')), [null, '('];
            }
            function Ze($, W, se, De) {
                (this.type = $), (this.indent = W), (this.prev = se), (this.line = De || { firstWord: '', indent: 0 });
            }
            function ke($, W, se, De) {
                return (De = De >= 0 ? De : H), ($.context = new Ze(se, W.indentation() + De, $.context)), se;
            }
            function Je($, W) {
                var se = $.context.indent - H;
                return (W = W || !1), ($.context = $.context.prev), W && ($.context.indent = se), $.context.type;
            }
            function He($, W, se) {
            ...
            function fe($, W) {
                return (Me(W) && ($ == '{' || $ == ']' || $ == 'hash' || $ == 'qualifier')) || $ == 'block-mixin';
            }
            function oe($, W) {
            ...
            return (
                (de.block = function ($, W, se) {
                    if (($ == 'comment' && we(W)) || ($ == ',' && Me(W)) || $ == 'mixin') return ke(se, W, 'block', 0);
                    if (oe($, W)) return ke(se, W, 'interpolation');
                    if (Me(W) && $ == ']' && !/^\s*(\.|#|:|\[|\*|&)/.test(W.string) && !U(Le(W)))
                    ...
                    if ($ == '=') return !Me(W) && !ce(Le(W)) ? ke(se, W, 'block', 0) : ke(se, W, 'block');
                    if ($ == '*' && (Me(W) || W.match(/\s*(,|\.|#|\[|:|{)/, !1)))
                    ...
                    if (/@(-(moz|ms|o|webkit)-)?keyframes$/.test($)) return ke(se, W, 'keyframes');
                    ...
                    if ($ == 'word') {
                        ...
                        if (ge == 'tag') {
                            if (
                                ...
                                W.string.match(new RegExp('\\[\\s*' + De + '|' + De + '\\s*\\]'))
                            )
                                return (ge = 'atom'), 'block';
                            if (
                                re.test(De) &&
                                ((we(W) && W.string.match(/=/)) ||
                                    (!we(W) && !W.string.match(/^(\s*\.|#|\&|\[|\/|>|\*)/) && !U(Le(W))))
                            )
                                return (ge = 'variable-2'), ce(Le(W)) ? 'block' : ke(se, W, 'block', 0);
                            if (Me(W)) return ke(se, W, 'block');
                        }
                        if (ge == 'block-keyword')
                            return (ge = 'keyword'), W.current(/(if|unless)/) && !we(W) ? 'block' : ke(se, W, 'block');
                        if (De == 'return') return ke(se, W, 'block', 0);
                        if (ge == 'variable-2' && W.string.match(/^\s?\$[\w-\.\[\]\'\"]+$/)) return ke(se, W, 'block');
                    }
                            ...
                            : (W.string.match(/^[a-z][\w-]*\(/i) && Me(W)) ||
                              ...
                              : W.string.match(/^[\$-]?[a-z][\w-\.\[\]\'\"]*\s*=/) ||
                                ...
                                : Me(W)
                                  ? ke(se, W, 'block')
                                  : ke(se, W, 'block', 0);
                    if (($ && $.charAt(0) == '@' && G(W.current().slice(1)) && (ge = 'variable-2'), $ == 'word')) {
                        var De = W.current();
                        (ge = te(De)),
                ...
                (de.vendorPrefixes = function ($, W, se) {
                    return $ == 'word' ? ((ge = 'property'), ke(se, W, 'block', 0)) : Je(se);
                }),
                (de.pseudo = function ($, W, se) {
                    return G(Le(W.string))
                        ? Ge($, W, se)
                        : (W.match(/^[a-z-]+/), (ge = 'variable-3'), Me(W) ? ke(se, W, 'block') : Je(se));
                }),
                (de.atBlock = function ($, W, se) {
                    ...
                    return $ == 'operator' && /^(not|and|or)$/.test(W.current()) && (ge = 'keyword'), se.context.type;
                }),
                (de.atBlock_parens = function ($, W, se) {
                    if ($ == '{' || $ == '}') return se.context.type;
                    if ($ == ')') return Me(W) ? ke(se, W, 'block') : ke(se, W, 'atBlock');
                    if ($ == 'word') {
                        var De = W.current().toLowerCase();
                        return (
                            (ge = te(De)),
                            /^(max|min)/.test(De) && (ge = 'property'),
                            ge == 'tag' && (re.test(De) ? (ge = 'variable-2') : (ge = 'atom')),
                            se.context.type
                        );
                    }
                ...
                (de.keyframes = function ($, W, se) {
                    return W.indentation() == '0' &&
                        (($ == '}' && we(W)) || $ == ']' || $ == 'hash' || $ == 'qualifier' || U(W.current()))
                        ? Ge($, W, se)
                        : $ == '{'
                          ? ke(se, W, 'keyframes')
                          : $ == '}'
                            ...
                            : $ == 'unit' && /^[0-9]+\%$/.test(W.current())
                              ? ke(se, W, 'keyframes')
                              : $ == 'word' && ((ge = te(W.current())), ge == 'block-keyword')
                ...
                (de.interpolation = function ($, W, se) {
                    return (
                        ...
                        $ == '}'
                            ...
                            : $ == 'variable-name'
                              ? ke(se, W, 'variableName', 0)
                              : ($ == 'word' && ((ge = te(W.current())), ge == 'tag' && (ge = 'atom')), se.context.type)
                    );
                }),
                ...
                (de.variableName = function ($, W, se) {
                    return $ == 'string' || $ == '[' || $ == ']' || W.current().match(/^(\.|\$)/)
                        ? (W.current().match(/^\.[\w-]+/i) && (ge = 'variable-2'), 'variableName')
                        : Ge($, W, se);
                }),
                {
                    startState: function ($) {
                        return { tokenize: null, state: 'block', context: new Ze('block', $ || 0, null) };
                    },
                    token: function ($, W) {
                    ...
                    indent: function ($, W, se) {
                        ...
                        return (
                            De.prev &&
                            ((nt == '}' && (De.type == 'block' || De.type == 'atBlock' || De.type == 'keyframes')) ||
                                (nt == ')' && (De.type == 'parens' || De.type == 'atBlock_parens')) ||
                                (nt == '{' && De.type == 'at'))
                                ? (dt = De.indent - H)
                                : /(\})/.test(nt) ||
                                  (/@|\$|\d/.test(nt) ||
        ...
        var p = [
            ...
            x = ['in', 'and', 'or', 'not', 'is not', 'is a', 'is', 'isnt', 'defined', 'if unless'],
            c = ['for', 'if', 'else', 'unless', 'from', 'to'],
            d = ['null', 'true', 'false', 'href', 'title', 'type', 'not-allowed', 'readonly', 'disabled'],
            w = ['@font-face', '@keyframes', '@media', '@viewport', '@page', '@host', '@supports', '@block', '@css'],
            E = p.concat(v, C, b, S, s, g, T, h, x, c, d, w);
        function z(M) {
            return (
...
var Xu = Ke((Gu, Zu) => {
    (function (o) {
        ...
        function y(N, F, D) {
            ...
            if (N.match(g) || N.match(T) || N.match(x) || N.match(c)) return 'number';
            if (N.match(w)) return 'property';
            if (s.indexOf(Q) > -1) return N.next(), 'operator';
            if (h.indexOf(Q) > -1) return N.next(), N.match('..'), 'punctuation';
            var j;
            if ((j = N.match(/("""|"|')/))) {
            ...
            return {
                ...
                token: function (F, D) {
                    ...
                    var j = D.tokenize[D.tokenize.length - 1] || y,
                        V = j(F, D, Q);
                    if ((!V || V == 'comment' ? (D.prev = Q) : D.prev || (D.prev = V), V == 'punctuation')) {
                ...
                indent: function (F, D) {
                    ...
                    if (!Q) return 0;
                    var j = /^[\]\}\)]/.test(D);
                    return Q.align != null ? Q.align - (j ? 1 : 0) : Q.indented + (j ? 0 : N.indentUnit);
                },
                electricInput: /^\s*[\)\}\]]$/,
                lineComment: '//',
                blockCommentStart: '/*',
    ...
    (function (o) {
        ...
        o.defineMode('coffeescript', function (p, v) {
            ...
            var S =
                ...
                T = b(['and', 'or', 'not', 'is', 'isnt', 'in', 'instanceof', 'typeof']),
                x = ['for', 'while', 'loop', 'if', 'unless', 'else', 'switch', 'try', 'catch', 'finally', 'class'],
                c = [
                    'break',
                    'by',
                    'continue',
            ...
            function R(F, D) {
                if (F.sol()) {
                    ...
                    if (F.eatSpace()) {
                        var j = F.indentation();
                        return j > Q && D.scope.type == 'coffee' ? 'indent' : j < Q ? 'dedent' : null;
                    } else Q > 0 && ee(F, D);
                }
                ...
                if (F.match(w)) return (D.tokenize = M(F.current(), !1, 'string')), D.tokenize(F, D);
                if (F.match(E)) {
            ...
            function M(F, D, Q) {
                return function (j, V) {
                    ...
                    return D && (v.singleLineStringErrors ? (Q = C) : (V.tokenize = R)), Q;
                };
            }
            function H(F, D) {
                for (; !F.eol(); ) {
            ...
            function Z(F, D, Q) {
                ...
                Q !== 'coffee'
                    ...
                    (D.scope = { offset: j, type: Q, prev: D.scope, align: V, alignOffset: _ });
            }
            function ee(F, D) {
                if (D.scope.prev)
                    if (D.scope.type === 'coffee') {
                        ...
                        if (!j) return !0;
                        for (; D.scope.prev && D.scope.offset !== Q; ) D.scope = D.scope.prev;
                        return !1;
            ...
            var N = {
                ...
                token: function (F, D) {
                    ...
                    return (
                        j &&
                            j != 'comment' &&
                            (Q && (Q.align = !0), (D.prop = j == 'punctuation' && F.current() == '.')),
                        j
                    );
                },
                indent: function (F, D) {
                    ...
                    return Q.align ? Q.alignOffset - (V ? 1 : 0) : (V ? Q.prev : Q).offset;
                },
                lineComment: '#',
                fold: 'indent',
            };
    ...
    (function (o) {
        ...
        o.defineMode(
            ...
            function (p) {
                ...
                function T(U, G) {
                    if (
                        (U.sol() && ((G.javaScriptLine = !1), (G.javaScriptLineExcludesColon = !1)), G.javaScriptLine)
                    ) {
                        if (G.javaScriptLineExcludesColon && U.peek() === ':') {
                            (G.javaScriptLine = !1), (G.javaScriptLineExcludesColon = !1);
                            return;
                        }
                        var ce = h.token(U, G.jsState);
                ...
                function w(U, G) {
                    if (U.match('#{')) return (G.isInterpolating = !0), (G.interpolationNesting = 0), 'punctuation';
                }
                function E(U, G) {
                ...
                function y(U, G) {
                    if (U.match(/^when\b/)) return (G.javaScriptLine = !0), (G.javaScriptLineExcludesColon = !0), v;
                }
                function R(U) {
                ...
                function ee(U, G) {
                    if (U.match(/^block\b *(?:(prepend|append)\b)?/)) return (G.restOfLine = 'variable'), v;
                }
                function re(U, G) {
                ...
                function Q(U, G) {
                    if (U.match(/^\+([-\w]+)/))
                        return (
                            U.match(/^\( *[-\w]+ *=/, !1) ||
                                ((G.javaScriptArguments = !0), (G.javaScriptArgumentsDepth = 0)),
                            'variable'
                        );
                    if (U.match('+#{', !1)) return U.next(), (G.mixinCallAfter = !0), w(U, G);
                }
                function j(U, G) {
                    if (G.mixinCallAfter)
                        return (
                ...
                function V(U, G) {
                    if (U.match(/^(if|unless|else if|else)\b/)) return (G.javaScriptLine = !0), v;
                }
                function _(U, G) {
                ...
                function K(U, G) {
                    if (G.isEach) {
                        if (U.match(/^ in\b/)) return (G.javaScriptLine = !0), (G.isEach = !1), v;
                ...
                function I(U, G) {
                    ...
                    if ((ce = U.match(/^(\w(?:[-:\w]*\w)?)\/?/)))
                        return (
                            ...
                            G.lastTag === 'script' && (G.scriptType = 'application/javascript'),
                            'tag'
                        );
                }
                function B(U, G) {
                    if (U.match(/^:([\w\-]+)/)) {
                        var ce;
                        return (
                            p && p.innerModes && (ce = p.innerModes(U.current().substring(1))),
                ...
                function le(U, G) {
                    if (U.match(/^(!?=|-)/)) return (G.javaScriptLine = !0), 'punctuation';
                }
                function xe(U) {
                ...
                function de(U, G) {
                    if (G.isAttrs) {
                        ...
                        if (G.inAttributeName && U.match(/^[^=,\)!]+/))
                            return (
                                (U.peek() === '=' || U.peek() === '!') &&
                                    ...
                                    G.lastTag === 'script' && U.current().trim().toLowerCase() === 'type'
                                        ? (G.attributeIsType = !0)
                                        : (G.attributeIsType = !1)),
                                'attribute'
                            );
                        var ce = h.token(U, G.jsState);
                        if (
                            (G.attributeIsType && ce === 'string' && (G.scriptType = U.current().toString()),
                            G.attrsNest.length === 0 && (ce === 'string' || ce === 'variable' || ce === 'keyword'))
                        )
                            try {
                                return (
                                    Function('', 'var x ' + G.attrValue.replace(/,\s*$/, '').replace(/^!/, '')),
                                    (G.inAttributeName = !0),
                                    (G.attrValue = ''),
                ...
                function ze(U, G) {
                    if (U.match(/^&attributes\b/))
                        return (G.javaScriptArguments = !0), (G.javaScriptArgumentsDepth = 0), 'keyword';
                }
                function pe(U) {
                ...
                function Ee(U, G) {
                    if (U.match(/^ *\/\/(-)?([^\n]*)/))
                        return (G.indentOf = U.indentation()), (G.indentToken = 'comment'), 'comment';
                }
                function ge(U) {
                ...
                function Oe(U, G) {
                    if (U.match(/^(?:\| ?| )([^\n]+)/)) return 'string';
                    if (U.match(/^(<[^\n]*)/, !1))
                        return je(U, G, 'htmlmixed'), (G.innerModeForLine = !0), Ze(U, G, !0);
                }
                function qe(U, G) {
                    if (U.eat('.')) {
                        var ce = null;
                        return (
                            G.lastTag === 'script' && G.scriptType.toLowerCase().indexOf('javascript') != -1
                ...
                function je(U, G, ce) {
                    (ce = o.mimeModes[ce] || ce),
                        ...
                        ce && ce.name !== 'null' ? (G.innerMode = ce) : (G.indentToken = 'string');
                }
                function Ze(U, G, ce) {
                    if (U.indentation() > G.indentOf || (G.innerModeForLine && !U.sol()) || ce)
                        return G.innerMode
                            ? (G.innerState ||
                    ...
                    U.sol() &&
                        ((G.indentOf = 1 / 0), (G.indentToken = null), (G.innerMode = null), (G.innerState = null));
                }
                function ke(U, G) {
            ...
            return {
                ...
                token: function (b, S) {
                    if (S.innerActive) {
                        var E = S.innerActive,
                            h = b.string;
                        if (!E.close && b.sol()) return (S.innerActive = S.inner = null), this.token(b, S);
                        var x = E.close && !S.startingInner ? C(h, E.close, b.pos, E.parseDelimiters) : -1;
                        ...
                        return (
                            x > -1 ? (b.string = h) : b.pos > b.start && (S.startingInner = !1),
                            x == b.pos && E.parseDelimiters && (S.innerActive = S.inner = null),
                            E.innerStyle && (z ? (z = z + ' ' + E.innerStyle) : (z = E.innerStyle)),
                            z
                        );
                    } else {
                        for (var s = 1 / 0, h = b.string, g = 0; g < v.length; ++g) {
                            var T = v[g],
                                x = C(h, T.open, b.pos);
                            if (x == b.pos) {
                                ...
                                var c = 0;
                                if (p.indent) {
                                    var d = p.indent(S.outer, '', '');
                                    d !== o.Pass && (c = d);
                                }
                                return (
                                    (S.inner = o.startState(T.mode, c)),
                                    T.delimStyle && T.delimStyle + ' ' + T.delimStyle + '-open'
                                );
                            } else x != -1 && x < s && (s = x);
                        }
                ...
                indent: function (b, S, s) {
                    var h = b.innerActive ? b.innerActive.mode : p;
                    return h.indent ? h.indent(b.innerActive ? b.inner : b.outer, S, s) : o.Pass;
                },
                blankLine: function (b) {
                    var S = b.innerActive ? b.innerActive.mode : p;
                    if ((S.blankLine && S.blankLine(b.innerActive ? b.inner : b.outer), b.innerActive))
                        b.innerActive.close ===
                            `
` && (b.innerActive = b.inner = null);
                        ...
                        for (var s = 0; s < v.length; ++s) {
                            ...
                            h.open ===
                                `
` && ((b.innerActive = h), (b.inner = o.startState(h.mode, S.indent ? S.indent(b.outer, '', '') : 0)));
                        }
                },
                electricChars: p.electricChars,
                innerMode: function (b) {
        ...
        o.defineMode('yaml', function () {
            ...
            return {
                token: function (C, b) {
                    var S = C.peek(),
                        s = b.escaped;
                    if (((b.escaped = !1), S == '#' && (C.pos == 0 || /\s/.test(C.string.charAt(C.pos - 1)))))
...
function vc(o) {
    return mc ? (o = o.replace('Ctrl', 'Cmd')) : (o = o.replace('Cmd', 'Ctrl')), o;
}
function Fd(o, p, v, C) {
    var b = qi(o, !1, p, v, 'button', C);
    ...
    for (var s = 0; s < o.children.length; s++) {
        var h = o.children[s],
            g;
        typeof h == 'string' && h in Pr ? (g = qi(Pr[h], !0, p, v, 'button', C)) : (g = qi(h, !0, p, v, 'button', C)),
            g.addEventListener(
                'click',
                function (T) {
                    T.stopPropagation();
...
function qi(o, p, v, C, b, S) {
    ...
    if (o.attributes)
        for (var h in o.attributes)
            Object.prototype.hasOwnProperty.call(o.attributes, h) && s.setAttribute(h, o.attributes[h]);
    (s.className = o.name),
        ...
        o.title &&
            ...
            mc && ((s.title = s.title.replace('Ctrl', '\u2318')), (s.title = s.title.replace('Alt', '\u2325')))),
                        ...
                        : S === 'strikethrough'
                          ...
                          : S === 'comment'
                            ...
                            : S === 'link' && !b.image
                              ...
                              : S === 'image'
                                ? (b.image = !0)
                                : S.match(/^header(-[1-6])?$/) && (b[S.replace('header', 'heading')] = !0);
    return b;
}
function jr(o) {
    var p = o.codemirror;
    p.setOption('fullScreen', !p.getOption('fullScreen')),
        p.getOption('fullScreen')
            ? ((hc = document.body.style.overflow), (document.body.style.overflow = 'hidden'))
...
function Pi(o) {
    ...
    function v(K) {
        if (typeof K != 'object')
            throw (
                "fencing_line() takes a 'line' object (not a line number, or line text).  Got: " + typeof K + ': ' + K
            );
    ...
    function b(K, X, I, B, le) {
        (I = I || K.getLineHandle(X)),
            ...
            (le = le || (!!I.text && K.getTokenAt({ line: X, ch: I.text.length - 1 })));
...
`),
    ...
    var s = o.codemirror,
        h = s.getCursor('start'),
        g = s.getCursor('end'),
        T = s.getTokenAt({ line: h.line, ch: h.ch || 1 }),
        x = s.getLineHandle(h.line),
        c = b(s, h.line, x, T),
        d,
        w,
        E;
    if (c === 'single') {
        var z = x.text.slice(0, h.ch).replace('`', ''),
            y = x.text.slice(h.ch).replace('`', '');
        s.replaceRange(z + y, { line: h.line, ch: 0 }, { line: h.line, ch: 99999999999999 }),
            h.ch--,
            h !== g && g.ch--,
            s.setSelection(h, g),
            s.focus();
...
`),
                ...
                s.operation(function () {
                    s.replaceRange(ee, { line: re, ch: 0 }, { line: re + (ee ? 0 : 1), ch: 0 }),
                        s.replaceRange(H, { line: Z, ch: 0 }, { line: Z + (H ? 0 : 1), ch: 0 });
                }),
                s.setSelection({ line: Z + (H ? 1 : 0), ch: 0 }, { line: re + (H ? 1 : -1), ch: 0 }),
                s.focus();
        } else {
            var N = h.line;
            if (
            ...
            if (w === void 0) for (E = s.lineCount(), w = N; w < E && ((x = s.getLineHandle(w)), !v(x)); w++);
            s.operation(function () {
        ...
        if (h.line !== g.line || h.ch !== g.ch) (d = h.line), (w = g.line), g.ch === 0 && w--;
        else {
            for (d = h.line; d >= 0; d--)
                if (((x = s.getLineHandle(d)), !x.text.match(/^\s*$/) && b(s, d, x) !== 'indented')) {
                    d += 1;
                    break;
                }
            for (E = s.lineCount(), w = h.line; w < E; w++)
                if (((x = s.getLineHandle(w)), !x.text.match(/^\s*$/) && b(s, w, x) !== 'indented')) {
                    w -= 1;
                    break;
                }
        }
...
`,
        ...
        var V = h.line === g.line && h.ch === g.ch && h.ch === 0,
            _ = h.line !== g.line;
...
function yc(o, p) {
    ...
    if (['png', 'jpg', 'jpeg', 'gif', 'svg', 'apng', 'avif', 'webp'].includes(s))
        ...
        var h = b.insertTexts.link;
        (h[0] = '[' + S), Rr(v, C.link, h, p);
    }
    o.updateStatusBar('upload-image', o.options.imageTexts.sbOnUploaded.replace('#image_name#', S)),
        setTimeout(function () {
...
function bn(o) {
    ...
    C.classList.contains('editor-preview-active-side')
        ...
        : (setTimeout(function () {
              p.getOption('fullScreen') ||
                  (o.options.sideBySideFullscreen === !1 ? s.classList.add('sided--no-fullscreen') : jr(o)),
    ...
    if (h.classList.contains('editor-preview-active')) {
        ...
        var g = o.toolbarElements.preview,
            T = o.toolbar_div;
        g.classList.remove('active'), T.classList.remove('disabled-for-preview');
    }
    var x = function () {
        var d = o.options.previewRender(o.value(), C);
        d != null && (C.innerHTML = d);
    };
    if ((p.sideBySideRenderingFunction || (p.sideBySideRenderingFunction = x), S)) {
...
function Ji(o) {
    ...
    if (
        ...
        if (((S = document.createElement('div')), (S.className = 'editor-preview-full'), o.options.previewClass))
            if (Array.isArray(o.options.previewClass))
                for (var h = 0; h < o.options.previewClass.length; h++) S.classList.add(o.options.previewClass[h]);
            else typeof o.options.previewClass == 'string' && S.classList.add(o.options.previewClass);
        v.appendChild(S);
    }
...
function Lr(o, p, v) {
    if (!o.getWrapperElement().lastChild.classList.contains('editor-preview-active')) {
        for (var C = o.getCursor('start'), b = o.getCursor('end'), S = C.line; S <= b.line; S++)
            (function (s) {
                var h = o.getLine(s),
                    g = h.search(/[^#]/);
                p !== void 0
                    ...
                    o.replaceRange(h, { line: s, ch: 0 }, { line: s, ch: 99999999999999 });
            })(S);
        o.focus();
    }
}
        ...
        for (
            var C = /^(\s*)(\*|-|\+|\d*\.)(\s+)/,
                ...
                c = function (E, z, y) {
                    ...
                    return (
                        R !== null
                            ? (x(E, R[2]) && (M = ''), (z = R[1] + M + R[3] + z.replace(b, '').replace(g[E], '$1')))
                            : y == !1 && (z = M + ' ' + z),
                        z
                    );
                },
...
function xc(o, p, v, C) {
    if (!(!o.codemirror || o.isPreviewActive())) {
        ...
        var h = b.getCursor('start'),
            ...
            x = T.slice(0, h.ch),
            c = T.slice(h.ch);
        p == 'link' ? (x = x.replace(/(.*)[^!]\[/, '$1')) : p == 'image' && (x = x.replace(/(.*)!\[$/, '$1')),
            (c = c.replace(/]\(.*?\)/, '')),
            b.replaceRange(x + c, { line: h.line, ch: 0 }, { line: h.line, ch: 99999999999999 }),
            (h.ch -= v[0].length),
            h !== g && (g.ch -= v[0].length),
            b.setSelection(h, g),
            b.focus();
    ...
    if (!(!o.codemirror || o.isPreviewActive())) {
        ...
        S[p]
            ? ((s = b.getLine(T.line)),
              ...
              (g = s.slice(T.ch)),
              p == 'bold'
                  ? ((h = h.replace(/(\*\*|__)(?![\s\S]*(\*\*|__))/, '')), (g = g.replace(/(\*\*|__)/, '')))
                  : p == 'italic'
                    ? ((h = h.replace(/(\*|_)(?![\s\S]*(\*|_))/, '')), (g = g.replace(/(\*|_)/, '')))
                    : p == 'strikethrough' &&
                      ((h = h.replace(/(\*\*|~~)(?![\s\S]*(\*\*|~~))/, '')), (g = g.replace(/(\*\*|~~)/, ''))),
              b.replaceRange(h + g, { line: T.line, ch: 0 }, { line: T.line, ch: 99999999999999 }),
...
function fr(o) {
    for (var p = 1; p < arguments.length; p++) o = _c(o, arguments[p]);
    return o;
}
function gc(o) {
    var p =
    ...
    if (o.toolbar === void 0) {
        ...
        for (var S in Pr)
            Object.prototype.hasOwnProperty.call(Pr, S) &&
                ...
                (Pr[S].default === !0 ||
                    (o.showIcons && o.showIcons.constructor === Array && o.showIcons.indexOf(S) != -1)) &&
                    o.toolbar.push(S));
    }
    if (
        ...
        o.autosave != null && (o.autosave.timeFormat = fr({}, Hd, o.autosave.timeFormat || {})),
        ...
        this.codemirror.on('dragenter', function (h, g) {
            ...
            this.codemirror.on('dragend', function (h, g) {
                s.updateStatusBar('upload-image', s.options.imageTexts.sbInit), g.stopPropagation(), g.preventDefault();
            }),
            ...
            this.codemirror.on('drop', function (h, g) {
                g.stopPropagation(),
                    ...
                    o.imageUploadFunction
                        ? s.uploadImagesUsingCustomFunction(o.imageUploadFunction, g.dataTransfer.files)
                        : s.uploadImages(g.dataTransfer.files);
            }),
            this.codemirror.on('paste', function (h, g) {
                o.imageUploadFunction
                    ? s.uploadImagesUsingCustomFunction(o.imageUploadFunction, g.clipboardData.files)
...
var mc,
    ...
    wc = Cd(() => {
        (mc = /Mac/.test(navigator.platform)),
            ...
            (Dd = function (o) {
                for (var p in Vn) if (Vn[p] === o) return p;
                return null;
            }),
            (ra = function () {
                var o = !1;
        ...
        (et = {
            ...
            (Pr = {
                bold: { name: 'bold', action: Fi, className: et.bold, title: 'Bold', default: !0 },
                italic: { name: 'italic', action: Ni, className: et.italic, title: 'Italic', default: !0 },
                strikethrough: {
                    name: 'strikethrough',
                    action: Oi,
                ...
                heading: { name: 'heading', action: Jn, className: et.heading, title: 'Heading', default: !0 },
                'heading-smaller': {
                ...
                'heading-1': { name: 'heading-1', action: Hi, className: et['heading-1'], title: 'Big Heading' },
                'heading-2': { name: 'heading-2', action: Bi, className: et['heading-2'], title: 'Medium Heading' },
                'heading-3': { name: 'heading-3', action: Wi, className: et['heading-3'], title: 'Small Heading' },
                'separator-1': { name: 'separator-1' },
                code: { name: 'code', action: Pi, className: et.code, title: 'Code' },
                quote: { name: 'quote', action: ji, className: et.quote, title: 'Quote', default: !0 },
                'unordered-list': {
                    name: 'unordered-list',
                    action: Ui,
                ...
                'clean-block': { name: 'clean-block', action: Ki, className: et['clean-block'], title: 'Clean block' },
                'separator-2': { name: 'separator-2' },
                link: { name: 'link', action: Gi, className: et.link, title: 'Create Link', default: !0 },
                image: { name: 'image', action: Zi, className: et.image, title: 'Insert Image', default: !0 },
                'upload-image': {
                    name: 'upload-image',
                    action: aa,
                ...
                table: { name: 'table', action: Xi, className: et.table, title: 'Insert Table' },
                'horizontal-rule': {
                ...
                undo: { name: 'undo', action: Qi, className: et.undo, noDisable: !0, title: 'Undo' },
                redo: { name: 'redo', action: Vi, className: et.redo, noDisable: !0, title: 'Redo' },
            }),
            (jd = {
                link: ['[', '](#url#)'],
                image: ['![', '](#url#)'],
...
`,
            ...
            (Hd = { locale: 'en-US', format: { hour: '2-digit', minute: '2-digit' } }),
            (Bd = { bold: '**', code: '```', italic: '*' }),
            (Wd = {
...
Maximum file size is #image_max_size#.`,
                ...
                if (
                    ...
                    v &&
                        (p.highlight = function (b, S) {
                            return S && v.getLanguage(S) ? v.highlight(S, b).value : v.highlightAuto(b).value;
                        });
                }
                marked.setOptions(p);
        ...
        Te.prototype.render = function (o) {
                ...
                p.shortcuts[b] !== null &&
                    ...
                    (function (y) {
                        C[vc(p.shortcuts[y])] = function () {
                            var R = Vn[y];
                            typeof R == 'function' ? R(v) : typeof R == 'string' && window.open(R, '_blank');
                        };
                    })(b);
            (C.Enter = 'newlineAndIndentContinueMarkdownList'),
                ...
                (this.documentOnKeyDown = function (y) {
                    (y = y || window.event), y.keyCode == 27 && v.codemirror.getOption('fullScreen') && jr(v);
                }),
            ...
            if (
                ...
                (this.codemirror = CodeMirror.fromTextArea(o, {
                    ...
                    styleSelectedText: p.styleSelectedText != null ? p.styleSelectedText : !ra(),
                    scrollbarStyle: p.scrollbarStyle != null ? p.scrollbarStyle : 'native',
                    configureMouse: h,
                    inputStyle: p.inputStyle != null ? p.inputStyle : ra() ? 'contenteditable' : 'textarea',
            ...
            T.classList.add('EasyMDEContainer'), T.setAttribute('role', 'application');
            ...
            function c(y, R) {
                var M,
                    H = window.getComputedStyle(document.querySelector('.CodeMirror-sizer')).width.replace('px', '');
            ...
            if (kc()) {
                ...
                if (v != null && v != null && v != '') {
                    var C = new Date(),
                        ...
                        S = this.options.autosave.text == null ? 'Autosaved: ' : this.options.autosave.text;
                    v.innerHTML = S + b;
                }
        ...
        Te.prototype.openBrowseFileWindow = function (o, p) {
            ...
            function b(S) {
                v.options.imageUploadFunction
                    ? v.uploadImagesUsingCustomFunction(v.options.imageUploadFunction, S.target.files)
        ...
        Te.prototype.uploadImage = function (o, p, v) {
            ...
            function S(g) {
                var T = C.options.imageTexts.sizeUnits.split(',');
                return g
            ...
            (h.upload.onprogress = function (g) {
                if (g.lengthComputable) {
                    var T = '' + Math.round((g.loaded * 100) / g.total);
                    C.updateStatusBar(
                        'upload-image',
                        C.options.imageTexts.sbProgress.replace('#file_name#', o.name).replace('#progress#', T)
                    );
                }
            }),
                ...
                C.options.imageCSRFToken &&
                    C.options.imageCSRFHeader &&
                    h.setRequestHeader(C.options.imageCSRFName, C.options.imageCSRFToken),
                (h.onload = function () {
                    try {
        ...
        Te.prototype.uploadImageUsingCustomFunction = function (o, p) {
            ...
            function S(s) {
                var h = v.options.imageTexts.sizeUnits.split(',');
                return s
        ...
        Te.prototype.createSideBySide = function () {
            ...
            return (
                o.on('scroll', function (s) {
                    ...
                    S = !0;
                    var h = s.getScrollInfo().height - s.getScrollInfo().clientHeight,
                        g = parseFloat(s.getScrollInfo().top) / h,
                        T = (v.scrollHeight - v.clientHeight) * g;
                    v.scrollTop = T;
                }),
                (v.onscroll = function () {
                    if (S) {
                    ...
                    var s = v.scrollHeight - v.clientHeight,
                        h = parseFloat(v.scrollTop) / s,
                        g = (o.getScrollInfo().height - o.getScrollInfo().clientHeight) * h;
                    o.scrollTo(0, g);
                }),
                v
            );
        ...
        Te.prototype.createToolbar = function (o) {
            if (((o = o || this.options.toolbar), !(!o || o.length === 0))) {
                var p;
                for (p = 0; p < o.length; p++) Pr[o[p]] != null && (o[p] = Pr[o[p]]);
                ...
                for (C.toolbar = o, p = 0; p < o.length; p++)
                    if (
                        ...
                        !((o[p].name == 'fullscreen' || o[p].name == 'side-by-side') && ra())
                    ) {
                        if (o[p] === '|') {
                        ...
                        (function (T) {
                            ...
                            if (
                                (T === '|'
                                    ? (x = Nd())
                                    : T.children
                                      ? (x = Fd(T, C.options.toolbarTips, C.options.shortcuts, C))
                                      : (x = qi(T, !0, C.options.toolbarTips, C.options.shortcuts, 'button', C)),
                                (b[T.name || T] = x),
                                v.appendChild(x),
                                T.name === 'upload-image')
                            ) {
        ...
        Te.prototype.createStatusbar = function (o) {
            ...
            if (!(!o || o.length === 0)) {
                ...
                for (b = 0; b < o.length; b++)
                    if (((S = void 0), (s = void 0), (h = void 0), typeof o[b] == 'object'))
                        C.push({
                        ...
                        g === 'words'
                            ...
                            C.push({ className: g, defaultValue: h, onUpdate: S, onActivity: s });
                    }
                var T = document.createElement('div');
...
function Kd({
    ...
    return {
        ...
        state: g,
        init: async function () {
            this.$root._editor && (this.$root._editor.toTextArea(), (this.$root._editor = null)),
                ...
                this.editor.codemirror.on('changes', (d, w) => {
                    try {
                        ...
                        if (E.origin === '+input') {
                            let z = '(https://)',
                                y = E.text[E.text.length - 1];
                            if (y.endsWith(z) && y !== '[]' + z) {
                                let R = E.from,
                                    M = E.to,
                                    Z = E.text.length > 1 ? 0 : R.ch;
                                setTimeout(() => {
                                    d.setSelection(
                                        { line: M.line, ch: Z + y.lastIndexOf('(') + 1 },
                                        { line: M.line, ch: Z + y.lastIndexOf(')') }
                                    );
                                }, 25);
                            }
                        }
                ...
                this.editor.codemirror.on(
                    'change',
                    Alpine.debounce(() => {
                        this.editor && ((this.state = this.editor.value()), p && this.$wire.call('$refresh'));
                    }, C ?? 300)
                ),
                v && this.editor.codemirror.on('blur', () => this.$wire.call('$refresh')),
                this.$watch('state', () => {
                    this.editor &&
                        (this.editor.codemirror.hasFocus() || Alpine.raw(this.editor).value(this.state ?? ''));
                }),
                h && h(this);
        },
        destroy: function () {
        ...
        getToolbar: function () {
            ...
            return (
                x.includes('bold') &&
                    d.push({ name: 'bold', action: EasyMDE.toggleBold, title: T.toolbar_buttons?.bold }),
                x.includes('italic') &&
                    d.push({ name: 'italic', action: EasyMDE.toggleItalic, title: T.toolbar_buttons?.italic }),
                x.includes('strike') &&
                    d.push({
                        name: 'strikethrough',
                ...
                x.includes('link') &&
                    d.push({ name: 'link', action: EasyMDE.drawLink, title: T.toolbar_buttons?.link }),
                ['bold', 'italic', 'strike', 'link'].some(w => x.includes(w)) &&
                ...
                ['heading'].some(w => x.includes(w)) &&
                    ['blockquote', 'codeBlock', 'bulletList', 'orderedList'].some(w => x.includes(w)) &&
                    d.push('|'),
                x.includes('blockquote') &&
                    d.push({ name: 'quote', action: EasyMDE.toggleBlockquote, title: T.toolbar_buttons?.blockquote }),
                x.includes('codeBlock') &&
                    d.push({ name: 'code', action: EasyMDE.toggleCodeBlock, title: T.toolbar_buttons?.code_block }),
                ...
                ['blockquote', 'codeBlock', 'bulletList', 'orderedList'].some(w => x.includes(w)) &&
                    ...
                    d.push('|'),
                x.includes('table') &&
                    d.push({ name: 'table', action: EasyMDE.drawTable, title: T.toolbar_buttons?.table }),
                ...
                ['table', 'attachFiles'].some(w => x.includes(w)) &&
                    ...
                    d.push('|'),
                x.includes('undo') && d.push({ name: 'undo', action: EasyMDE.undo, title: T.toolbar_buttons?.undo }),
                x.includes('redo') && d.push({ name: 'redo', action: EasyMDE.redo, title: T.toolbar_buttons?.redo }),
                d
            );
        },
    };
