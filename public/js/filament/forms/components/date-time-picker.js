...
var Hi = (n, t, s, i) => {
    if ((t && typeof t == 'object') || typeof t == 'function')
        for (let e of Si(t))
            !ki.call(n, e) && e !== s && fn(n, e, { get: () => t[e], enumerable: !(i = gi(t, e)) || i.enumerable });
    return n;
};
var de = (n, t, s) => (
    (s = n != null ? vi(bi(n)) : {}),
    Hi(t || !n || !n.__esModule ? fn(s, 'default', { value: n, enumerable: !0 }) : s, n)
);
var bn = k((He, je) => {
    (function (n, t) {
        typeof He == 'object' && typeof je < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_plugin_advancedFormat = t());
    })(He, function () {
        'use strict';
        return function (n, t) {
            var s = t.prototype,
...
var kn = k((Te, we) => {
    (function (n, t) {
        typeof Te == 'object' && typeof we < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_plugin_customParseFormat = t());
    })(Te, function () {
        'use strict';
        var n = {
                LTS: 'h:mm:ss A',
                ...
                Do: [
                    ...
                    function (m) {
                        var Y = a.ordinal,
                            L = m.match(/\d+/);
                        if (((this.day = L[0]), Y))
                            for (var D = 1; D <= 31; D += 1) Y(D).replace(/\[|\]/g, '') === m && (this.day = D);
                    },
                ],
                w: [e, o('week')],
                ww: [i, o('week')],
        ...
        function f(m) {
            ...
            (Y = m), (L = a && a.formats);
            for (
                var D = (m = Y.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g, function ($, H, W) {
                        var U = W && W.toUpperCase();
                        return (
                            H ||
                            L[W] ||
                            n[W] ||
                            L[U].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g, function (v, h, c) {
                                return h || c.slice(1);
                            })
                        );
                    })).match(t),
            ...
            return function ($) {
                ...
                return (
                    (function (S) {
                        ...
                        if (b !== void 0) {
                            var T = S.hours;
                            b ? T < 12 && (S.hours += 12) : T === 12 && (S.hours = 0), delete S.afternoon;
                        }
                    })(H),
                    H
                );
                ...
                if (typeof x == 'string') {
                    ...
                    H && (U = q[2]),
                        ...
                        (this.$d = (function (p, M, S, b) {
                            try {
                                if (['x', 'X'].indexOf(M) > -1) return new Date((M === 'X' ? 1e3 : 1) * p);
                                var T = f(M)(p),
                                    I = T.year,
                                    N = T.month,
                                    E = T.day,
                                ...
                                var me,
                                    ...
                                    ve = re || 0;
                                return Z
                                    ? new Date(Date.UTC(ee, le, X, pe, De, Le, ve + 60 * Z.offset * 1e3))
                                    : S
                                      ? new Date(Date.UTC(ee, le, X, pe, De, Le, ve))
                                      : ((me = new Date(ee, le, X, pe, De, Le, ve)),
...
var Hn = k(($e, Ce) => {
    (function (n, t) {
        typeof $e == 'object' && typeof Ce < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_plugin_localeData = t());
    })($e, function () {
        'use strict';
            ...
            var i = t.prototype,
                ...
                u = function (d, _) {
                    return (
                        d.formats[_] ||
                        (function (y) {
                            return y.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g, function (l, f, m) {
                                return f || m.slice(1);
                            });
                ...
                o = function () {
                    ...
                    return {
                        ...
                        monthsShort: function (_) {
                            return _ ? _.format('MMM') : r(d, 'monthsShort', 'months', 3);
                        },
                        ...
                        weekdaysMin: function (_) {
                            return _ ? _.format('dd') : r(d, 'weekdaysMin', 'weekdays', 2);
                        },
                        weekdaysShort: function (_) {
                            return _ ? _.format('ddd') : r(d, 'weekdaysShort', 'weekdays', 3);
                        },
...
var jn = k((Oe, ze) => {
    (function (n, t) {
        typeof Oe == 'object' && typeof ze < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_plugin_timezone = t());
    })(Oe, function () {
        'use strict';
        ...
        return function (s, i, e) {
            ...
            (o.tz = function (_, y) {
                ...
                (o.offsetName = function (_) {
                    var y = this.$x.$timezone || e.tz.guess(),
                        l = a(this.valueOf(), y, { timeZoneName: _ }).find(function (f) {
            ...
            (o.startOf = function (_, y) {
                ...
                var l = e(this.format('YYYY-MM-DD HH:mm:ss:SSS'), { locale: this.$L });
                ...
                (e.tz = function (_, y, l) {
                    ...
                    var L = (function (C, A, q) {
                            ...
                            return $ === H ? [x, $] : [C - 60 * Math.min($, H) * 1e3, Math.max($, H)];
...
var Tn = k((Ae, Ie) => {
    (function (n, t) {
        typeof Ae == 'object' && typeof Ie < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_plugin_utc = t());
    })(Ae, function () {
        'use strict';
        var n = 'minute',
            t = /[+-]\d\d(?::?\d\d)?/g,
        ...
        return function (i, e, r) {
            ...
            a.utcOffset = function (f, m) {
                var Y = this.$utils().u;
                if (Y(f)) return this.$u ? 0 : Y(this.$offset) ? d.call(this) : this.$offset;
                if (
                    typeof f == 'string' &&
                    ((f = (function (g) {
                        g === void 0 && (g = '');
                ...
                if (f !== 0) {
                    ...
                    ((D = this.local().add(L + w, n)).$offset = L), (D.$x.$localOffset = w);
                } else D = this.utc();
                return D;
            };
            var _ = a.format;
            ...
            var y = a.toDate;
            a.toDate = function (f) {
                return f === 's' && this.$offset ? r(this.format('YYYY-MM-DD HH:mm:ss:SSS')).toDate() : y.call(this);
            };
            var l = a.diff;
...
var j = k((qe, xe) => {
    (function (n, t) {
        ...
        var n = 1e3,
            ...
            D = function (v, h, c) {
                var p = String(v);
                return !p || p.length >= h ? v : '' + Array(h + 1 - p.length).join(c) + v;
            },
            w = {
                s: D,
                z: function (v) {
                ...
                m: function v(h, c) {
                    ...
                    var p = 12 * (c.year() - h.year()) + (c.month() - h.month()),
                        M = h.clone().add(p, d),
                        S = c - M < 0,
                ...
                p: function (v) {
                    return (
                        { M: d, y, w: o, d: u, D: l, h: a, m: r, s: e, ms: i, Q: _ }[v] ||
                        String(v || '')
                            .toLowerCase()
                            .replace(/s$/, '')
                    );
        ...
        (H.l = x),
            (H.i = q),
            (H.w = function (v, h) {
                return $(v, { locale: h.$L, utc: h.$u, x: h.$x, $offset: h.$offset });
            });
        var W = (function () {
                function v(c) {
                    (this.$L = x(c.locale, null, !0)), this.parse(c), (this.$x = this.$x || c.x || {}), (this[A] = !0);
                }
                var h = v.prototype;
                return (
                    (h.parse = function (c) {
                        (this.$d = (function (p) {
                            ...
                            if (typeof M == 'string' && !/Z$/i.test(M)) {
                                ...
                                if (b) {
                                    ...
                                    return S
                                        ? new Date(Date.UTC(b[1], T, b[3] || 1, b[4] || 0, b[5] || 0, b[6] || 0, I))
                                        : new Date(b[1], T, b[3] || 1, b[4] || 0, b[5] || 0, b[6] || 0, I);
                                }
                            }
                            return new Date(M);
                        })(c)),
                    ...
                    (h.startOf = function (c, p) {
                        var M = this,
                            ...
                            b = H.p(c),
                            T = function (Z, J) {
                                var G = H.w(M.$u ? Date.UTC(M.$y, J, Z) : new Date(M.$y, J, Z), M);
                                return S ? G : G.endOf(u);
                            },
                            I = function (Z, J) {
                                return H.w(
                                    M.toDate()[Z].apply(M.toDate('s'), (S ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(J)),
                                    M
                                );
                            },
                            N = this.$W,
                    ...
                    (h.$set = function (c, p) {
                        ...
                        if (S === d || S === y) {
                            ...
                            N.$d[T](I), N.init(), (this.$d = N.set(l, Math.min(this.$D, N.daysInMonth())).$d);
                        } else T && this.$d[T](I);
                    ...
                    (h.add = function (c, p) {
                        ...
                        if (b === u) return T(1);
                        if (b === o) return T(7);
                        var I = ((M = {}), (M[r] = t), (M[a] = s), (M[e] = n), M)[b] || 1,
...
var wn = k((Ne, Ee) => {
    (function (n, t) {
        typeof Ne == 'object' && typeof Ee < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_ar = t(n.dayjs));
    })(Ne, function (n) {
        'use strict';
        function t(u) {
...
var $n = k((Fe, Je) => {
    (function (n, t) {
        typeof Fe == 'object' && typeof Je < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_bs = t(n.dayjs));
    })(Fe, function (n) {
        'use strict';
        function t(e) {
...
var Cn = k((We, Ue) => {
    (function (n, t) {
        typeof We == 'object' && typeof Ue < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_ca = t(n.dayjs));
    })(We, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
        ...
        var s = t(n),
            i = {
                ...
                ordinal: function (e) {
                    return '' + e + (e === 1 || e === 3 ? 'r' : e === 2 ? 'n' : e === 4 ? 't' : '\xE8');
                },
            };
        return s.default.locale(i, null, !0), i;
    });
    ...
    (function (n, t) {
        typeof Ye == 'object' && typeof On < 'u'
            ...
            : typeof define == 'function' && define.amd
              ...
              : t(((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_ku = {}), n.dayjs);
    })(Ye, function (n, t) {
        'use strict';
        function s(o) {
...
var zn = k((Re, Ge) => {
    (function (n, t) {
        typeof Re == 'object' && typeof Ge < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_cs = t(n.dayjs));
    })(Re, function (n) {
        'use strict';
        function t(a) {
        ...
        function e(a, u, o, d) {
            ...
            switch (o) {
                ...
                case 'mm':
                    return u || d ? _ + (i(a) ? 'minuty' : 'minut') : _ + 'minutami';
                case 'h':
                    return u ? 'hodina' : d ? 'hodinu' : 'hodinou';
                case 'hh':
                    return u || d ? _ + (i(a) ? 'hodiny' : 'hodin') : _ + 'hodinami';
                case 'd':
                    return u || d ? 'den' : 'dnem';
                case 'dd':
                ...
                case 'MM':
                    return u || d ? _ + (i(a) ? 'm\u011Bs\xEDce' : 'm\u011Bs\xEDc\u016F') : _ + 'm\u011Bs\xEDci';
                case 'y':
...
var An = k((Ze, Ve) => {
    (function (n, t) {
        typeof Ze == 'object' && typeof Ve < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_cy = t(n.dayjs));
    })(Ze, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var In = k((Ke, Qe) => {
    (function (n, t) {
        typeof Ke == 'object' && typeof Qe < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_da = t(n.dayjs));
    })(Ke, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var qn = k((Xe, Be) => {
    (function (n, t) {
        typeof Xe == 'object' && typeof Be < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_de = t(n.dayjs));
    })(Xe, function (n) {
        'use strict';
        function t(a) {
            return a && typeof a == 'object' && 'default' in a ? a : { default: a };
...
var xn = k((et, tt) => {
    (function (n, t) {
        typeof et == 'object' && typeof tt < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_en = t());
    })(et, function () {
        'use strict';
        return {
            name: 'en',
...
var Nn = k((nt, it) => {
    (function (n, t) {
        typeof nt == 'object' && typeof it < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_es = t(n.dayjs));
    })(nt, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var En = k((st, rt) => {
    (function (n, t) {
        typeof st == 'object' && typeof rt < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_et = t(n.dayjs));
    })(st, function (n) {
        'use strict';
        function t(r) {
        ...
        function i(r, a, u, o) {
            ...
            return a ? (d[u][2] ? d[u][2] : d[u][1]).replace('%d', r) : (o ? d[u][0] : d[u][1]).replace('%d', r);
        }
        var e = {
            name: 'et',
...
var Fn = k((at, ut) => {
    (function (n, t) {
        typeof at == 'object' && typeof ut < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_fa = t(n.dayjs));
    })(at, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var Jn = k((ot, dt) => {
    (function (n, t) {
        typeof ot == 'object' && typeof dt < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_fi = t(n.dayjs));
    })(ot, function (n) {
        'use strict';
        function t(r) {
            return r && typeof r == 'object' && 'default' in r ? r : { default: r };
...
var Wn = k((_t, ft) => {
    (function (n, t) {
        typeof _t == 'object' && typeof ft < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_fr = t(n.dayjs));
    })(_t, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var Un = k((lt, mt) => {
    (function (n, t) {
        typeof lt == 'object' && typeof mt < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_hi = t(n.dayjs));
    })(lt, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var Pn = k((ct, ht) => {
    (function (n, t) {
        typeof ct == 'object' && typeof ht < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_hu = t(n.dayjs));
    })(ct, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var Rn = k((Mt, yt) => {
    (function (n, t) {
        typeof Mt == 'object' && typeof yt < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_hy_am = t(n.dayjs));
    })(Mt, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var Gn = k((Yt, pt) => {
    (function (n, t) {
        typeof Yt == 'object' && typeof pt < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_id = t(n.dayjs));
    })(Yt, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var Zn = k((Dt, Lt) => {
    (function (n, t) {
        typeof Dt == 'object' && typeof Lt < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_it = t(n.dayjs));
    })(Dt, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var Vn = k((vt, gt) => {
    (function (n, t) {
        typeof vt == 'object' && typeof gt < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_ja = t(n.dayjs));
    })(vt, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var Kn = k((St, bt) => {
    (function (n, t) {
        typeof St == 'object' && typeof bt < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_ka = t(n.dayjs));
    })(St, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var Qn = k((kt, Ht) => {
    (function (n, t) {
        typeof kt == 'object' && typeof Ht < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_km = t(n.dayjs));
    })(kt, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var Xn = k((jt, Tt) => {
    (function (n, t) {
        typeof jt == 'object' && typeof Tt < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_lt = t(n.dayjs));
    })(jt, function (n) {
        'use strict';
        function t(o) {
            return o && typeof o == 'object' && 'default' in o ? o : { default: o };
...
var Bn = k((wt, $t) => {
    (function (n, t) {
        typeof wt == 'object' && typeof $t < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_lv = t(n.dayjs));
    })(wt, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var ei = k((Ct, Ot) => {
    (function (n, t) {
        typeof Ct == 'object' && typeof Ot < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_ms = t(n.dayjs));
    })(Ct, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var ti = k((zt, At) => {
    (function (n, t) {
        typeof zt == 'object' && typeof At < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_my = t(n.dayjs));
    })(zt, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var ni = k((It, qt) => {
    (function (n, t) {
        typeof It == 'object' && typeof qt < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_nl = t(n.dayjs));
    })(It, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var ii = k((xt, Nt) => {
    (function (n, t) {
        typeof xt == 'object' && typeof Nt < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_nb = t(n.dayjs));
    })(xt, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var si = k((Et, Ft) => {
    (function (n, t) {
        typeof Et == 'object' && typeof Ft < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_pl = t(n.dayjs));
    })(Et, function (n) {
        'use strict';
        function t(_) {
...
var ri = k((Jt, Wt) => {
    (function (n, t) {
        typeof Jt == 'object' && typeof Wt < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_pt_br = t(n.dayjs));
    })(Jt, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var ai = k((Ut, Pt) => {
    (function (n, t) {
        typeof Ut == 'object' && typeof Pt < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_pt = t(n.dayjs));
    })(Ut, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var ui = k((Rt, Gt) => {
    (function (n, t) {
        typeof Rt == 'object' && typeof Gt < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_ro = t(n.dayjs));
    })(Rt, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var oi = k((Zt, Vt) => {
    (function (n, t) {
        typeof Zt == 'object' && typeof Vt < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_ru = t(n.dayjs));
    })(Zt, function (n) {
        'use strict';
        function t(l) {
...
var di = k((Kt, Qt) => {
    (function (n, t) {
        typeof Kt == 'object' && typeof Qt < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_sv = t(n.dayjs));
    })(Kt, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var _i = k((Xt, Bt) => {
    (function (n, t) {
        typeof Xt == 'object' && typeof Bt < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_th = t(n.dayjs));
    })(Xt, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var fi = k((en, tn) => {
    (function (n, t) {
        typeof en == 'object' && typeof tn < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_tr = t(n.dayjs));
    })(en, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var li = k((nn, sn) => {
    (function (n, t) {
        typeof nn == 'object' && typeof sn < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_uk = t(n.dayjs));
    })(nn, function (n) {
        'use strict';
        function t(d) {
...
var mi = k((rn, an) => {
    (function (n, t) {
        typeof rn == 'object' && typeof an < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_vi = t(n.dayjs));
    })(rn, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var ci = k((un, on) => {
    (function (n, t) {
        typeof un == 'object' && typeof on < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_zh_cn = t(n.dayjs));
    })(un, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var hi = k((dn, _n) => {
    (function (n, t) {
        typeof dn == 'object' && typeof _n < 'u'
            ...
            : typeof define == 'function' && define.amd
              ? define(['dayjs'], t)
              : ((n = typeof globalThis < 'u' ? globalThis : n || self).dayjs_locale_zh_tw = t(n.dayjs));
    })(dn, function (n) {
        'use strict';
        function t(e) {
            return e && typeof e == 'object' && 'default' in e ? e : { default: e };
...
var ln = 60,
    ...
    Se = 'Invalid Date',
    Yn = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,
...
var be = function (t, s, i) {
    ...
    Ci = function (t) {
        var s = { M: R, y: K, w: oe, d: V, D: se, h: ie, m: ne, s: te, ms: _e, Q: he };
        return (
            s[t] ||
            String(t || '')
                .toLowerCase()
...
var Ai = function (t) {
        ...
        if (typeof s == 'string' && !/Z$/i.test(s)) {
            ...
            if (e) {
                ...
                return i
                    ? new Date(Date.UTC(e[1], r, e[3] || 1, e[4] || 0, e[5] || 0, e[6] || 0, a))
                    : new Date(e[1], r, e[3] || 1, e[4] || 0, e[5] || 0, e[6] || 0, a);
            }
        }
        return new Date(s);
    },
    ye = (function () {
        function n(s) {
            (this.$L = Me(s.locale, null, !0)), this.parse(s), (this.$x = this.$x || s.x || {}), (this[gn] = !0);
        }
        var t = n.prototype;
        return (
            (t.parse = function (i) {
            ...
            (t.startOf = function (i, e) {
                var r = this,
                    ...
                    u = z.p(i),
                    o = function (D, w) {
                        var g = z.w(r.$u ? Date.UTC(r.$y, w, D) : new Date(r.$y, w, D), r);
                        return a ? g : g.endOf(V);
                    },
                    d = function (D, w) {
                        var g = [0, 0, 0, 0],
                            C = [23, 59, 59, 999];
                        return z.w(r.toDate()[D].apply(r.toDate('s'), (a ? g : C).slice(w)), r);
                    },
                    _ = this.$W,
                    y = this.$M,
                    l = this.$D,
            ...
            (t.$set = function (i, e) {
                ...
                if (a === R || a === K) {
                    ...
                    _.$d[o](d), _.init(), (this.$d = _.set(se, Math.min(this.$D, _.daysInMonth())).$d);
                } else o && this.$d[o](d);
                return this.init(), this;
            }),
            (t.set = function (i, e) {
            ...
            (t.add = function (i, e) {
                ...
                if (u === V) return o(1);
                if (u === oe) return o(7);
                var d = ((a = {}), (a[ne] = ce), (a[ie] = ge), (a[te] = ae), a)[u] || 1,
...
function Ii({
    ...
    return {
        ...
        init: function () {
            ...
            let u = this.getSelectedDate() ?? O().tz(a).hour(0).minute(0).second(0);
            ((this.getMaxDate() !== null && u.isAfter(this.getMaxDate())) ||
                (this.getMinDate() !== null && u.isBefore(this.getMinDate()))) &&
                (u = null),
                (this.hour = u?.hour() ?? 0),
                ...
                this.setMonths(),
                this.setDayLabels(),
                s && this.$nextTick(() => this.togglePanelVisibility(this.$refs.button)),
                ...
                this.$watch('focusedYear', () => {
                    if (
                        (this.focusedYear?.length > 4 && (this.focusedYear = this.focusedYear.substring(0, 4)),
                        !this.focusedYear || this.focusedYear?.length !== 4)
                    )
                        return;
                    let o = +this.focusedYear;
                    Number.isInteger(o) || ((o = O().tz(a).year()), (this.focusedYear = o)),
                        this.focusedDate.year() !== o && (this.focusedDate = this.focusedDate.year(o));
                }),
                ...
                this.$watch('state', () => {
                    ...
                    this.getMaxDate() !== null && o?.isAfter(this.getMaxDate()) && (o = null),
                        this.getMinDate() !== null && o?.isBefore(this.getMinDate()) && (o = null);
                    let d = o?.hour() ?? 0;
            ...
            return !!(
                (this.$refs?.disabledDates &&
                    JSON.parse(this.$refs.disabledDates.value ?? []).some(
                        o => ((o = O(o)), o.isValid() ? o.isSame(u, 'day') : !1)
                    )) ||
        ...
        dayIsDisabled: function (u) {
            return this.focusedDate ?? (this.focusedDate = O().tz(a)), this.dateIsDisabled(this.focusedDate.date(u));
        },
        dayIsSelected: function (u) {
            ...
            return o === null
                ...
                : (this.focusedDate ?? (this.focusedDate = O().tz(a)),
                  o.date() === u && o.month() === this.focusedDate.month() && o.year() === this.focusedDate.year());
        },
        ...
        focusNextDay: function () {
            this.focusedDate ?? (this.focusedDate = O().tz(a)), (this.focusedDate = this.focusedDate.add(1, 'day'));
        },
        focusNextWeek: function () {
            this.focusedDate ?? (this.focusedDate = O().tz(a)), (this.focusedDate = this.focusedDate.add(1, 'week'));
        },
        ...
        togglePanelVisibility: function () {
            this.isOpen() ||
                ((this.focusedDate = this.getSelectedDate() ?? this.getMinDate() ?? O().tz(a)), this.setupDaysGrid()),
        ...
        setDisplayText: function () {
            this.displayText = this.getSelectedDate() ? this.getSelectedDate().format(n) : '';
        },
        setMonths: function () {
        ...
        setupDaysGrid: function () {
            this.focusedDate ?? (this.focusedDate = O().tz(a)),
                ...
                (this.daysInFocusedMonth = Array.from({ length: this.focusedDate.daysInMonth() }, (u, o) => o + 1));
        },
