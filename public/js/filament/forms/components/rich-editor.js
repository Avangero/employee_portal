var po = '2.1.12',
    ...
    mi = { preview: { presentation: 'gallery', caption: { name: !0, size: !0 } }, file: { caption: { size: !0 } } },
    W = {
    ...
    xe = {
        ...
        supportsInputEvents:
            typeof InputEvent < 'u' && ['data', 'getTargetRanges', 'inputType'].every(i => i in InputEvent.prototype),
    },
    ...
    p = function (i) {
        ...
        if (
            (n.editable != null &&
                (n.attributes == null && (n.attributes = {}), (n.attributes.contenteditable = n.editable)),
            n.attributes)
        )
...
`,
    ...
    R = class {
        static proxyMethod(t) {
            ...
            this.prototype[e] = function () {
                ...
                return (
                    n
                        ? (l = o ? ((c = this[n]) === null || c === void 0 ? void 0 : c.call(this)) : this[n]())
                        : r && (l = this[r]),
                    o
    ...
    Eo =
        ((Ln = String.fromCodePoint) === null || Ln === void 0 ? void 0 : Ln.call(String, 32, 128124)) === ' \u{1F47C}',
    Xn,
    Zn;
(Xn =
    xo && Co
...
var So = 0,
    ...
    Br = /Mac|^iP/.test(navigator.platform) ? i => i.metaKey : i => i.ctrlKey,
    Ai = i => setTimeout(i, 1),
    _r = function () {
        let i = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {},
            t = {};
    ...
    Ue = class extends R {
        ...
        unregisterSelectionManager(t) {
            if (
                ((this.selectionManagers = this.selectionManagers.filter(e => e !== t)),
    ...
    xi = i => i.replace(new RegExp(''.concat(yi.source), 'g'), ' ').replace(/\ {2,}/g, ' '),
    nr = function (i, t) {
    ...
    fe = class {
        static groupObjects() {
            let t,
                ...
                { depth: n, asTree: r } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            r && n == null && (n = 0);
            let o = [];
            return (
        ...
        constructor() {
            let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : [],
                { depth: e, asTree: n } = arguments.length > 1 ? arguments[1] : void 0;
            (this.objects = t),
                n &&
                    ((this.depth = e),
                    (this.objects = this.constructor.groupObjects(this.objects, { asTree: n, depth: this.depth + 1 })));
        }
        getObjects() {
            return this.objects;
        }
    ...
    Ht = class extends R {
        ...
        release() {
            var t, e;
            (t = this.promise) === null || t === void 0 || (e = t.cancel) === null || e === void 0 || e.call(t),
                (this.promise = null),
...
var dt = class extends R {
        ...
        invalidate() {
            ...
            return (
                (this.nodes = null),
                (this.childViews = []),
                (t = this.parentView) === null || t === void 0 ? void 0 : t.invalidate()
            );
        }
        ...
        findOrCreateCachedChildView(t, e, n) {
            ...
            return (
                r ? this.recordChildView(r) : ((r = this.createChildView(...arguments)), this.cacheViewForObject(r, e)),
                r
            );
        }
        createChildView(t, e) {
...
var { entries: Ur, setPrototypeOf: rr, isFrozen: Po, getPrototypeOf: Mo, getOwnPropertyDescriptor: Bo } = Object,
...
var lr = U([
    ...
    Ve = (function i() {
        let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : ns(),
            e = a => i(a);
        if (((e.version = '3.2.3'), (e.removed = []), !t || !t.document || t.document.nodeType !== es))
        ...
        let k,
            rt = '',
            { implementation: xt, createNodeIterator: eo, createDocumentFragment: no, getElementsByTagName: io } = n,
            { importNode: ro } = r,
            q = {
        ...
        let {
            ...
            Cn = function () {
                ...
                if (!Wt || Wt !== a) {
                    if (
                        ((a && typeof a == 'object') || (a = {}),
                        (a = St(a)),
                        (ne = ho.indexOf(a.PARSER_MEDIA_TYPE) === -1 ? 'text/html' : a.PARSER_MEDIA_TYPE),
                        (I = ne === 'application/xhtml+xml' ? Fn : _e),
                        (N = $(a, 'ALLOWED_TAGS') ? b({}, a.ALLOWED_TAGS, I) : ki),
                        (O = $(a, 'ALLOWED_ATTR') ? b({}, a.ALLOWED_ATTR, I) : Ri),
                        (xn = $(a, 'ALLOWED_NAMESPACES') ? b({}, a.ALLOWED_NAMESPACES, Fn) : co),
                        (An = $(a, 'ADD_URI_SAFE_ATTR') ? b(St(Pi), a.ADD_URI_SAFE_ATTR, I) : Pi),
                        (Oi = $(a, 'ADD_DATA_URI_TAGS') ? b(St(Fi), a.ADD_DATA_URI_TAGS, I) : Fi),
                        (_t = $(a, 'FORBID_CONTENTS') ? b({}, a.FORBID_CONTENTS, I) : Ii),
                        (te = $(a, 'FORBID_TAGS') ? b({}, a.FORBID_TAGS, I) : {}),
                        (gn = $(a, 'FORBID_ATTR') ? b({}, a.FORBID_ATTR, I) : {}),
                        ...
                        a.CUSTOM_ELEMENT_HANDLING &&
                            ...
                            (w.attributeNameCheck = a.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),
                        a.CUSTOM_ELEMENT_HANDLING &&
                            typeof a.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements == 'boolean' &&
                        ...
                        a.FORBID_CONTENTS && (_t === Ii && (_t = St(_t)), b(_t, a.FORBID_CONTENTS, I)),
                        vn && (N['#text'] = !0),
                        ...
                        k === void 0 &&
                            ...
                            k !== null && typeof rt == 'string' && (rt = k.createHTML(''));
                    U && U(a), (Wt = a);
                }
            },
            Bi = b({}, [...Pn, ...Mn, ...Uo]),
            ...
            ji = function (a) {
                ...
                return (
                    a && h && A.insertBefore(n.createTextNode(h), A.childNodes[0] || null),
                    jt === ot ? io.call(g, Ct ? 'html' : 'body')[0] : Ct ? g.documentElement : A
                );
            },
            Wi = function (a) {
                return eo.call(
        ...
        let Vi = function (a) {
                ...
                let h = I(a.nodeName);
                if (
                    (st(q.uponSanitizeElement, a, { tagName: h, allowedTags: N }),
                    (a.hasChildNodes() &&
                ...
                if (!N[h] || te[h]) {
                    if (
                        !te[h] &&
                        Hi(h) &&
                        ((w.tagNameCheck instanceof RegExp && _(w.tagNameCheck, h)) ||
                ...
                return a instanceof u &&
                                ...
                                : v.namespaceURI === ke
                                  ...
                                  : v.namespaceURI === ot
                                    ? !(A.namespaceURI === Re && !we[D]) &&
                                      ...
                                      !_i[f] &&
                                      (uo[f] || !Bi[f])
                                    : !(ne !== 'application/xhtml+xml' || !xn[v.namespaceURI]))
                        );
                    })(a)
                    ? (tt(a), !0)
                    : (h !== 'noscript' && h !== 'noembed' && h !== 'noframes') ||
                      ...
                      ? (Pt &&
                            ...
                            a.textContent !== g && (oe(e.removed, { element: a.cloneNode() }), (a.textContent = g))),
                    ...
                    if (!(Ti && _(so, g))) {
                        if (!O[g] || gn[g]) {
                            if (
                                !(
                                    (Hi(a) &&
                                        ((w.tagNameCheck instanceof RegExp && _(w.tagNameCheck, a)) ||
                                            (w.tagNameCheck instanceof Function && w.tagNameCheck(a))) &&
                                        ((w.attributeNameCheck instanceof RegExp && _(w.attributeNameCheck, g)) ||
                                            (w.attributeNameCheck instanceof Function && w.attributeNameCheck(g)))) ||
                                    (g === 'is' &&
                                        w.allowCustomizedBuiltInElements &&
                                        ((w.tagNameCheck instanceof RegExp && _(w.tagNameCheck, h)) ||
                                            (w.tagNameCheck instanceof Function && w.tagNameCheck(h))))
            ...
            qi = function (a) {
                ...
                let { attributes: g } = a;
                if (!g || En(a)) return;
                let h = { attrName: '', attrValue: '', keepAttr: !0, allowedAttributes: O, forceKeepAttr: void 0 },
                    v = g.length;
                for (; v--; ) {
                    let A = g[v],
                    ...
                    if (
                        ...
                        (B = h.attrValue),
                        !Ni || (et !== 'id' && et !== 'name') || (Le(f, a), (B = 'user-content-' + B)),
                    ...
                    let Ji = I(a.nodeName);
                    if (zi(Ji, et, B)) {
                        if (k && typeof Q == 'object' && typeof Q.getAttributeType == 'function' && !D)
            ...
            mo = function a(g) {
                let h = null,
                    v = Wi(g);
                for (st(q.beforeSanitizeShadowDOM, g, null); (h = v.nextNode()); )
                    st(q.uponSanitizeShadowNode, h, null), Vi(h), qi(h), h.content instanceof s && a(h.content);
            ...
            (e.sanitize = function (a) {
                ...
                if ((fn || Cn(g), (e.removed = []), typeof a == 'string' && (ee = !1), ee)) {
                    ...
                    (h = ji('<!---->')),
                        ...
                        (v.nodeType === Xo && v.nodeName === 'BODY') || v.nodeName === 'HTML'
                            ? (h = v)
                            : h.appendChild(v);
                else {
                ...
                if (ee) return a;
                if (Mt) {
                    if (Ee) for (f = no.call(h.ownerDocument); h.firstChild; ) f.appendChild(h.firstChild);
                    else f = h;
...
var is = 'style href src width height language class'.split(' '),
    ...
    qt = class extends R {
        ...
        sanitizeElement(t) {
            return (
                t.hasAttribute('href') && this.forbiddenProtocols.includes(t.protocol) && t.removeAttribute('href'),
    ...
    be = class extends dt {
        ...
        createNodes() {
            let t,
                e = (t = p({ tagName: 'figure', className: this.getClassName(), data: this.getData(), editable: !1 })),
                n = this.getHref();
            return (
                n && ((t = p({ tagName: 'a', editable: !1, attributes: { href: n, tabindex: -1 } })), e.appendChild(t)),
        ...
        createCaptionElement() {
            let t = p({ tagName: 'figcaption', className: pt.attachmentCaption }),
                e = this.attachmentPiece.getCaption();
            if (e) t.classList.add(''.concat(pt.attachmentCaption, '--edited')), (t.textContent = e);
            else {
                let n,
                    r,
        ...
        getCaptionConfig() {
            ...
            let e = this.attachment.getType(),
                n = _r((t = mi[e]) === null || t === void 0 ? void 0 : t.caption);
    ...
    ze = class extends be {
        ...
        createContentNodes() {
            return (
                (this.image = p({ tagName: 'img', attributes: { src: '' }, data: { trixMutable: !0 } })),
        ...
        refresh(t) {
            var e;
            if ((t || (t = (e = this.findElement()) === null || e === void 0 ? void 0 : e.querySelector('img')), t))
        ...
        updateAttributesForImage(t) {
            ...
            if (((t.src = n || e), n === e)) t.removeAttribute('data-trix-serialized-attributes');
            else {
        ...
        preserveSpaces(t) {
            return (
                ...
                (t = t
                    ...
                    .replace(/\ {2}/g, ' '.concat(ft))),
                (this.context.isFirst || this.context.followsWhitespace) && (t = t.replace(/^\ /, ft)),
                t
            );
        }
    },
...
function z(i, t, e) {
    return (
        (t = hs(t)) in i
            ? Object.defineProperty(i, t, { value: e, enumerable: !0, configurable: !0, writable: !0 })
            : (i[t] = e),
        i
    );
}
...
var gt = class extends ht {
    ...
    isEqualTo(t) {
        return (
            ...
            (this.hasSameConstructorAs(t) && this.hasSameStringValueAsPiece(t) && this.hasSameAttributesAsPiece(t))
        );
    }
    isEmpty() {
...
var Ke = class extends Ht {
        ...
        perform(t) {
            let e = new Image();
            (e.onload = () => (
                (e.width = this.width = e.naturalWidth), (e.height = this.height = e.naturalHeight), t(!0, e)
            )),
                (e.onerror = () => t(!1)),
                (e.src = this.url);
        }
                ...
                return (
                    ...
                    new Ke(t)
                        .then(n => {
                            ...
                            return (
                                (this.getWidth() && this.getHeight()) || this.setAttributes({ width: r, height: o }),
...
var Gt = class i extends gt {
    ...
    ensureAttachmentExclusivelyHasAttribute(t) {
        this.hasAttribute(t) &&
            (this.attachment.hasAttribute(t) || this.attachment.setAttributes(this.attributes.slice([t])),
    ...
    isEqualTo(t) {
        ...
        return (
            super.isEqualTo(t) &&
            this.attachment.id === (t == null || (e = t.attachment) === null || e === void 0 ? void 0 : e.id)
        );
    }
    toString() {
        return '\uFFFC';
    ...
    splitAtOffset(t) {
        ...
        return (
            t === 0
                ...
                : t === this.length
                  ? ((e = this), (n = null))
                  : ((e = new this.constructor(this.string.slice(0, t), this.attributes)),
                    (n = new this.constructor(this.string.slice(t), this.attributes))),
            [e, n]
        );
    }
    toConsole() {
        ...
        consolidate() {
            ...
            return (
                this.objects.slice(1).forEach(n => {
                    var r, o;
                    (r = (o = e).canBeConsolidatedWith) !== null && r !== void 0 && r.call(o, n)
        ...
        getEndPosition() {
            return (
                this.endPosition == null &&
                    ((this.endPosition = 0), this.objects.forEach(t => (this.endPosition += t.getLength()))),
                this.endPosition
            );
        }
        toString() {
    ...
    J = class extends ht {
        ...
        addAttributesAtRange(t, e) {
            return this.copyWithPieceList(
                this.pieceList.transformObjectsInRange(e, n => n.copyWithAdditionalAttributes(t))
            );
        }
        ...
        getAttributesAtPosition(t) {
            var e;
            return (
                ((e = this.pieceList.getObjectAtPosition(t)) === null || e === void 0 ? void 0 : e.getAttributes()) ||
                {}
            );
        }
        getCommonAttributes() {
        ...
        getAttachmentAndPositionById(t) {
            ...
            for (let r of this.pieceList.toArray()) {
                var n;
                if (((n = r.attachment) === null || n === void 0 ? void 0 : n.id) === t)
        ...
        isEqualTo(t) {
            ...
            return (
                super.isEqualTo(t) ||
                (t == null || (e = t.pieceList) === null || e === void 0 ? void 0 : e.isEqualTo(this.pieceList))
            );
        }
        isBlockBreak() {
                ...
                t === 0
                    ...
                    : t === this.getLength()
                      ...
                      : ((e = this.copyWithText(this.text.getTextAtRange([0, t]))),
                        (n = this.copyWithText(this.text.getTextAtRange([t, this.getLength()])))),
                [e, n]
            );
        }
...
`,
    ...
    V = class extends ht {
        ...
        copy() {
            let t = (arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}).consolidateBlocks
        ...
        insertDocumentAtRange(t, e) {
            ...
            return (
                ...
                new this.constructor(l.blockList.insertSplittableListAtPosition(n, r))
            );
        }
        ...
        insertTextAtRange(t, e) {
            ...
            return new this.constructor(
                s.blockList.editObjectAtIndex(r, l => l.copyWithText(l.text.insertTextAtPosition(t, o)))
            );
        }
        removeTextAtRange(t) {
            let e;
...
`
                ...
                e = this.blockList.editObjectAtIndex(d, H => H.copyWithText(H.text.removeTextAtRange([C, C + 1])));
            else {
                let H,
                    ...
                    mt = Q.appendText(M);
                H =
                    l !== d && c === 0 && u.getAttributeLevel() >= T.getAttributeLevel()
                        ? T.copyWithText(mt)
                        : u.copyWithText(mt);
                let yt = d + 1 - l;
        ...
        moveTextFromRangeToPosition(t, e) {
            ...
            let [u, ...d] = s.getBlocks();
            return (
                d.length === 0 ? ((n = u.getTextWithoutBlockBreak()), c && (e += 1)) : (n = u.text),
                (l = l.insertTextAtRange(n, e)),
                d.length === 0
                    ? l
                    : ((s = new this.constructor(d)), (e += n.getLength()), l.insertDocumentAtRange(s, e))
            );
        }
        addAttributeAtRange(t, e, n) {
                    ...
                    (o, s, l) =>
                        (r = r.editObjectAtIndex(l, function () {
                            return L(t)
                                ...
                                : s[0] === s[1]
                                  ? o
                                  : o.copyWithText(o.text.addAttributeAtRange(t, e, s));
                        }))
                ),
        ...
        addAttribute(t, e) {
            ...
            return (
                this.eachBlock((r, o) => (n = n.editObjectAtIndex(o, () => r.addAttribute(t, e)))),
            ...
            return (
                this.eachBlockAtRange(e, function (r, o, s) {
                    L(t)
                        ...
                        : o[0] !== o[1] &&
                          (n = n.editObjectAtIndex(s, () => r.copyWithText(r.text.removeAttributeAtRange(t, o))));
                }),
                new this.constructor(n)
            );
        }
        updateAttributesForAttachment(t, e) {
            ...
            return new this.constructor(
                this.blockList.editObjectAtIndex(o, l => l.copyWithText(s.updateAttributesForAttachment(t, e)))
            );
        }
        ...
        insertBlockBreakAtRange(t) {
            ...
            return (
                r === 0 && (e = [new bt()]),
                new this.constructor(o.blockList.insertSplittableListAtPosition(new $t(e), n))
            );
        }
        ...
        expandRangeToLineBreaksAndSplitBlocks(t) {
            ...
            if (
                ((o.offset = c.findLineBreakInDirectionFromPosition('backward', o.offset)),
                o.offset != null &&
                ...
                (s.index -= 1), (s.offset = l.getBlockAtIndex(s.index).getBlockBreakPosition());
            else {
...
`
                    ? (s.offset -= 1)
                    : (s.offset = u.findLineBreakInDirectionFromPosition('forward', s.offset)),
                    s.offset !== u.getBlockBreakPosition() &&
                        ((e = l.positionFromLocation(s)), (l = l.insertBlockBreakAtRange([e, e + 1])));
            }
            return (
        ...
        eachBlockAtRange(t, e) {
            ...
            if (l.index === c.index)
                return (n = this.getBlockAtIndex(l.index)), (r = [l.offset, c.offset]), e(n, r, l.index);
        ...
        getRangeOfCommonAttributeAtPosition(t, e) {
            let { index: n, offset: r } = this.locationFromPosition(e),
                ...
                [s, l] = Array.from(o.getExpandedRangeForAttributeAtOffset(t, r)),
        ...
        findRangesForTextAttribute(t) {
            let { withValue: e } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {},
                n = 0,
                r = [],
                o = [];
            return (
                this.getPieces().forEach(s => {
                    ...
                    })(s) && (r[1] === n ? (r[1] = n + l) : o.push((r = [n, n + l]))),
                        (n += l);
                }),
                o
            );
        ...
        toSerializableDocument() {
            let t = [];
            return (
                this.blockList.eachObject(e => t.push(e.copyWithText(e.text.toSerializableText()))),
                new this.constructor(t)
            );
        }
        toString() {
    ...
    Ft = class extends R {
        ...
        createHiddenContainer() {
            return this.referenceElement
                ...
                : ((this.containerElement = p({ tagName: 'div', style: { display: 'none' } })),
            ...
            switch (t.nodeType) {
                case Node.TEXT_NODE:
                    if (!this.isInsignificantTextNode(t))
                        return this.appendBlockForTextNode(t), this.processTextNode(t);
                    break;
                case Node.ELEMENT_NODE:
        ...
        appendBlockForTextNode(t) {
            let e = t.parentNode;
            if (e === this.currentBlockElement && this.isBlockElement(t.previousSibling))
...
`);
            if (e === this.containerElement || this.isBlockElement(e)) {
                ...
                It(r, (n = this.currentBlock) === null || n === void 0 ? void 0 : n.attributes) ||
                    ((this.currentBlock = this.appendBlockForAttributesWithElement(r, e, o)),
                ...
                if (!this.isInsignificantTextNode(t.firstChild) || !this.isBlockElement(t.firstElementChild)) {
                    ...
                    if (t.firstChild) {
                        if (n && It(r, this.currentBlock.attributes))
                            return this.appendStringWithAttributes(`
`);
                        (this.currentBlock = this.appendBlockForAttributesWithElement(r, t, o)),
        ...
        processTextNode(t) {
            ...
            return (
                Cr(t.parentNode) ||
                    ((e = xi(e)),
                    Gr((n = t.previousSibling) === null || n === void 0 ? void 0 : n.textContent) && (e = Ss(e))),
                this.appendStringWithAttributes(e, this.getTextAttributes(t.parentNode))
            );
        }
        processElement(t) {
            let e;
...
`,
                ...
                case 'img':
                    ...
                    return (
                        this.appendAttachmentWithAttributes(e, this.getTextAttributes(t)),
                        this.processedElements.push(t)
                    );
                case 'tr':
        ...
        appendPiece(t) {
            return (
                this.blocks.length === 0 && this.appendEmptyBlock(), this.blocks[this.blocks.length - 1].text.push(t)
            );
        }
        ...
        getTextAttributes(t) {
            ...
            for (let r in Dt) {
                let o = Dt[r];
                if (o.tagName && vt(t, { matchingSelector: o.tagName, untilNode: this.containerElement })) n[r] = !0;
                else if (o.parser) {
                    if (((e = o.parser(t)), e)) {
                        let s = !1;
        ...
        getBlockAttributes(t) {
            ...
            for (; t && t !== this.containerElement; ) {
                for (let r in W) {
                    ...
                    o.parse !== !1 &&
                        j(t) === o.tagName &&
                        (((n = o.test) !== null && n !== void 0 && n.call(o, t)) || !o.test) &&
        ...
        isBlockElement(t) {
            if (
                ...
                !Tt(t) &&
                !vt(t, { matchingSelector: 'td', untilNode: this.containerElement })
            )
        ...
        isInsignificantTextNode(t) {
            ...
            return (Cs(e.previousSibling) && !this.isBlockElement(e.previousSibling)) || Cr(e)
                ? void 0
...
`,
    ...
    Ls = {
        ...
        'text/html': function (i) {
            ...
            return (
                Array.from(t.querySelectorAll('[data-trix-serialize=false]')).forEach(e => {
                    At(e);
                }),
                Rs.forEach(e => {
...
var Ge = class extends R {
        ...
        manageAttachment(t) {
            return (
                this.managedAttachments[t.id] || (this.managedAttachments[t.id] = new E(this, t)),
        ...
        requestRemovalOfAttachment(t) {
            ...
            if (this.attachmentIsManaged(t))
                return (e = this.delegate) === null ||
                    e === void 0 ||
                    (n = e.attachmentManagerDidRequestRemovalOfAttachment) === null ||
                    n === void 0
                    ? void 0
                    : n.call(e, t);
        }
    ...
    it = class extends R {
        ...
        insertText(t) {
            let { updatePosition: e } =
                    arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : { updatePosition: !0 },
        ...
        insertBlock() {
            let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : new bt(),
                e = new V([t]);
            return this.insertDocument(e);
        }
        insertDocument() {
            let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : new V(),
...
`);
        ...
        insertAttachments(t) {
            ...
            return (
                Array.from(t).forEach(n => {
                    var r;
                    let o = n.getType(),
                        s = (r = mi[o]) === null || r === void 0 ? void 0 : r.presentation,
        ...
        deleteInDirection(t) {
            let e,
                n,
                r,
                { length: o } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {},
                s = this.getLocationRange(),
                l = this.getSelectedRange(),
                c = ut(l);
            if (
                (c ? (n = t === 'backward' && s[0].offset === 0) : (r = s[0].index !== s[1].index),
                n && this.canDecreaseBlockAttributeLevel())
            ) {
                let u = this.getBlock();
                if (
                    (u.isListItem() ? this.decreaseListLevel() : this.decreaseBlockAttributeLevel(),
        ...
        selectPlaceholder() {
            if (this.placeholderPosition != null)
                return (
                    this.setSelectedRange([this.placeholderPosition, this.placeholderPosition + 1]),
        ...
        setBlockAttribute(t, e) {
            ...
            if (this.canSetCurrentAttribute(t))
                return this.setDocument(this.document.applyBlockAttributeAtRange(t, e, n)), this.setSelection(n);
        }
        ...
        canIncreaseNestingLevel() {
            ...
            let e = this.getBlock();
            if (e) {
                if ((t = L(e.getLastNestableAttribute())) === null || t === void 0 || !t.listAttribute)
                    return e.getNestingLevel() > 0;
                {
                    ...
                    if (n)
                        return (function () {
                            ...
                            return It(
                                (arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : []).slice(
                                    0,
                                    r.length
                                ),
                                r
        ...
        updateCurrentAttributes() {
            ...
            if (t) {
                ...
                if (
                    ...
                    return (this.currentAttributes = e), this.notifyDelegateOfCurrentAttributesChange();
            }
        }
        ...
        getLocationRange(t) {
            return this.targetLocationRange
                ...
                : this.getSelectionManager().getLocationRange(t) || y({ index: 0, offset: 0 });
        }
        ...
        moveCursorInDirection(t) {
            let e, n;
            if (this.editingAttachment) n = this.document.getRangeOfAttachment(this.editingAttachment);
            else {
                            ...
                            (o.delegate = this),
                                r.push(
                                    (s = this.delegate) === null ||
                                        s === void 0 ||
                                        (l = s.compositionDidAddAttachment) === null ||
                                        l === void 0
                                        ? void 0
                                        : l.call(s, o)
                                );
...
var Ae = class extends R {
    ...
    Ns = (i, t, e) => i?.description === t?.toString() && i?.context === JSON.stringify(e),
            ...
            this.findRangesOfPieces().forEach(e => {
                e[1] - e[0] > 1 &&
                    ...
                    this.document.getCharacterAtPosition(e[1]) !==
                        `
` &&
                        ((this.document = this.document.insertBlockBreakAtRange(e[1])),
                        e[1] < this.selectedRange[1] && this.moveSelectedRangeForward(),
                        e[1]++,
                        t++),
                    e[0] !== 0 &&
                        this.document.getCharacterAtPosition(e[0] - 1) !==
                            `
` &&
                        ((this.document = this.document.insertBlockBreakAtRange(e[0])),
                        e[0] < this.selectedRange[0] && this.moveSelectedRangeForward(),
                        e[0]++,
                        t++),
                    (this.document = this.document.applyBlockAttributeAtRange(Wn, !0, e)));
            });
        }
        findRangesOfBlocks() {
    ...
    Ze = class {
        ...
        findLocationFromContainerAndOffset(t, e) {
            let { strict: n } = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : { strict: !0 },
                r = 0,
                o = !1,
                s = { index: 0, offset: 0 },
        ...
        findContainerAndOffsetFromLocation(t) {
            ...
            if (r) {
                if (ge(r))
                    Un(r) === 0
                        ? ((e = r.parentNode.parentNode), (n = kn(r.parentNode)), zt(r, { name: 'right' }) && n++)
                        : ((e = r), (n = t.offset - o));
                else {
                    if (((e = r.parentNode), !Yi(r.previousSibling) && !Rn(e)))
                        for (; r === e.lastChild && ((r = e), (e = e.parentNode), !Rn(e)); );
                    (n = kn(r)), t.offset !== 0 && n++;
                }
                return [e, n];
            }
    ...
    ct = class extends R {
        constructor(t) {
            super(...arguments),
                ...
                (this.lockCount = 0),
                S('mousedown', { onElement: this.element, withCallback: this.didMouseDown });
        }
        getLocationRange() {
            let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
            return t.strict === !1
        ...
        lock() {
            this.lockCount++ == 0 &&
                (this.updateCurrentLocationRange(), (this.lockedLocationRange = this.getLocationRange()));
        }
        unlock() {
            if (--this.lockCount == 0) {
        ...
        updateCurrentLocationRange(t) {
            var e, n;
            if ((t ?? (t = this.createLocationRangeFromDOMRange(me()))) && !We(t, this.currentLocationRange))
                return (
        ...
        domRangeWithinElement(t) {
            return t.collapsed
                ...
                : kt(this.element, t.startContainer) && kt(this.element, t.endContainer);
        }
    };
...
var Xr = Object.freeze({
    ...
    tn = class extends R {
        constructor(t, e, n) {
            ...
            super(...arguments),
                ...
                z(
                    ...
                    zn(() => {
                        ...
                        return (
                            ...
                            S('click', { onElement: o, withCallback: this.didClickToolbar }),
                            S('click', {
                                onElement: o,
                ...
                z(
                    ...
                    zn(() => {
                        ...
                        S('input', { onElement: o, withCallback: l }),
                            S('input', { onElement: o, withCallback: this.didInputCaption }),
                            S('keydown', { onElement: o, withCallback: this.didKeyDownCaption }),
                            S('change', { onElement: o, withCallback: this.didChangeCaption }),
                        ...
                        return {
                            do: () => {
                                if (
                                    ...
                                    u.appendChild(o),
                                    u.appendChild(s),
                                    u.classList.add(''.concat(Et.attachmentCaption, '--editing')),
                ...
                j(this.element) === 'a' && (this.element = this.element.firstChild),
                this.install();
        }
        install() {
            ...
            if (this.pendingCaption != null) {
                ...
                (this.pendingCaption = null),
                    o
                        ? (t = this.delegate) === null ||
                          t === void 0 ||
                          (e = t.attachmentEditorDidRequestUpdatingAttributesForAttachment) === null ||
                          e === void 0 ||
                          e.call(t, { caption: o }, this.attachment)
                        : (n = this.delegate) === null ||
                          n === void 0 ||
                          (r = n.attachmentEditorDidRequestRemovingAttributeForAttachment) === null ||
                          r === void 0 ||
        ...
        didClickActionButton(t) {
            ...
            if (t.target.getAttribute('data-trix-action') === 'remove')
                return (e = this.delegate) === null || e === void 0
                    ? void 0
                    : e.attachmentEditorDidRequestRemovalOfAttachment(this.attachment);
        }
        didKeyDownCaption(t) {
            var e, n;
            if (Ms[t.keyCode] === 'return')
                return (
                    ...
                    (e = this.delegate) === null ||
                    e === void 0 ||
                    (n = e.attachmentEditorDidRequestDeselectingAttachment) === null ||
                    n === void 0
                        ? void 0
    ...
    en = class extends R {
        constructor(t, e) {
            super(...arguments),
                ...
                (this.element = t),
                (this.composition = e),
                (this.documentView = new Jt(this.composition.document, { element: this.element })),
                S('focus', { onElement: this.element, withCallback: this.didFocus }),
                S('blur', { onElement: this.element, withCallback: this.didBlur }),
                S('click', {
                    onElement: this.element,
        ...
        render() {
            ...
            return (
                ...
                this.canSyncDocumentView() &&
                    ...
                    ((n = this.delegate) === null ||
                        n === void 0 ||
                        (r = n.compositionControllerWillSyncDocumentView) === null ||
                        r === void 0 ||
                        r.call(n),
        ...
        attachmentEditorDidRequestRemovalOfAttachment(t) {
            ...
            return (e = this.delegate) === null ||
                e === void 0 ||
                (n = e.compositionControllerDidRequestRemovalOfAttachment) === null ||
                n === void 0
                ? void 0
                : n.call(e, t);
        }
        attachmentEditorDidRequestDeselectingAttachment(t) {
            ...
            return (e = this.delegate) === null ||
                e === void 0 ||
                (n = e.compositionControllerDidRequestDeselectingAttachment) === null ||
                n === void 0
                ? void 0
                : n.call(e, t);
        }
    ...
    rn = class extends R {
        ...
        didMutate(t) {
            var e, n;
            if ((this.mutations.push(...Array.from(this.findSignificantMutations(t) || [])), this.mutations.length))
                return (
                    (e = this.delegate) === null ||
                        e === void 0 ||
            ...
            if (n.length) {
                let r = n[0],
                    ...
                    s = (function (l, c) {
                        ...
                        return (
                            (l = Nt.box(l)),
                            (c = Nt.box(c)).length < l.length ? ([d, u] = nr(l, c)) : ([u, d] = nr(c, l)),
                            { added: u, removed: d }
                        );
    ...
    ci = class {
        ...
        insertingLongTextAfterUnidentifiedChar() {
            ...
            return (
                ...
                ((t = this.event.data) === null || t === void 0 ? void 0 : t.length) > 50
            );
        }
        ...
        previousEventWasUnidentifiedKeydown() {
            var t, e;
            return (
                ((t = this.previousEvent) === null || t === void 0 ? void 0 : t.type) === 'keydown' &&
                ((e = this.previousEvent) === null || e === void 0 ? void 0 : e.key) === 'Unidentified'
            );
        }
    },
    js = (i, t) => Sr(i) === Sr(t),
    Ws = new RegExp('('.concat('\uFFFC', '|').concat(ln, '|').concat(ft, '|\\s)+'), 'g'),
        ...
        attachFiles(t) {
            ...
            return Promise.all(e).then(n => {
                this.handleInput(function () {
                    var r, o;
                    return (
                        (r = this.delegate) === null || r === void 0 || r.inputControllerWillAttachFiles(),
                        (o = this.responder) === null || o === void 0 || o.insertFiles(n),
                        this.requestRender()
                    );
                });
            });
    ...
    Y = class extends Yt {
                ...
                : this.handleInput(function () {
                      return (
                          this.mutationIsSignificant(t) &&
                              (this.mutationIsExpected(t) ? this.requestRender() : this.requestReparse()),
                          this.reset()
                      );
                  });
        }
        mutationIsExpected(t) {
            ...
            let r = e != null ? e === this.inputSummary.textAdded : !this.inputSummary.textAdded,
                o = n != null ? this.inputSummary.didDelete : !this.inputSummary.didDelete,
                s =
                    [
                        `
`,
...
` && !o;
        ...
        deleteInDirection(t, e) {
            var n;
            return ((n = this.responder) === null || n === void 0 ? void 0 : n.deleteInDirection(t)) !== !1
...
z(Y, 'events', {
    keydown(i) {
        ...
        if (t) {
            ...
            ['ctrl', 'alt', 'shift', 'meta'].forEach(o => {
                var s;
                i[''.concat(o, 'Key')] &&
                    (o === 'ctrl' && (o = 'control'), (r = (s = r) === null || s === void 0 ? void 0 : s[o]));
            }),
                ((e = r) === null || e === void 0 ? void 0 : e[t]) != null &&
                    (this.setInputSummary({ keyName: t }), Ot.reset(), r[t].call(this, i));
        }
        if (Br(i)) {
    ...
    keypress(i) {
        ...
        var e, n;
        return t
            ? ((e = this.delegate) === null || e === void 0 || e.inputControllerWillPerformTyping(),
              (n = this.responder) === null || n === void 0 || n.insertString(t),
              this.setInputSummary({ textAdded: t, didDelete: this.selectionIsExpanded() }))
            : void 0;
    },
    textInput(i) {
        let { data: t } = i,
    ...
    dragstart(i) {
        ...
        return (
            ...
            (t = this.delegate) === null || t === void 0 || (e = t.inputControllerDidStartDrag) === null || e === void 0
                ? void 0
                : e.call(t)
        );
    },
    ...
    drop(i) {
        ...
        if (
            ((e = this.responder) === null || e === void 0 || e.setLocationRangeFromPointRange(o),
            n != null && n.length)
        )
            this.attachFiles(n);
        else if (this.draggedRange) {
            var s, l;
            (s = this.delegate) === null || s === void 0 || s.inputControllerWillMoveText(),
    ...
    cut(i) {
        ...
        if (
            ...
            (this.serializeSelectionToDataTransfer(i.clipboardData) && i.preventDefault(),
            (e = this.delegate) === null || e === void 0 || e.inputControllerWillCutText(),
    ...
    paste(i) {
        ...
        if (!t || Js(i))
            return void this.getPastedHTMLUsingHiddenElement(F => {
                ...
                return (
                    (e.type = 'text/html'),
                    (e.html = F),
                    (k = this.delegate) === null || k === void 0 || k.inputControllerWillPaste(e),
                    (rt = this.responder) === null || rt === void 0 || rt.insertHTML(e.html),
                    this.requestRender(),
                    (xt = this.delegate) === null || xt === void 0 ? void 0 : xt.inputControllerDidPaste(e)
                );
            });
        let n = t.getData('URL'),
        ...
        if (n) {
            ...
            (e.type = 'text/html'),
                ...
                (s = this.delegate) === null || s === void 0 || s.inputControllerWillPaste(e),
                this.setInputSummary({ textAdded: F, didDelete: this.selectionIsExpanded() }),
                (l = this.responder) === null || l === void 0 || l.insertHTML(e.html),
                this.requestRender(),
                (c = this.delegate) === null || c === void 0 || c.inputControllerDidPaste(e);
        } else if (Mr(t)) {
            var u, d, C;
            (e.type = 'text/plain'),
                (e.string = t.getData('text/plain')),
                (u = this.delegate) === null || u === void 0 || u.inputControllerWillPaste(e),
                this.setInputSummary({ textAdded: e.string, didDelete: this.selectionIsExpanded() }),
                (d = this.responder) === null || d === void 0 || d.insertString(e.string),
                this.requestRender(),
                (C = this.delegate) === null || C === void 0 || C.inputControllerDidPaste(e);
        } else if (r) {
            var T, H, Q;
            (e.type = 'text/html'),
                (e.html = r),
                (T = this.delegate) === null || T === void 0 || T.inputControllerWillPaste(e),
                (H = this.responder) === null || H === void 0 || H.insertHTML(e.html),
                this.requestRender(),
                (Q = this.delegate) === null || Q === void 0 || Q.inputControllerDidPaste(e);
            ...
            if (F) {
                var yt, Zt, Qt;
                let k = zs(F);
                !F.name && k && (F.name = 'pasted-file-'.concat(++Vs, '.').concat(k)),
                    (e.type = 'File'),
                    (e.file = F),
                    (yt = this.delegate) === null || yt === void 0 || yt.inputControllerWillAttachFiles(),
                    (Zt = this.responder) === null || Zt === void 0 || Zt.insertFile(e.file),
                    this.requestRender(),
                    (Qt = this.delegate) === null || Qt === void 0 || Qt.inputControllerDidPaste(e);
            }
        }
        i.preventDefault();
    },
    ...
    z(Y, 'keys', {
        ...
        return(i) {
            ...
            return (
                ...
                (t = this.delegate) === null || t === void 0 || t.inputControllerWillPerformTyping(),
                (e = this.responder) === null || e === void 0 ? void 0 : e.insertLineBreak()
            );
        },
        tab(i) {
            var t, e;
            (t = this.responder) !== null &&
                ...
                ((e = this.responder) === null || e === void 0 || e.increaseNestingLevel(),
                this.requestRender(),
                i.preventDefault());
        },
        left(i) {
            ...
            if (this.selectionIsInCursorTarget())
                return (
                    i.preventDefault(),
                    (t = this.responder) === null || t === void 0 ? void 0 : t.moveCursorInDirection('backward')
                );
        },
        right(i) {
            var t;
            if (this.selectionIsInCursorTarget())
                return (
                    i.preventDefault(),
                    (t = this.responder) === null || t === void 0 ? void 0 : t.moveCursorInDirection('forward')
                );
        },
        control: {
            d(i) {
...
`),
            ...
            tab(i) {
                ...
                (t = this.responder) !== null &&
                    ...
                    ((e = this.responder) === null || e === void 0 || e.decreaseNestingLevel(),
                    this.requestRender(),
                    i.preventDefault());
            },
            left(i) {
                if (this.selectionIsInCursorTarget())
                    return i.preventDefault(), this.expandSelectionInDirection('backward');
            },
            right(i) {
                if (this.selectionIsInCursorTarget())
                    return i.preventDefault(), this.expandSelectionInDirection('forward');
            },
        },
        alt: {
            backspace(i) {
                ...
                return (
                    ...
                    (t = this.delegate) === null || t === void 0 ? void 0 : t.inputControllerWillPerformTyping()
                );
            },
        },
        meta: {
...
var zs = i => {
        var t;
        return (t = i.type) === null || t === void 0 || (t = t.match(/\/(\w+)$/)) === null || t === void 0
            ? void 0
            : t[1];
    },
    Hs = !((Hn = ' '.codePointAt) === null || Hn === void 0 || !Hn.call(' ', 0)),
    qs = function (i) {
        if (i.key && Hs && i.key.codePointAt(0) === i.keyCode) return i.key;
        {
            let t;
            if (
                (i.which === null ? (t = i.keyCode) : i.which !== 0 && i.charCode !== 0 && (t = i.charCode),
                t != null && Qr[t] !== 'escape')
            )
    ...
    nt = class extends R {
        ...
        start(t) {
            if (((this.data.start = t), this.isSignificant())) {
                ...
                this.inputSummary.eventName === 'keypress' &&
                    ...
                    ((n = this.responder) === null || n === void 0 || n.deleteInDirection('left')),
                    this.selectionIsExpanded() || (this.insertPlaceholder(), this.requestRender()),
                    (this.range = (e = this.responder) === null || e === void 0 ? void 0 : e.getSelectedRange());
            }
        }
        update(t) {
                    ...
                    ? (this.forgetPlaceholder(),
                      this.canApplyToDocument()
                          ? (this.setInputSummary({ preferDocument: !0, didInput: !1 }),
                            (e = this.delegate) === null || e === void 0 || e.inputControllerWillPerformTyping(),
                            (n = this.responder) === null || n === void 0 || n.setSelectedRange(this.range),
                            (r = this.responder) === null || r === void 0 || r.insertString(this.data.end),
                            (o = this.responder) === null || o === void 0
                                ? void 0
                                : o.setSelectedRange(this.range[0] + this.data.end.length))
        ...
        canApplyToDocument() {
            var t, e;
            return (
                ((t = this.data.start) === null || t === void 0 ? void 0 : t.length) === 0 &&
                ((e = this.data.end) === null || e === void 0 ? void 0 : e.length) > 0 &&
                this.range
            );
        }
    };
...
var wt = class extends Yt {
    ...
    render() {
        ...
        cancelAnimationFrame(this.scheduledRender),
            ...
            this.composing || (e = this.delegate) === null || e === void 0 || e.render(),
    ...
    toggleAttributeIfSupported(t) {
        ...
        if (Qn().includes(t))
            return (
                (e = this.delegate) === null || e === void 0 || e.inputControllerWillPerformFormatting(t),
                this.withTargetDOMRange(function () {
                    var n;
    ...
    activateAttributeIfSupported(t, e) {
        ...
        if (Qn().includes(t))
            return (
                (n = this.delegate) === null || n === void 0 || n.inputControllerWillPerformFormatting(t),
                this.withTargetDOMRange(function () {
                    var r;
    ...
    deleteInDirection(t) {
        let { recordUndoEntry: e } =
            arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : { recordUndoEntry: !0 };
        var n;
...
z(wt, 'events', {
    ...
    paste(i) {
        var t;
        let e,
            n = (t = i.clipboardData) === null || t === void 0 ? void 0 : t.getData('URL');
        return to(i)
            ? (i.preventDefault(), this.attachFiles(i.clipboardData.files))
            : $s(i)
              ? (i.preventDefault(),
                (e = { type: 'text/plain', string: i.clipboardData.getData('text/plain') }),
                (r = this.delegate) === null || r === void 0 || r.inputControllerWillPaste(e),
                (o = this.responder) === null || o === void 0 || o.insertString(e.string),
                this.render(),
                (s = this.delegate) === null || s === void 0 ? void 0 : s.inputControllerDidPaste(e))
              : n
                ? (i.preventDefault(),
                  (e = { type: 'text/html', html: this.createLinkHTML(n) }),
                  (l = this.delegate) === null || l === void 0 || l.inputControllerWillPaste(e),
                  (c = this.responder) === null || c === void 0 || c.insertHTML(e.html),
                  this.render(),
                  (u = this.delegate) === null || u === void 0 ? void 0 : u.inputControllerDidPaste(e))
                : void 0;
        var r, o, s, l, c, u;
    },
    beforeinput(i) {
        let t = this.constructor.inputTypes[i.inputType],
            e =
                ((n = i),
                !(!/iPhone|iPad/.test(navigator.userAgent) || (n.inputType && n.inputType !== 'insertParagraph')));
        var n;
        ...
        if (this.dragging) {
            ...
            if (!Xt(e, this.dragging.point))
                return (
                    ...
                    (t = this.responder) === null || t === void 0 ? void 0 : t.setLocationRangeFromPointRange(e)
                );
    ...
    drop(i) {
        ...
        if (this.dragging)
            return (
                i.preventDefault(),
                (t = this.delegate) === null || t === void 0 || t.inputControllerWillMoveText(),
                (e = this.responder) === null || e === void 0 || e.moveTextFromRange(this.dragging.range),
                (this.dragging = null),
                this.scheduleRender()
            );
        if (qn(i)) {
            ...
            let r = Jn(i);
            return (
                (n = this.responder) === null || n === void 0 || n.setLocationRangeFromPointRange(r),
    ...
    dragend() {
        var i;
        this.dragging &&
            ((i = this.responder) === null || i === void 0 || i.setSelectedRange(this.dragging.range),
            (this.dragging = null));
    },
    compositionend(i) {
    ...
    z(wt, 'keys', {
        ArrowLeft() {
            var i, t;
            if ((i = this.responder) !== null && i !== void 0 && i.shouldManageMovingCursorInDirection('backward'))
                return (
        ...
        ArrowRight() {
            var i, t;
            if ((i = this.responder) !== null && i !== void 0 && i.shouldManageMovingCursorInDirection('forward'))
                return (
                    this.event.preventDefault(),
                    (t = this.responder) === null || t === void 0 ? void 0 : t.moveCursorInDirection('forward')
                );
        ...
        Backspace() {
            var i, t, e;
            if ((i = this.responder) !== null && i !== void 0 && i.shouldManageDeletingInDirection('backward'))
                return (
                    this.event.preventDefault(),
                    (t = this.delegate) === null || t === void 0 || t.inputControllerWillPerformTyping(),
                    (e = this.responder) === null || e === void 0 || e.deleteInDirection('backward'),
                    this.render()
                );
        },
        Tab() {
            var i, t;
            if ((i = this.responder) !== null && i !== void 0 && i.canIncreaseNestingLevel())
                return (
                    this.event.preventDefault(),
                    (t = this.responder) === null || t === void 0 || t.increaseNestingLevel(),
                    this.render()
                );
        },
        'Tab+Shift'() {
            var i, t;
            if ((i = this.responder) !== null && i !== void 0 && i.canDecreaseNestingLevel())
                return (
                    this.event.preventDefault(),
                    (t = this.responder) === null || t === void 0 || t.decreaseNestingLevel(),
                    this.render()
                );
        },
    }),
            ...
            return (
                ...
                this.withTargetDOMRange(function () {
                    ...
                    this.deleteByDragRange =
                        (i = this.responder) === null || i === void 0 ? void 0 : i.getSelectedRange();
                })
            );
        },
        ...
        insertFromPaste() {
            ...
            if (e) {
                ...
                (c = u ? xi(u).trim() : e),
                    ...
                    (r = this.delegate) === null || r === void 0 || r.inputControllerWillPaste(t),
                    this.withTargetDOMRange(function () {
                        var d;
                ...
                (t.type = 'text/plain'),
                    ...
                    (o = this.delegate) === null || o === void 0 || o.inputControllerWillPaste(t),
                    this.withTargetDOMRange(function () {
                        var c;
                ...
                (t.type = 'File'),
                    (t.file = i.files[0]),
                    (s = this.delegate) === null || s === void 0 || s.inputControllerWillPaste(t),
                    this.withTargetDOMRange(function () {
                        var c;
                ...
                this.event.preventDefault(),
                    (t.type = 'text/html'),
                    (t.html = n),
                    (l = this.delegate) === null || l === void 0 || l.inputControllerWillPaste(t),
                    this.withTargetDOMRange(function () {
                        var c;
...
`);
        ...
        insertParagraph() {
            var i;
            return (
                (i = this.delegate) === null || i === void 0 || i.inputControllerWillPerformTyping(),
                this.withTargetDOMRange(function () {
                    var t;
        ...
        insertText() {
            ...
            return this.insertString(
                this.event.data ||
                    ((i = this.event.dataTransfer) === null || i === void 0 ? void 0 : i.getData('text/plain'))
            );
        },
        insertTranspose() {
            return this.insertString(this.event.data);
        ...
        return (
            ...
            !(e => {
                ...
                return (
                    ...
                    n.getData('text/html').includes('urn:schemas-microsoft-com:office:office')
                );
            })(i)
        );
    },
    ...
    sn = class extends R {
        constructor(t) {
            super(t),
                ...
                S('click', { onElement: this.element, matchingSelector: Xs, preventDefault: !0 }),
                S('click', { onElement: this.element, matchingSelector: Qs, withCallback: this.didClickDialogButton }),
                S('keydown', {
                    onElement: this.element,
                    matchingSelector: kr,
        ...
        didClickAttributeButton(t, e) {
            ...
            return (
                this.getDialog(r)
                    ? this.toggleDialog(r)
                    : (o = this.delegate) === null || o === void 0 || o.toolbarDidToggleAttribute(r),
            ...
            return this.eachAttributeButton(
                (t, e) => (
                    ...
                    this.attributes[e] || this.dialogIsVisible(e)
                        ? (t.setAttribute('data-trix-active', ''), t.classList.add('trix-active'))
                        : (t.removeAttribute('data-trix-active'), t.classList.remove('trix-active'))
                )
            );
        }
        ...
        setAttribute(t) {
            ...
            let n = Ut(t),
                r = Rr(t, n);
            return !r.willValidate || (r.setCustomValidity(''), r.checkValidity() && this.isSafeAttribute(r))
                ? ((e = this.delegate) === null || e === void 0 || e.toolbarDidUpdateAttribute(n, r.value),
                  this.hideDialog())
            ...
            if (t)
                return (
                    ...
                    (e = this.delegate) === null || e === void 0
                        ? void 0
                        : e.toolbarDidHideDialog((n => n.getAttribute('data-trix-dialog'))(t))
                );
        }
        resetDialogInputs() {
    ...
    Lt = class extends nn {
        constructor(t) {
            ...
            super(...arguments),
                ...
                (this.attachmentManager = new Ge(this.composition.getAttachments())),
                (this.attachmentManager.delegate = this),
                (this.inputController = bi.getLevel() === 2 ? new wt(this.editorElement) : new Y(this.editorElement)),
                (this.inputController.delegate = this),
                (this.inputController.responder = this.composition),
                (this.compositionController = new en(this.editorElement, this.composition)),
                (this.compositionController.delegate = this),
                (this.toolbarController = new sn(this.editorElement.toolbarElement)),
                (this.toolbarController.delegate = this),
                (this.editor = new Xe(this.composition, this.selectionManager, this.editorElement)),
        ...
        toolbarDidHideDialog(t) {
            return (
                ...
                this.notifyEditorElement('toolbar-dialog-hide', { dialogName: t })
            );
        }
        freezeSelection() {
        ...
        invokeAction(t, e) {
            return this.actionIsExternal(t)
                ? this.notifyEditorElement('action-invoke', { actionName: t, invokingElement: e })
                : (n = this.actions[t]) === null || n === void 0 || (n = n.perform) === null || n === void 0
                  ? void 0
                  : n.call(this);
            var n;
        }
        ...
        updateCurrentActions() {
            ...
            if (!Xt(t, this.currentActions))
                return (
                    ...
                    this.notifyEditorElement('actions-change', { actions: this.currentActions })
                );
        }
        runEditorFilters() {
            ...
            if (
                ...
                !We(e.selectedRange, n.selectedRange) || !e.document.isEqualTo(n.document))
            )
            ...
            switch (t) {
                ...
                case 'render':
                    this.documentChangedSinceLastRender &&
                        ((this.documentChangedSinceLastRender = !1), this.notifyEditorElement('change'));
                    break;
                case 'change':
                case 'attachment-add':
        ...
        removeAttachment(t) {
            return (
                this.editor.recordUndoEntry('Delete Attachment'), this.composition.removeAttachment(t), this.render()
            );
        }
        ...
        isFocused() {
            ...
            return (
                this.editorElement ===
                ((t = this.editorElement.ownerDocument) === null || t === void 0 ? void 0 : t.activeElement)
            );
        }
        isFocusedInvisibly() {
...
var an = class extends HTMLElement {
    ...
    sa = function (i) {
        var t, e;
        if ((t = (e = document).queryCommandSupported) !== null && t !== void 0 && t.call(e, 'enableObjectResizing'))
            return (
...
var Kn = new WeakMap(),
    ...
    gi = class {
        ...
        get labels() {
            ...
            this.element.id &&
                ...
                t.push(
                    ...Array.from(
                        this.element.ownerDocument.querySelectorAll("label[for='".concat(this.element.id, "']")) || []
                    )
                );
        ...
        get willValidate() {
            return (
                console.warn('This browser does not support the willValidate property for trix-editor elements.'), !1
            );
        }
        setFormValue(t) {}
        checkValidity() {
    ...
    ye = class extends HTMLElement {
        ...
        connectedCallback() {
            this.hasAttribute('data-trix-internal') ||
                ...
                this.editorController ||
                    ...
                    (this.editorController = new Lt({ editorElement: this, html: (this.defaultValue = this.value) })),
                    requestAnimationFrame(() => he('trix-initialize', { onElement: this }))),
        ...
        disconnectedCallback() {
            var t;
            (t = this.editorController) === null || t === void 0 || t.unregisterSelectionManager(),
...
Object.assign(Z, Xr),
    (window.Trix = Z),
    setTimeout(function () {
        customElements.get('trix-toolbar') || customElements.define('trix-toolbar', an),
            customElements.get('trix-editor') || customElements.define('trix-editor', ye);
    }, 0);
            ...
            (this.$refs.trixValue.value = this.state),
                ...
                this.$watch('state', () => {
                    document.activeElement !== this.$refs.trix &&
                        ((this.$refs.trixValue.value = this.state), this.$refs.trix.editor?.loadHTML(this.state ?? ''));
                });
        },
    };
}
