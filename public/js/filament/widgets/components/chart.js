...
var Eo = (i, t) => (typeof i == 'string' && i.endsWith('%') ? parseFloat(i) / 100 : i / t),
    En = (i, t) => (typeof i == 'string' && i.endsWith('%') ? (parseFloat(i) / 100) * t : +i);
function $(i, t, e) {
...
function V(i, t, e, s) {
    ...
    else if (F(i)) for (o = Object.keys(i), r = o.length, n = 0; n < r; n++) t.call(e, i[o[n]], o[n]);
}
function _i(i, t) {
    let e, s, n, r;
    if (!i || !t || i.length !== t.length) return !1;
    for (e = 0, s = i.length; e < s; ++e)
        if (((n = i[e]), (r = t[e]), n.datasetIndex !== r.datasetIndex || n.index !== r.index)) return !1;
    return !0;
}
function Ss(i) {
...
function Ec(i, t, e) {
    ...
    let s = t[i],
        n = e[i];
    F(s) && F(n) ? Le(s, n) : Object.prototype.hasOwnProperty.call(t, i) || (t[i] = Ss(n));
}
...
var Es = i => (i === 'start' ? 'left' : i === 'end' ? 'right' : 'center'),
    ...
    Vo = (i, t, e, s) => (i === (s ? 'left' : 'right') ? e : i === 'center' ? (t + e) / 2 : t);
function zn(i, t, e) {
    let s = t.length,
        n = 0,
        r = s;
    if (i._sorted) {
        ...
        u && (n = tt(Math.min(Ct(a, o.axis, c).lo, e ? s : Ct(t, l, o.getPixelForValue(c)).lo), 0, s - 1)),
            d
                ? (r =
                      tt(
                          Math.max(Ct(a, o.axis, h, !0).hi + 1, e ? 0 : Ct(t, l, o.getPixelForValue(h), !0).hi + 1),
                          n,
                          s
                      ) - n)
                : (r = s - n);
...
function Vn(i) {
    ...
    let r = s.xmin !== t.min || s.xmax !== t.max || s.ymin !== e.min || s.ymax !== e.max;
    return Object.assign(s, n), r;
}
var ys = i => i === 0 || i === 1,
    po = (i, t, e) => -(Math.pow(2, 10 * (i -= 1)) * Math.sin(((i - t) * H) / e)),
    ...
    Ie = {
        ...
        easeInOutExpo: i =>
            ys(i) ? i : i < 0.5 ? 0.5 * Math.pow(2, 10 * (i * 2 - 1)) : 0.5 * (-Math.pow(2, -10 * (i * 2 - 1)) + 2),
        ...
        easeInOutElastic(i) {
            return ys(i) ? i : i < 0.5 ? 0.5 * po(i * 2, 0.1125, 0.45) : 0.5 + 0.5 * yo(i * 2 - 1, 0.1125, 0.45);
        },
        easeInBack(i) {
...
var Hc = /^(hsla?|hwb|hsv)\(\s*([-+.e\d]+)(?:deg)?[\s,]+([-+.e\d]+)%[\s,]+([-+.e\d]+)%(?:[\s,]+([-+.e\d]+)(%)?)?\s*\)$/;
function Ho(i, t, e) {
    let s = t * Math.min(e, 1 - e),
        n = (r, o = (r + i / 30) % 12) => e - s * Math.max(Math.min(o - 3, 9 - o, 1), -1);
    return [n(0), n(8), n(4)];
}
function Bc(i, t, e) {
    let s = (n, r = (n + i / 60) % 6) => e - e * t * Math.max(Math.min(r, 4 - r, 1), 0);
    return [s(5), s(3), s(1)];
}
function $c(i, t, e) {
    let s = Ho(i, 1, 0.5),
...
function Hn(i) {
    ...
    return (
        r !== o &&
            ((h = r - o), (c = a > 0.5 ? h / (2 - r - o) : h / (r + o)), (l = jc(e, s, n, h, r)), (l = l * 60 + 0.5)),
        [l | 0, c || 0, a]
    );
}
function Bn(i, t, e, s) {
...
function Zc(i) {
    ...
    let n = Bo(+t[2]),
        ...
        o = +t[4] / 100;
    return (
        t[1] === 'hwb' ? (s = Uc(n, r, o)) : t[1] === 'hsv' ? (s = Yc(n, r, o)) : (s = $n(n, r, o)),
        { r: s[0], g: s[1], b: s[2], a: e }
    );
}
function qc(i, t) {
    var e = Hn(i);
    (e[0] = Bo(e[0] + t)), (e = $n(e)), (i.r = e[0]), (i.g = e[1]), (i.b = e[2]);
}
function Gc(i) {
    if (!i) return;
    let t = Hn(i),
...
function Xc() {
    ...
    for (s = 0; s < t.length; s++) {
        for (o = a = t[s], n = 0; n < e.length; n++) (r = e[n]), (a = a.replace(r, xo[r]));
        (r = parseInt(_o[o], 16)), (i[a] = [(r >> 16) & 255, (r >> 8) & 255, r & 255]);
    }
    return i;
}
var xs;
...
var Jc = /^rgba?\(\s*([-+.\d]+)(%)?[\s,]+([-+.e\d]+)(%)?[\s,]+([-+.e\d]+)(%)?(?:[\s,/]+([-+.e\d]+)(%)?)?\s*\)$/;
function Qc(i) {
    let t = Jc.exec(i),
        e = 255,
        s,
...
var Sn = i => (i <= 0.0031308 ? i * 12.92 : Math.pow(i, 1 / 2.4) * 1.055 - 0.055),
...
function wo(i) {
    ...
    return (
        Array.isArray(i)
            ? i.length >= 3 && ((t = { r: i[0], g: i[1], b: i[2], a: 255 }), i.length > 3 && (t.a = Xt(i[3])))
...
var On = class i {
    constructor(t) {
        ...
        let e = typeof t,
            s;
        e === 'object' ? (s = wo(t)) : e === 'string' && (s = Wc(t) || Kc(t) || ih(t)),
            (this._rgb = s),
            (this._valid = !!s);
    }
    get valid() {
...
function Yo(i, t, e, s) {
    ...
    for (l = 0; l < a; l++)
        ...
        else if (B(u)) for (c = 0, h = u.length; c < h; c++) (d = u[c]), d != null && !B(d) && (o = xi(i, n, r, o, d));
    i.restore();
    let f = r.length / 2;
    if (f > e.length) {
...
function Yn(i, t, e, s, n) {
    ...
    if (!(isNaN(f) || f <= 0)) {
        switch ((i.beginPath(), u)) {
            default:
                n ? i.ellipse(e, s, n / 2, f, 0, 0, H) : i.arc(e, s, f, 0, H), i.closePath();
                break;
            case 'triangle':
            ...
            case 'line':
                ...
                break;
            case 'dash':
                i.moveTo(e, s), i.lineTo(e + Math.cos(m) * f, s + Math.sin(m) * f);
                break;
        }
...
function Re(i, t) {
    ...
    i.arc(e + o.topLeft, s + o.topLeft, o.topLeft, -U, j, !0),
        ...
        i.arc(e + n - o.bottomRight, s + r - o.bottomRight, o.bottomRight, U, 0, !0),
...
var oh = new RegExp(/^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/),
    ah = new RegExp(/^(normal|italic|initial|inherit|unset|(oblique( -?[0-9]?[0-9]deg)?))$/);
function lh(i, t) {
    let e = ('' + i).match(oh);
...
function Q(i, t) {
    ...
    s && !('' + s).match(ah) && (console.warn('Invalid font style specified: "' + s + '"'), (s = ''));
    let n = {
...
var hh = (i, t) => (i ? i + vs(t) : t),
    Gn = (i, t) => F(t) && i !== 'adapters' && (Object.getPrototypeOf(t) === null || t.constructor === Object);
function Xo(i, t, e) {
...
function dh(i, t, e, s) {
    ...
    return a.add(i), (t = t(r, o || s)), a.delete(i), Gn(i, t) && (t = Xn(n._scopes, n, i, t)), t;
}
function fh(i, t, e, s) {
...
function Xn(i, t, e, s) {
    ...
    return l === null || (dt(r) && r !== e && ((l = So(a, o, r, l, s)), l === null))
        ? !1
...
function yh(i, t, e, s) {
    let n;
    for (let r of t) if (((n = Jo(hh(r, i), e)), dt(n))) return Gn(i, n) ? Xn(e, s, i, n) : n;
}
function Jo(i, t) {
    for (let e of t) {
        if (!e) continue;
...
function Kn(i, t, e, s) {
    let { iScale: n } = i,
        ...
        c,
        h;
    for (a = 0, l = s; a < l; ++a) (c = a + e), (h = t[c]), (o[a] = { r: n.parse(Vt(h, r), c) });
    return o;
}
    ...
    for (let h = 0; h < s - 1; ++h)
        if (((l = c), (c = Ae(i, h + 1)), !(!l || !c))) {
            ...
            (n = e[h] / t[h]),
                ...
                !(a <= 9) && ((o = 3 / Math.sqrt(a)), (e[h] = n * o * t[h]), (e[h + 1] = r * o * t[h]));
        }
}
function Sh(i, t, e = 'x') {
    let s = Qo(e),
    ...
    for (let c = 0; c < n; ++c) {
        ...
        let h = a[e],
            u = a[s];
        o && ((r = (h - o[e]) / 3), (a[`cp1${e}`] = h - r), (a[`cp1${s}`] = u - r * t[c])),
            l && ((r = (l[e] - h) / 3), (a[`cp2${e}`] = h + r), (a[`cp2${s}`] = u + r * t[c]));
    }
}
function kh(i, t = 'x') {
    let e = Qo(t),
    ...
    for (o = 0; o < s; ++o)
        if (((a = l), (l = c), (c = Ae(i, o + 1)), !!l)) {
            ...
            r[o] = a ? (c ? (Mt(n[o - 1]) !== Mt(n[o]) ? 0 : (n[o - 1] + n[o]) / 2) : n[o - 1]) : n[o];
        }
    wh(i, n, r), Sh(i, r, t);
}
function ws(i, t, e) {
...
function Mh(i, t) {
    ...
    for (e = 0, s = i.length; e < s; ++e)
        (o = r),
            ...
            r &&
                ((n = i[e]),
                o && ((n.cp1x = ws(n.cp1x, t.left, t.right)), (n.cp1y = ws(n.cp1y, t.top, t.bottom))),
                a && ((n.cp2x = ws(n.cp2x, t.left, t.right)), (n.cp2y = ws(n.cp2y, t.top, t.bottom))));
}
function ta(i, t, e, s, n) {
    let r, o, a, l;
    if ((t.spanGaps && (i = i.filter(c => !c.skip)), t.cubicInterpolationMode === 'monotone')) kh(i, n);
    else {
        let c = s ? i[i.length - 1] : i[0];
        for (r = 0, o = i.length; r < o; ++r)
            (a = i[r]),
                (l = _h(c, a, i[Math.min(r + 1, o - (s ? 0 : 1)) % o], t.tension)),
                (a.cp1x = l.previous.x),
                (a.cp1y = l.previous.y),
                (a.cp2x = l.next.x),
                (a.cp2y = l.next.y),
...
function ee(i, t) {
    ...
    return (
        ...
        { x: Math.round((((l - u) / f) * e.width) / s), y: Math.round((((c - d) / m) * e.height) / s) }
    );
}
function Eh(i, t, e) {
    let s, n;
...
function Qn(i, t, e) {
    ...
    return (
        o.style &&
            ...
            ((o.style.height = `${i.height}px`), (o.style.width = `${i.width}px`)),
        i.currentDevicePixelRatio !== s || o.height !== n || o.width !== r
            ? ((i.currentDevicePixelRatio = s), (o.height = n), (o.width = r), i.ctx.setTransform(s, 0, 0, s, 0, 0), !0)
            : !1
    );
}
var ia = (function () {
...
function Ah(i, t, e) {
    let { property: s, start: n, end: r } = e,
        ...
        f;
    if (u) {
        for (c += l, h += l, d = 0, f = l; d < f && o(a(t[c % l][s]), n, r); ++d) c--, h--;
        (c %= l), (h %= l);
    }
        ...
        (b = t[v % o]),
            !b.skip &&
                ...
                y !== _ &&
                    ...
                    p !== null && k() && (m.push(To({ start: p, end: v, loop: d, count: o, style: f })), (p = null)),
                    (T = v),
                    (_ = y)));
    return p !== null && m.push(To({ start: p, end: u, loop: d, count: o, style: f })), m;
}
function nr(i, t) {
    let e = [],
        s = i.segments;
...
function Ph(i, t, e, s) {
    ...
    for (l = t + 1; l <= e; ++l) {
        let c = i[l % n];
        c.skip || c.stop
            ? a.skip || ((s = !1), r.push({ start: t % n, end: (l - 1) % n, loop: s }), (t = o = c.stop ? l : null))
            : ((o = l), a.skip && (t = l)),
            (a = c);
    }
...
function Nh(i, t, e, s) {
    ...
    function f(m, g, p, y) {
        ...
        if (m !== g) {
            ...
            for (; e[g % l].skip; ) g += b;
            m % l !== g % l && (c.push({ start: m % l, end: g % l, loop: p, style: y }), (h = y), (u = g % l));
        }
    }
    for (let m of t) {
        u = a ? u : m.start;
...
var mr = class {
        ...
        _notify(t, e, s, n) {
            let r = e.listeners[n],
                o = e.duration;
            r.forEach(a => a({ chart: t, initial: e.initial, numSteps: o, currentStep: Math.min(s - e.start, o) }));
        }
        _refresh() {
            this._request ||
                ((this._running = !0),
        ...
        _update(t = Date.now()) {
            ...
            this._charts.forEach((s, n) => {
                ...
                a && (n.draw(), this._notify(n, s, t, 'progress')),
                    r.length || ((s.running = !1), this._notify(n, s, t, 'complete'), (s.initial = !1)),
                    (e += r.length);
            }),
                (this._lastDate = t),
                e === 0 && (this._running = !1);
...
A.set('animations', { colors: { type: 'color', properties: Vh }, numbers: { type: 'number', properties: zh } });
...
function Uh(i) {
    let t, e, s, n;
    return (
        F(i) ? ((t = i.top), (e = i.right), (s = i.bottom), (n = i.left)) : (t = e = s = n = i),
...
function ca(i, t, e, s = {}) {
    ...
    if (t !== null) {
        for (o = 0, a = n.length; o < a; ++o) {
            ...
            (c = i.values[l]), q(c) && (r || t === 0 || Mt(t) === Mt(c)) && (t += c);
        }
        return t;
    }
}
...
function da(i, t) {
    ...
    for (let f = 0; f < u; ++f) {
        ...
        (d = y[c] = Gh(n, h, g)), (d[a] = p), (d._top = ua(d, o, !0, s.type)), (d._bottom = ua(d, o, !1, s.type));
    }
}
function rr(i, t) {
    let e = i.scales;
...
var or = i => i === 'reset' || i === 'none',
    ...
    Jh = (i, t, e) => i && !t.hidden && t._stacked && { keys: Ja(e, !0), values: null },
    gt = class {
        constructor(t, e) {
            (this.chart = t),
                (this._ctx = t.ctx),
        ...
        initialize() {
            ...
            this.configure(), this.linkScales(), (t._stacked = ha(t.vScale, t)), this.addElements();
        }
        updateIndex(t) {
        ...
        parsePrimitiveData(t, e, s, n) {
            let { iScale: r, vScale: o } = t,
                ...
                f,
                m;
            for (d = 0, f = n; d < f; ++d) (m = d + s), (u[d] = { [a]: h || r.parse(c[m], m), [l]: o.parse(e[m], m) });
            return u;
        }
        parseArrayData(t, e, s, n) {
            let { xScale: r, yScale: o } = t,
                ...
                u;
            for (l = 0, c = n; l < c; ++l)
                (h = l + s), (u = e[h]), (a[l] = { x: r.parse(u[0], h), y: o.parse(u[1], h) });
            return a;
        }
        parseObjectData(t, e, s, n) {
            let { xScale: r, yScale: o } = t,
                ...
                f;
            for (h = 0, u = n; h < u; ++h)
                (d = h + s), (f = e[d]), (c[h] = { x: r.parse(Vt(f, a), d), y: o.parse(Vt(f, l), d) });
            return c;
        }
        getParsed(t) {
        ...
        getMinMax(t, e) {
            ...
            for (d = 0; d < o && !(!m() && (this.updateRangeFromParsed(c, t, f, l), r)); ++d);
            if (r) {
                for (d = o - 1; d >= 0; --d)
                    if (!m()) {
        ...
        getAllParsedValues(t) {
            let e = this._cachedMeta._parsed,
                ...
                r,
                o;
            for (n = 0, r = e.length; n < r; ++n) (o = e[n][t.axis]), q(o) && s.push(o);
            return s;
        }
        getMaxOverflow() {
            return !1;
        ...
        _update(t) {
            ...
            this.update(t || 'default'),
                (e._clip = Uh(E(this.options.clip, jh(e.xScale, e.yScale, this.getMaxOverflow()))));
        }
        update(t) {}
        draw() {
            let t = this._ctx,
        ...
        getContext(t, e, s) {
            ...
            if (t >= 0 && t < this._cachedMeta.data.length) {
                ...
                (r = this.$context || (this.$context = Xh(this.chart.getContext(), this.index))),
                    (r.dataset = n),
        ...
        _resolveElementOptions(t, e = 'default', s) {
            ...
            return g.$shared && ((g.$shared = l), (r[o] = Object.freeze(fa(g, l)))), g;
        }
        ...
        _getSharedOptions(t, e) {
            ...
            return this.updateSharedOptions(r, e, s), { sharedOptions: r, includeOptions: o };
        }
        updateElement(t, e, s, n) {
            or(n) ? Object.assign(t, s) : this._resolveAnimations(e, n).update(t, s);
        }
        ...
        _setStyle(t, e, s, n) {
            ...
            this._resolveAnimations(e, s, n).update(t, { options: (!n && this.getSharedOptions(r)) || r });
        }
...
function Qh(i, t) {
    if (!i._cache.$bar) {
        let e = i.getMatchingVisibleMetas(t),
            s = [];
        for (let n = 0, r = e.length; n < r; n++) s = s.concat(e[n].controller.getAllParsedValues(i));
...
function tu(i) {
    let t = i.iScale,
        ...
        a,
        l = () => {
            o === 32767 || o === -32768 || (dt(a) && (s = Math.min(s, Math.abs(o - a) || s)), (a = o));
        };
    for (n = 0, r = e.length; n < r; ++n) (o = t.getPixelForValue(e[n])), l();
    for (a = void 0, n = 0, r = t.ticks.length; n < r; ++n) (o = t.getPixelForTick(n)), l();
    return s;
}
function eu(i, t, e, s) {
    let n = e.barThickness,
        ...
        o;
    return (
        P(n) ? ((r = t.min * e.categoryPercentage), (o = e.barPercentage)) : ((r = n * s), (o = 1)),
...
function iu(i, t, e, s) {
    ...
    return { chunk: ((Math.abs(a - o) / 2) * l) / s, ratio: e.barPercentage, start: c };
}
function su(i, t, e, s) {
    let n = e.parse(i[0], s),
        r = e.parse(i[1], s),
    ...
    Math.abs(o) > Math.abs(a) && ((l = a), (c = o)),
        (t[e.axis] = c),
        (t._custom = { barStart: l, barEnd: c, start: n, end: r, min: o, max: a });
}
function Qa(i, t, e, s) {
...
function ma(i, t, e, s) {
    let n = i.iScale,
        ...
        d;
    for (c = e, h = e + s; c < h; ++c)
        (d = t[c]), (u = {}), (u[n.axis] = a || n.parse(o[c], c)), l.push(Qa(d, u, r, c));
    return l;
}
function ar(i) {
...
function ou(i, t, e, s) {
    ...
    n === 'middle' &&
        ...
        (e._top || 0) === s ? (n = c) : (e._bottom || 0) === s ? (n = h) : ((r[ga(h, o, a, l)] = !0), (n = c))),
        (r[ga(n, o, a, l)] = !0),
        (i.borderSkipped = r);
}
function ga(i, t, e, s) {
...
var Be = class extends gt {
    ...
    parseObjectData(t, e, s, n) {
        let { iScale: r, vScale: o } = t,
            ...
            g;
        for (d = s, f = s + n; d < f; ++d)
            (g = e[d]), (m = {}), (m[r.axis] = r.parse(Vt(g, c), d)), u.push(Qa(Vt(g, h), m, o, d));
        return u;
    }
    updateRangeFromParsed(t, e, s, n) {
    ...
    getLabelAndValue(t) {
        let e = this._cachedMeta,
            ...
            r = this.getParsed(t),
            o = r._custom,
            a = ar(o) ? '[' + o.start + ', ' + o.end + ']' : '' + n.getLabelForValue(r[n.axis]);
    ...
    updateElements(t, e, s, n) {
        ...
        for (let f = e; f < e + s; f++) {
            let m = this.getParsed(f),
                g = r || P(m[a.axis]) ? { base: l, head: l } : this._calculateBarValuePixels(f),
                p = this._calculateBarIndexPixels(f, h),
                y = (m._stacks || {})[a.axis],
                b = {
                    horizontal: c,
                    base: g.base,
                    enableBorderRadius: !y || ar(m._custom) || o === y._top || o === y._bottom,
                    x: c ? g.head : p.center,
                    y: c ? p.center : g.head,
                    height: c ? p.size : Math.abs(g.size),
                    width: c ? Math.abs(g.size) : p.size,
                };
            d && (b.options = u || this.resolveDataElementOptions(f, t[f].active ? 'active' : n));
    ...
    _getStacks(t, e) {
        ...
        for (let l of n)
            if (
                !(e !== void 0 && a(l)) &&
                ((r === !1 || o.indexOf(l.stack) === -1 || (r === void 0 && l.stack === void 0)) && o.push(l.stack),
                l.index === t)
            )
                break;
    ...
    _getRuler() {
        let t = this.options,
            ...
            r,
            o;
        for (r = 0, o = e.data.length; r < o; ++r) n.push(s.getPixelForValue(this.getParsed(r)[s.axis], r));
    ...
    _calculateBarValuePixels(t) {
        ...
        d !== h && ((u = d - h), (d = h)),
            c &&
                ((h = l.barStart), (d = l.barEnd - l.barStart), h !== 0 && Mt(h) !== Mt(l.barEnd) && (u = 0), (u += h));
        let g = !P(n) && !c ? n : u,
            p = e.getPixelForValue(g);
        if (
            (this.chart.getDataVisibility(t) ? (f = e.getPixelForValue(u + d)) : (f = p), (m = f - p), Math.abs(m) < r)
        ) {
    ...
    _calculateBarIndexPixels(t, e) {
        ...
        if (e.grouped) {
            let c = r ? this._getStackCount(t) : e.stackCount,
                ...
                u = this._getStackIndex(this.index, this._cachedMeta.stack, r ? t : void 0);
            (a = h.start + h.chunk * u + h.chunk / 2), (l = Math.min(o, h.chunk * h.ratio));
        } else (a = s.getPixelForValue(this.getParsed(t)[s.axis], t)), (l = Math.min(o, e.min * e.ratio));
    ...
    draw() {
        let t = this._cachedMeta,
            ...
            n = s.length,
            r = 0;
        for (; r < n; ++r) this.getParsed(r)[e.axis] !== null && s[r].draw(this._ctx);
    }
};
Be.id = 'bar';
Be.defaults = {
...
var $e = class extends gt {
    ...
    parsePrimitiveData(t, e, s, n) {
        ...
        for (let o = 0; o < r.length; o++) r[o]._custom = this.resolveDataElementOptions(o + s).radius;
        return r;
    }
    parseArrayData(t, e, s, n) {
    ...
    parseObjectData(t, e, s, n) {
        ...
        for (let o = 0; o < r.length; o++) {
            let a = e[s + o];
            r[o]._custom = E(a && a.r && +a.r, this.resolveDataElementOptions(o + s).radius);
        }
        return r;
    }
    getMaxOverflow() {
    ...
    getLabelAndValue(t) {
        let e = this._cachedMeta,
            ...
            l = r._custom;
        return { label: e.label, value: '(' + o + ', ' + a + (l ? ', ' + l : '') + ')' };
    }
    update(t) {
    ...
    updateElements(t, e, s, n) {
        ...
        for (let d = e; d < e + s; d++) {
            let f = t[d],
                ...
                g = {},
                p = (g[h] = r ? o.getPixelForDecimal(0.5) : o.getPixelForValue(m[h])),
    ...
    resolveDataElementOptions(t, e) {
        ...
        let r = n.radius;
        return e !== 'active' && (n.radius = 0), (n.radius += E(s && s._custom, r)), n;
    }
};
$e.id = 'bubble';
$e.defaults = {
...
function cu(i, t, e) {
    ...
    if (t < H) {
        let a = i,
            ...
            u = Math.cos(l),
            d = Math.sin(l),
            f = (_, w, x) => (Ne(_, a, l, !0) ? 1 : Math.max(w, w * e, x, x * e)),
            m = (_, w, x) => (Ne(_, a, l, !0) ? -1 : Math.min(w, w * e, x, x * e)),
            g = f(0, c, u),
            p = f(U, h, d),
            y = m(j, c, u),
            b = m(j + U, h, d);
        (s = (g - y) / 2), (n = (p - b) / 2), (r = -(g + y) / 2), (o = -(p + b) / 2);
    }
...
var ne = class extends gt {
    ...
    updateElements(t, e, s, n) {
        ...
        for (b = e; b < e + s; ++b) {
            ...
            p && (x.options = g || this.resolveDataElementOptions(b, w.active ? 'active' : n)),
                (y += _),
...
ne.descriptors = { _scriptable: i => i !== 'spacing', _indexable: i => i !== 'spacing' };
ne.overrides = {
    aspectRatio: 1,
    plugins: {
        legend: {
    ...
    updateElements(t, e, s, n) {
        ...
        for (let _ = e; _ < e + s; ++_) {
            let w = t[_],
                ...
                T = (S[f] = r || k ? a.getBasePixel() : a.getPixelForValue(l ? this.applyStack(a, x, l) : x[f], _));
            (S.skip = isNaN(v) || isNaN(T) || k),
                (S.stop = _ > 0 && Math.abs(x[d] - b[d]) > p),
                g && ((S.parsed = x), (S.raw = c.data[_])),
                u && (S.options = h || this.resolveDataElementOptions(_, w.active ? 'active' : n)),
...
je.id = 'line';
je.defaults = { datasetElementType: 'line', dataElementType: 'point', showLine: !0, spanGaps: !1 };
je.overrides = { scales: { _index_: { type: 'category' }, _value_: { type: 'linear' } } };
    ...
    updateElements(t, e, s, n) {
        ...
        for (m = e; m < e + s; m++) {
            let p = t[m],
                ...
                _ = o.getDataVisibility(m) ? c.getDistanceFromCenterForValue(this.getParsed(m).r) : 0;
            (f = b), r && (l.animateScale && (_ = 0), l.animateRotate && (y = b = d));
            let w = {
                x: h,
                y: u,
                innerRadius: 0,
...
var tl = {
    ...
    logarithmic(i, t, e) {
        ...
        return s === 1 || s === 2 || s === 5 ? tl.numeric.call(this, i, t, e) : '';
    },
};
function hu(i, t) {
...
function uu(i, t) {
    ...
    if (r > 0) {
        ...
        for (Ns(t, l, c, P(d) ? 0 : o - d, o), h = 0, u = r - 1; h < u; h++) Ns(t, l, c, n[h], n[h + 1]);
...
function gu(i, t, e, s) {
    let n = 0,
        r = e[0],
        o;
    for (s = Math.ceil(s), o = 0; o < i.length; o++) o === r && (t.push(i[o]), n++, (r = e[n * s]));
}
function Ns(i, t, e, s, n) {
    ...
    for (c = Math.max(r, 0); c < o; c++) c === h && (t.push(i[c]), a++, (h = Math.round(r + a * e)));
}
function pu(i) {
    let t = i.length,
        e,
...
function ku(i, t, e, s) {
    ...
    if (i.isHorizontal()) {
        ...
        } else e === 'center' ? (m = (c.bottom + c.top) / 2 + g - t) : (m = ya(i, e, t));
        d = a - r;
    } else {
        if (F(e)) {
            let y = Object.keys(e)[0],
        ...
        } else e === 'center' ? (f = (c.left + c.right) / 2 - p + t) : (f = ya(i, e, t));
...
var be = class i extends pt {
        ...
        getMinMax(t) {
            let { min: e, max: s, minDefined: n, maxDefined: r } = this.getUserBounds(),
                o;
            ...
            return (e = r && e > s ? s : e), (s = n && e > s ? e : s), { min: ft(e, ft(s, e)), max: ft(s, ft(e, s)) };
        }
        getPadding() {
            return {
        ...
        update(t, e, s) {
            ...
            this._convertTicksToLabels(l ? ba(this.ticks, a) : this.ticks),
                ...
                o.display &&
                    ...
                    ((this.ticks = uu(this, this.ticks)), (this._labelSizes = null), this.afterAutoSkip()),
        ...
        generateTickLabels(t) {
            let e = this.options.ticks,
                ...
                n,
                r;
            for (s = 0, n = t.length; s < n; s++) (r = t[s]), (r.label = $(e.callback, [r.value, s, t], this));
        }
        ...
        calculateLabelRotation() {
            ...
            (a = t.offset ? this.maxWidth / s : f / (s - 1)),
                u + 6 > a &&
                    ...
                    (l = this.maxHeight - Ti(t.grid) - e.padding - xa(t.title, this.chart.options.font)),
                    (c = Math.sqrt(u * u + d * d)),
                    (o = Os(
                        Math.min(
                            Math.asin(tt((h.highest.height + 6) / a, -1, 1)),
                            Math.asin(tt(l / c, -1, 1)) - Math.asin(tt(d / c, -1, 1))
                        )
                    )),
        ...
        _calculatePadding(t, e, s, n) {
            ...
            if (this.isHorizontal()) {
                ...
                l
                    ...
                    (this.paddingLeft = Math.max(((d - h + o) * this.width) / (this.width - h), 0)),
                    (this.paddingRight = Math.max(((f - u + o) * this.width) / (this.width - u), 0));
            } else {
                let h = e.height / 2,
                    u = t.height / 2;
                r === 'start' ? ((h = 0), (u = t.height)) : r === 'end' && ((h = e.height), (u = 0)),
                    (this.paddingTop = h + o),
        ...
        _convertTicksToLabels(t) {
            ...
            let e, s;
            for (e = 0, s = t.length; e < s; e++) P(t[e].label) && (t.splice(e, 1), s--, e--);
        ...
        _getLabelSizes() {
            ...
            if (!t) {
                let e = this.options.ticks.sampleSize,
                    s = this.ticks;
                e < s.length && (s = ba(s, e)), (this._labelSizes = t = this._computeLabelSizes(s, s.length));
            }
            return t;
        }
        _computeLabelSizes(t, e) {
            ...
            for (c = 0; c < e; ++c) {
                if (
                    ...
                    for (h = 0, u = d.length; h < u; ++h)
                        (_ = d[h]), !P(_) && !B(_) && ((y = xi(s, g.data, g.gc, y, _)), (b += p));
            ...
            return { first: S(0), last: S(e - 1), widest: S(w), highest: S(x), widths: r, heights: o };
        }
        getLabelForValue(t) {
            return t;
        }
        ...
        getContext(t) {
            ...
            return this.$context || (this.$context = _u(this.chart.getContext(), this));
        }
        _tickSize() {
        ...
        _computeGridLineItems(t) {
            let e = this.axis,
                ...
                L;
            if (o === 'top')
                (y = p(this.bottom)), (S = this.bottom - u), (v = y - g), (C = p(t.top) + g), (L = t.bottom);
            else if (o === 'bottom')
                (y = p(this.top)), (C = t.top), (L = p(t.bottom) - g), (S = y + g), (v = this.top + u);
            else if (o === 'left')
                (y = p(this.right)), (x = this.right - u), (k = y - g), (T = p(t.left) + g), (N = t.right);
            else if (o === 'right')
                (y = p(this.left)), (T = t.left), (N = p(t.right) - g), (x = y + g), (k = this.left + u);
            else if (e === 'x') {
        ...
        _computeLabelItems(t) {
            let e = this.axis,
                ...
                L,
                K = 'middle';
            if (n === 'top') (S = this.bottom - m), (k = this._getXAxisLabelAlignment());
            else if (n === 'bottom') (S = this.top + m), (k = this._getXAxisLabelAlignment());
            else if (n === 'left') {
            ...
            for (y = 0, b = a.length; y < b; ++y) {
                ...
                if (D.showLabelBackdrop) {
                    ...
                    ps = { left: wn, top: _n, width: xn + De.width, height: gi + De.height, color: D.backdropColor };
                }
                p.push({
                    rotation: g,
                    label: w,
        ...
        drawBorder() {
            ...
            let o = s.setContext(this.getContext(0)).lineWidth,
                ...
                u;
            this.isHorizontal()
                ? ((l = Jt(t, this.left, r) - r / 2), (c = Jt(t, this.right, o) + o / 2), (h = u = a))
                : ((h = Jt(t, this.top, r) - r / 2), (u = Jt(t, this.bottom, o) + o / 2), (l = c = a)),
                e.save(),
        ...
        drawLabels(t) {
            ...
            n && Si(s, n);
            let r = this._labelItems || (this._labelItems = this._computeLabelItems(t)),
                o,
                a;
        ...
        drawTitle() {
            ...
            e === 'bottom' || e === 'center' || F(e)
                ? ((l += o.bottom), B(s.text) && (l += r.lineHeight * (s.text.length - 1)))
                : (l += o.top);
            let { titleX: c, titleY: h, maxWidth: u, rotation: d } = ku(this, l, e, a);
            Qt(t, s.text, 0, 0, r, {
                color: s.color,
                maxWidth: u,
                rotation: d,
    ...
    He = class {
        ...
        register(t) {
            ...
            return r in n || ((n[r] = t), Mu(t, o, s), this.override && A.override(t.id, t.overrides)), o;
        }
        get(t) {
            return this.items[t];
        }
        unregister(t) {
            let e = this.items,
                s = t.id,
                n = this.scope;
            s in e && delete e[s], n && s in A[n] && (delete A[n][s], this.override && delete Kt[s]);
        }
    };
function Mu(i, t, e) {
    let s = Ce(Object.create(null), [e ? A.get(e) : {}, A.get(t), i.defaults]);
    A.set(t, s), i.defaultRoutes && Tu(t, i.defaultRoutes), i.descriptors && A.describe(t, i.descriptors);
}
function Tu(i, t) {
        ...
        update(t) {
            ...
            if (
                ...
                (a._chart = this.chart),
                    ...
                    (a.points = s);
                let c = this.resolveDatasetElementOptions(t);
                (c.segment = this.options.segment), this.updateElement(a, void 0, { animated: !n, options: c }, t);
            }
            this.updateElements(s, r, o, t);
        }
        addElements() {
            let { showLine: t } = this.options;
            !this.datasetElementType && t && (this.datasetElementType = Pt.getElement('line')), super.addElements();
        }
        updateElements(t, e, s, n) {
            let r = n === 'reset',
                { iScale: o, vScale: a, _stacked: l, _dataset: c } = this._cachedMeta,
            ...
            for (let w = e; w < e + s; ++w) {
                let x = t[w],
                    ...
                    C = (k[m] = r || v ? a.getBasePixel() : a.getPixelForValue(l ? this.applyStack(a, S, l) : S[m], w));
                (k.skip = isNaN(T) || isNaN(C) || v),
                    (k.stop = w > 0 && Math.abs(S[f] - _[f]) > y),
                    p && ((k.parsed = S), (k.raw = c.data[w])),
                    d && (k.options = u || this.resolveDataElementOptions(w, x.active ? 'active' : n)),
...
Ze.id = 'scatter';
Ze.defaults = { datasetElementType: !1, dataElementType: 'point', showLine: !1, fill: !1 };
Ze.overrides = {
            ...
            zi(
                ...
                function (a, l, c) {
                    (!n && !Fe(a, i.chartArea, 0)) ||
                        (a.inRange(t.x, t.y, s) && r.push({ element: a, datasetIndex: l, index: c }));
                },
                !0
            ),
        r
...
function Iu(i, t, e, s) {
    let n = [];
    function r(o, a, l) {
        let { startAngle: c, endAngle: h } = o.getProps(['startAngle', 'endAngle'], s),
...
function cr(i, t, e, s, n, r) {
    return !r && !i.isPointInArea(t) ? [] : e === 'r' && !s ? Iu(i, t, e, n) : Cu(i, t, e, s, n, r);
}
function _a(i, t, e, s, n) {
    ...
    return (
        zi(i, e, t, (l, c, h) => {
            l[o](t[e], n) && (r.push({ element: l, datasetIndex: c, index: h }), (a = a || l.inRange(t.x, t.y, n)));
        }),
        s && !a ? [] : r
    );
}
...
function Ei(i, t, e, s) {
    ...
    for (r = 0, o = i.length, c = 0; r < o; ++r) {
        (a = i[r]), (l = a.box), l.update(a.width || t.w, a.height || t.h, zu(a.horizontal, t));
    ...
    for (let a of i) {
        ...
        if (a.horizontal) {
            ...
            dt(c.start) && (o = c.start),
                l.fullSize ? Rs(l, n.left, o, e.outerWidth - n.right - n.left, d) : Rs(l, t.left + c.placed, o, u, d),
                (c.start = o),
                (c.placed += u),
                (o = l.bottom);
        } else {
            ...
            dt(c.start) && (r = c.start),
                l.fullSize ? Rs(l, r, n.top, d, e.outerHeight - n.bottom - n.top) : Rs(l, r, t.top + c.placed, d, u),
                (c.start = r),
                (c.placed += u),
                (r = l.right);
        }
...
var ot = {
        ...
        update(i, t, e, s) {
            ...
            let h = l.reduce((g, p) => (p.box.options && p.box.options.display === !1 ? g : g + 1), 0) || 1,
                u = Object.freeze({
                    outerWidth: t,
                    outerHeight: e,
                    padding: n,
                ...
                d = Object.assign({}, n);
            il(d, rt(s));
            let f = Object.assign({ maxPadding: d, w: r, h: o, x: n.left, y: n.top }, n),
                m = Pu(l.concat(c), u);
            Ei(a.fullSize, f, u, m),
                Ei(l, f, u, m),
                ...
                V(a.chartArea, g => {
                    let p = g.box;
                    Object.assign(p, i.chartArea), p.update(f.w, f.h, { left: 0, top: 0, right: 0, bottom: 0 });
                });
        },
    },
    js = class {
...
function Uu(i, t, e) {
    let s = i.canvas,
        n = new MutationObserver(r => {
            let o = !1;
            for (let a of r) (o = o || Us(a.addedNodes, s)), (o = o && !Us(a.removedNodes, s));
            o && e();
        });
...
function Yu(i, t, e) {
    let s = i.canvas,
        n = new MutationObserver(r => {
            let o = !1;
            for (let a of r) (o = o || Us(a.removedNodes, s)), (o = o && !Us(a.addedNodes, s));
            o && e();
        });
    return n.observe(document, { childList: !0, subtree: !0 }), n;
}
...
var br = class extends js {
    ...
    removeEventListener(t, e) {
        let s = t.$proxies || (t.$proxies = {}),
            n = s[e];
        if (!n) return;
        (({ attach: hr, detach: hr, resize: hr })[e] || $u)(t, e, n), (s[e] = void 0);
    }
    getDevicePixelRatio() {
...
function Ku(i) {
    return !Jn() || (typeof OffscreenCanvas < 'u' && i instanceof OffscreenCanvas) ? yr : br;
}
var xr = class {
    constructor() {
        this._init = [];
    ...
    _notifyStateChanges(t) {
        let e = this._oldCache || [],
            s = this._cache,
            n = (r, o) => r.filter(a => !o.some(l => a.plugin.id === l.plugin.id));
...
function td(i, { plugins: t, localIds: e }, s, n) {
    ...
    for (let a of t) {
        let l = a.id,
            c = Qu(s[l], n);
        c !== null && r.push({ plugin: a, options: ed(i.config, { plugin: a, local: e[l] }, c, o) });
    }
    return r;
}
function ed(i, { plugin: t, local: e }, s, n) {
    ...
    return (
        ...
        i.createResolver(o, n, [''], { scriptable: !1, indexable: !1, allKeys: !0 })
    );
}
function _r(i, t) {
    let e = A.datasets[i] || {};
...
function wr(i, t) {
    return i === 'x' || i === 'y' ? i : t.axis || nd(t.position) || i.charAt(0).toLowerCase();
}
function rd(i, t) {
    ...
    return (
        Object.keys(s).forEach(a => {
            let l = s[a];
            if (!F(l)) return console.error(`Invalid scale configuration for scale: ${a}`);
            if (l._proxy) return console.warn(`Ignoring resolver passed as options for scale: ${a}`);
            let c = wr(a, l),
                h = sd(c, n),
                u = e.scales || {};
            (r[c] = r[c] || a), (o[a] = Le(Object.create(null), [{ axis: c }, l, u[c], u[h]]));
        }),
        i.data.datasets.forEach(a => {
            ...
            Object.keys(u).forEach(d => {
                let f = id(d, c),
                    m = a[f + 'AxisID'] || r[f] || f;
                (o[m] = o[m] || Object.create(null)), Le(o[m], [{ axis: f }, s[m], u[d]]);
            });
        }),
...
var Di = (i, t, e) => {
    ...
    Sr = class {
        constructor(t) {
            (this._config = od(t)), (this._scopeCache = new Map()), (this._resolverCache = new Map());
        }
        get platform() {
        ...
        pluginScopeKeys(t) {
            let e = t.id,
                s = this.type;
            return Ws(`${s}-plugin-${e}`, () => [[`plugins.${e}`, ...(t.additionalOptionScopes || [])]]);
        }
        _cachedScopes(t, e) {
        ...
        getOptionScopes(t, e, s) {
            ...
            let c = Array.from(l);
            return c.length === 0 && c.push(Object.create(null)), al.has(e) && o.set(e, c), c;
        }
        chartOptionScopes() {
...
function Oa(i, t, e) {
    ...
    return (
        r ||
            ((r = { resolver: As(t, e), subPrefixes: e.filter(a => !a.toLowerCase().includes('hover')) }), s.set(n, r)),
        r
    );
}
var ad = i => F(i) && Object.getOwnPropertyNames(i).reduce((t, e) => t || zt(i[e]), !1);
function ld(i, t) {
...
function ll(i) {
    return (
        Jn() && typeof i == 'string' ? (i = document.getElementById(i)) : i && i.length && (i = i[0]),
...
var xe = class {
        constructor(t, e) {
            ...
            (this.platform = new (s.platform || Ku(n))()), this.platform.updateConfig(s);
        ...
        _initialize() {
            return (
                ...
                this.options.responsive ? this.resize() : Qn(this, this.options.devicePixelRatio),
                this.bindEvents(),
            ...
            e &&
                ...
                V(r, o => {
                    let a = o.options,
                        ...
                        c = wr(l, a),
                        h = E(a.type, o.dtype);
                    (a.position === void 0 || Da(a.position, c) !== Da(o.dposition)) && (a.position = o.dposition),
                        (n[l] = !0);
                    let u = null;
                    if (l in s && s[l].type === h) u = s[l];
                    else {
                        let d = Pt.getScale(h);
                        (u = new d({ id: l, type: h, ctx: this.ctx, chart: this })), (s[u.id] = u);
                    }
                    u.init(a, t);
                }),
                V(n, (o, a) => {
        ...
        buildOrUpdateControllers() {
            ...
            for (this._removeUnreferencedMetasets(), s = 0, n = e.length; s < n; s++) {
                ...
                if (
                    (o.type && o.type !== a && (this._destroyDatasetMeta(s), (o = this.getDatasetMeta(s))),
                    (o.type = a),
                    ...
                    let l = Pt.getController(a),
                        { datasetElementType: c, dataElementType: h } = A.datasets[a];
        ...
        _checkEventBindings() {
            let t = this.options,
                ...
                s = new Set(t.events);
            (!In(e, s) || !!this._responsiveListeners !== t.responsive) && (this.unbindEvents(), this.bindEvents());
        }
        ...
        _getUniformDataChanges() {
            ...
            let e = this.data.datasets.length,
                s = r => new Set(t.filter(o => o[0] === r).map((o, a) => a + ',' + o.splice(1).join(','))),
                n = s(0);
        ...
        updateHoverStyle(t, e, s) {
            ...
            for (
                e === 'dataset' &&
                    ((r = this.getDatasetMeta(t[0].datasetIndex)), r.controller['_' + n + 'DatasetHoverStyle']()),
                    a = 0,
                    l = t.length;
                a < l;
                ++a
        ...
        setActiveElements(t) {
            ...
            !_i(s, e) && ((this._active = s), (this._lastEvent = null), this._updateHoverStyles(s, e));
        }
        notifyPlugins(t, e, s) {
        ...
        _updateHoverStyles(t, e, s) {
            let n = this.options.hover,
                r = (l, c) => l.filter(h => !c.some(u => h.datasetIndex === u.datasetIndex && h.index === u.index)),
                o = r(e, t),
                a = s ? t : r(t, e);
        ...
        _handleEvent(t, e, s) {
            ...
            s && ((this._lastEvent = null), $(r.onHover, [t, a, this], this), l && $(r.onClick, [t, a, this], this));
            let h = !_i(a, n);
...
function hl(i, t, e) {
    let { startAngle: s, pixelMargin: n, x: r, y: o, outerRadius: a, innerRadius: l } = t,
        c = n / a;
    i.beginPath(),
        i.arc(r, o, a, s - c, e + c),
        l > n ? ((c = n / l), i.arc(r, o, l, e + c, s - c, !0)) : i.arc(r, o, n, e + U, s - U),
        i.closePath(),
        i.clip();
}
function md(i) {
...
function kr(i, t, e, s, n, r) {
    ...
    let g = Math.max(0.001, m * u - e / j) / u,
        ...
        y = l + p + f,
        b = n - p - f,
        { outerStart: _, outerEnd: w, innerStart: x, innerEnd: S } = gd(t, d, u, b - y),
        k = u - _,
        v = u - w,
        T = y + _ / k,
        C = b - w / v,
...
function yd(i, t, e) {
    let { x: s, y: n, startAngle: r, pixelMargin: o, fullCircles: a } = t,
        ...
        c = t.innerRadius + o,
        h;
    for (e && hl(i, t, r + H), i.beginPath(), i.arc(s, n, c, r + H, r, !0), h = 0; h < a; ++h) i.stroke();
...
function bd(i, t, e, s, n, r) {
    ...
    a &&
        (c ? ((i.lineWidth = a * 2), (i.lineJoin = l || 'round')) : ((i.lineWidth = a), (i.lineJoin = l || 'bevel')),
...
var qe = class extends pt {
    ...
    draw(t) {
        ...
        if (n) {
            ...
            t.translate(Math.cos(c) * a, Math.sin(c) * a), this.circumference >= j && (a = n);
        }
...
function _d(i) {
    return i.stepped ? Zo : i.tension || i.cubicInterpolationMode === 'monotone' ? qo : xd;
}
function dl(i, t, e = {}) {
    let s = i.length,
...
function wd(i, t, e, s) {
    ...
    for (f = 0; f <= c; ++f)
        (m = n[(a + (d ? c - f : f)) % o]),
            !m.skip && (u ? (i.moveTo(m.x, m.y), (u = !1)) : h(i, g, m, d, r.stepped), (g = m));
...
function kd(i) {
    return i.stepped ? sa : i.tension || i.cubicInterpolationMode === 'monotone' ? na : qt;
}
function Md(i, t, e, s) {
    let n = t._path;
    n || ((n = t._path = new Path2D()), t.path(n, e, s) && n.closePath()), ul(i, t.options), i.stroke(n);
}
function Td(i, t, e, s) {
    let { segments: n, options: r } = t,
        o = Mr(t);
    for (let a of n)
        ul(i, r, a.style), i.beginPath(), o(i, t, a, { start: e, end: e + s - 1 }) && i.closePath(), i.stroke();
}
...
var Nt = class extends pt {
    ...
    get segments() {
        return this._segments || (this._segments = oa(this, this.options.segment));
    }
    first() {
        let t = this.segments,
            e = this.points;
    ...
    draw(t, e, s, n) {
        let r = this.options || {};
        (this.points || []).length && r.borderWidth && (t.save(), Od(t, this, s, n), t.restore()),
...
Nt.defaultRoutes = { backgroundColor: 'backgroundColor', borderColor: 'borderColor' };
Nt.descriptors = { _scriptable: !0, _indexable: i => i !== 'borderDash' && i !== 'fill' };
function Fa(i, t, e, s) {
    let n = i.options,
        { [e]: r } = i.getProps([e], s);
...
Ge.defaultRoutes = { backgroundColor: 'backgroundColor', borderColor: 'borderColor' };
function fl(i, t) {
    let { x: e, y: s, base: n, width: r, height: o } = i.getProps(['x', 'y', 'base', 'width', 'height'], t),
        a,
        l,
        c,
        h,
    ...
    return (
        i.horizontal
            ? ((u = o / 2), (a = Math.min(e, n)), (l = Math.max(e, n)), (c = s - u), (h = s + u))
            : ((u = r / 2), (a = e - u), (l = e + u), (c = Math.min(s, n)), (h = Math.max(s, n))),
...
var Xe = class extends pt {
    ...
    draw(t) {
        ...
        t.save(),
            (o.w !== r.w || o.h !== r.h) &&
                (t.beginPath(), a(t, dr(o, e, r)), t.clip(), a(t, dr(r, -e, o)), (t.fillStyle = s), t.fill('evenodd')),
            t.beginPath(),
            a(t, dr(r, e)),
            (t.fillStyle = n),
            t.fill(),
    ...
    getCenterPoint(t) {
        let { x: e, y: s, base: n, horizontal: r } = this.getProps(['x', 'y', 'base', 'horizontal'], t);
...
Xe.id = 'bar';
Xe.defaults = { borderSkipped: 'start', borderWidth: 0, borderRadius: 0, inflateAmount: 'auto', pointStyle: void 0 };
Xe.defaultRoutes = { backgroundColor: 'backgroundColor', borderColor: 'borderColor' };
var Ad = Object.freeze({ __proto__: null, ArcElement: qe, LineElement: Nt, PointElement: Ge, BarElement: Xe });
function Ld(i, t, e, s, n) {
    ...
    for (o[l++] = i[h], u = 0; u < r - 2; u++) {
        ...
        let S = Math.floor(u * a) + 1 + t,
            ...
            { x: v, y: T } = i[h];
        for (f = m = -1, b = S; b < k; b++)
            (m = 0.5 * Math.abs((v - p) * (i[b].y - T) - (v - i[b].x) * (y - T))),
                m > f && ((f = m), (d = i[b]), (g = b));
        (o[l++] = d), (h = g);
    }
    return (o[l++] = i[c]), o;
...
function Pd(i, t, e, s) {
    ...
    for (o = t; o < t + e; ++o) {
        ...
        let x = l | 0;
        if (x === h) c < m ? ((m = c), (u = o)) : c > g && ((g = c), (d = o)), (n = (r * n + a.x) / ++r);
        else {
            let S = o - 1;
            if (!P(u) && !P(d)) {
                let k = Math.min(u, d),
                    v = Math.max(u, d);
                k !== f && k !== S && p.push({ ...i[k], x: n }), v !== f && v !== S && p.push({ ...i[v], x: n });
            }
            o > 0 && S !== f && p.push(i[S]), p.push(a), (h = x), (r = 0), (m = g = c), (u = d = f = o);
        }
    }
    return p;
}
    ...
    beforeElementsUpdate: (i, t, e) => {
        ...
        i.data.datasets.forEach((n, r) => {
            let { _data: o, indexAxis: a } = n,
                ...
                c = o || n.data;
            if (We([a, i.options.indexAxis]) === 'y' || !l.controller.supportsDecimation) return;
...
function Tr(i, t, e, s) {
    ...
    let n = t[i],
        r = e[i];
    return i === 'angle' && ((n = ct(n)), (r = ct(r))), { property: i, start: n, end: r };
}
function zd(i, t) {
...
function gl(i, t) {
    ...
    return (
        ...
        e.length ? new Nt({ points: e, options: { tension: 0 }, _loop: s, _fullLoop: s }) : null
    );
}
function Pa(i) {
    return i && i.fill !== !1;
...
var Zs = class {
    ...
    pathSegment(t, e, s) {
        ...
        return (e = e || { start: 0, end: H }), t.arc(n, r, o, e.end, e.start, !0), !s.bounds;
    }
    interpolate(t) {
...
function tf(i) {
    ...
    if (s.grid.circular) {
        ...
        return new Zs({ x: l.x, y: l.y, radius: t.getDistanceFromCenterForValue(o) });
    }
...
function fr(i, t, e) {
    ...
    s &&
        n.points.length &&
        (Si(i, e), ef(i, { line: n, target: s, above: h, below: u, area: e, scale: r, axis: o }), ki(i));
}
function ef(i, t) {
...
function Na(i, t, e) {
    ...
    for (let a of s) {
        let { start: l, end: c } = a,
            h = n[l],
            u = n[Dr(l, c, n)];
        r ? (i.moveTo(h.x, h.y), (r = !1)) : (i.lineTo(h.x, e), i.lineTo(h.x, h.y)),
...
var nf = {
        ...
        afterDatasetsUpdate(i, t, e) {
            ...
            for (o = 0; o < s; ++o)
                (r = i.getDatasetMeta(o)),
                    ...
                    (r.$filler = l),
                    n.push(l);
            for (o = 0; o < s; ++o) (l = n[o]), !(!l || l.fill === !1) && (l.fill = Vd(n, o, e.propagate));
        },
        beforeDraw(i, t, e) {
            ...
            for (let o = n.length - 1; o >= 0; --o) {
                let a = n[o].$filler;
                a && (a.line.updateControlPoints(r, a.axis), s && a.fill && fr(i.ctx, a, r));
            }
        },
        ...
        beforeDatasetDraw(i, t, e) {
            let s = t.meta.$filler;
            !Pa(s) || e.drawTime !== 'beforeDatasetDraw' || fr(i.ctx, s, i.chartArea);
        },
    ...
    rf = (i, t) => i !== null && t !== null && i.datasetIndex === t.datasetIndex && i.index === t.index,
    qs = class extends pt {
        constructor(t) {
            super(),
                (this._added = !1),
        ...
        _fitCols(t, e, s, n) {
            ...
            return (
                this.legendItems.forEach((p, y) => {
                    ...
                    y > 0 &&
                        f + n + 2 * a > h &&
                        ((u += d + a), c.push({ width: d, height: f }), (m += d + a), g++, (d = f = 0)),
        ...
        adjustHitBoxes() {
            ...
            if (this.isHorizontal()) {
                ...
                for (let c of e)
                    a !== c.row && ((a = c.row), (l = nt(s, this.left + n, this.right - this.lineWidths[a]))),
                        (c.top += this.top + t + n),
                        (c.left = o.leftForLtr(o.x(l), c.width)),
                        (l += c.width + n);
            } else {
                let a = 0,
                    l = nt(s, this.top + t + n, this.bottom - this.columnSizes[a].height);
                for (let c of e)
                    c.col !== a &&
                        ((a = c.col), (l = nt(s, this.top + t + n, this.bottom - this.columnSizes[a].height))),
                        (c.top = l),
                        (c.left += this.left + n),
        ...
        _draw() {
            ...
            let { boxWidth: g, boxHeight: p, itemHeight: y } = za(o, d),
                ...
                _ = function (k, v, T) {
                    Qt(n, T.text, k, v + y / 2, c, { strikethrough: T.hidden, textAlign: l.textAlign(T.textAlign) });
                },
                w = this.isHorizontal(),
                x = this._computeTitleHeight();
            w
                ? (m = { x: nt(r, this.left + u, this.right - s[0]), y: this.top + u + x, line: 0 })
                : (m = { x: this.left + u, y: nt(r, this.top + x + u, this.bottom - e[0].height), line: 0 }),
            ...
            this.legendItems.forEach((k, v) => {
                ...
                l.setWidth(this.width),
                    w
                        ? v > 0 &&
                          L + N + u > this.right &&
                          ((K = m.y += S), m.line++, (L = m.x = nt(r, this.left + u, this.right - s[m.line])))
                        : v > 0 &&
                          K + S > this.bottom &&
                          ((L = m.x = L + e[m.line].width + u),
                          m.line++,
                          (K = m.y = nt(r, this.top + x + u, this.bottom - e[m.line].height)));
                let lt = l.x(L);
                b(lt, K, k),
        ...
        drawTitle() {
            ...
            let r = pe(t.rtl, this.left, this.width),
                ...
                d = this.width;
            if (this.isHorizontal())
                (d = Math.max(...this.lineWidths)), (h = this.top + c), (u = nt(t.align, u, this.right - d));
            else {
        ...
        _getLegendItemAt(t, e) {
            ...
            if (At(t, this.left, this.right) && At(e, this.top, this.bottom)) {
                for (r = this.legendHitBoxes, s = 0; s < r.length; ++s)
                    if (((n = r[s]), At(t, n.left, n.left + n.width) && At(e, n.top, n.top + n.height)))
            ...
            labels: {
                ...
                generateLabels(i) {
                    let t = i.data.datasets,
                        {
                            labels: { usePointStyle: e, pointStyle: s, textAlign: n, color: r },
                        } = i.legend.options;
...
function Va(i, t) {
    let e = i.chart.ctx,
        ...
        g = m.height,
        p = 0,
        y = s.reduce((w, x) => w + x.before.length + x.lines.length + x.after.length, 0);
    if (
...
function ff(i, t, e, s) {
    ...
    if ((i === 'left' && n + r + o > t.width) || (i === 'right' && n - r - o < 0)) return !0;
}
function mf(i, t, e, s) {
    let { x: n, width: r } = e,
        {
...
var Pi = class extends pt {
    ...
    getContext() {
        return this.$context || (this.$context = yf(this.chart.getContext(), this, this._tooltipItems));
    }
    getTitle(t, e) {
        let { callbacks: s } = e,
    ...
    update(t, e) {
        ...
        if (!n.length) this.opacity !== 0 && (r = { opacity: 0 });
            ...
            (this.xAlign = h.xAlign),
                ...
                (r = { opacity: 1, x: u.x, y: u.y, width: l.width, height: l.height, caretX: a.x, caretY: a.y });
        }
    ...
    _drawColorBox(t, e, s, n, r) {
        let o = this.labelColors[s],
            ...
            g = e.y + m;
        if (r.usePointStyle) {
            let p = { radius: Math.min(c, l) / 2, pointStyle: a.pointStyle, rotation: a.rotation, borderWidth: 1 },
            ...
            (t.lineWidth = F(o.borderWidth) ? Math.max(...Object.values(o.borderWidth)) : o.borderWidth || 1),
                (t.strokeStyle = o.borderColor),
    ...
    drawBody(t, e, s) {
        let { body: n } = this,
            { bodySpacing: r, bodyAlign: o, displayColors: a, boxHeight: l, boxWidth: c, boxPadding: h } = s,
            u = Q(s.bodyFont),
            d = u.lineHeight,
            f = 0,
        ...
        for (
            e.textAlign = o,
                ...
                V(this.beforeBody, g),
                f = a && p !== 'right' ? (o === 'center' ? c / 2 + h : c + 2 + h) : 0,
                w = 0,
                S = n.length;
            w < S;
            ++w
            ...
            for (
                y = n[w],
                    ...
                    V(y.before, g),
                    _ = y.lines,
                    a && _.length && (this._drawColorBox(e, t, w, m, s), (d = Math.max(u.lineHeight, l))),
                    x = 0,
                    k = _.length;
                x < k;
                ++x
    ...
    drawBackground(t, e, s, n) {
        let { xAlign: r, yAlign: o } = this,
            { x: a, y: l } = t,
            { width: c, height: h } = s,
            { topLeft: u, topRight: d, bottomLeft: f, bottomRight: m } = te(n.cornerRadius);
    ...
    Ke = class extends be {
        ...
        init(t) {
            ...
            if (e.length) {
                ...
                for (let { index: n, label: r } of e) s[n] === r && s.splice(n, 1);
                this._addedLabels = [];
            }
            super.init(t);
        }
        parse(t, e) {
            if (P(t)) return null;
            let s = this.getLabels();
            return (e = isFinite(e) && s[e] === t ? e : wf(s, t, E(e, t), this._addedLabels)), Sf(e, s.length - 1);
        }
        determineDataLimits() {
...
function kf(i, t) {
    let e = [],
        { bounds: n, step: r, min: o, max: a, precision: l, count: c, maxTicks: h, maxDigits: u, includeBounds: d } = i,
        f = r || 1,
        m = h - 1,
        { min: g, max: p } = t,
        y = !P(o),
    ...
    (T = Math.ceil(p / x) - Math.floor(g / x)),
        ...
        n === 'ticks' ? ((k = Math.floor(g / x) * x), (v = Math.ceil(p / x) * x)) : ((k = g), (v = p)),
        y && b && r && Ao((a - o) / r, x / 1e3)
            ? ((T = Math.round(Math.min((a - o) / x, h))), (x = (a - o) / T), (k = o), (v = a))
            : _
              ? ((k = y ? o : k), (v = b ? a : v), (T = c - 1), (x = (v - k) / T))
              : ((T = (v - k) / x), Pe(T, Math.round(T), x / 1e3) ? (T = Math.round(T)) : (T = Math.ceil(T)));
    let C = Math.max(An(x), An(k));
    (S = Math.pow(10, P(l) ? C : l)), (k = Math.round(k * S) / S), (v = Math.round(v * S) / S);
    let N = 0;
    for (
        y &&
        (d && k !== o
            ? (e.push({ value: o }), k < o && N++, Pe(Math.round((k + N * x) * S) / S, o, Ua(o, w, i)) && N++)
            : k < o && N++);
        N < T;
        ++N
    )
...
var Je = class extends be {
        ...
        parse(t, e) {
            return P(t) || ((typeof t == 'number' || t instanceof Number) && !isFinite(+t)) ? null : +t;
        }
        handleTickRangeOptions() {
            ...
            if (n === r) {
                let l = 1;
                (r >= Number.MAX_SAFE_INTEGER || n <= Number.MIN_SAFE_INTEGER) && (l = Math.abs(r * 0.05)),
                    a(r + l),
                    t || o(n - l);
            }
...
var Ri = class extends be {
    ...
    handleTickRangeOptions() {
        ...
        s === n && (s <= 0 ? (r(1), o(10)) : (r(a(s, -1)), o(a(n, 1)))),
            s <= 0 && r(a(n, -1)),
            n <= 0 && o(a(s, 1)),
            this._zero && this.min !== this._suggestedMin && s === a(this.min, 0) && r(a(s, -1)),
            (this.min = s),
            (this.max = n);
    }
    buildTicks() {
...
Ri.id = 'logarithmic';
Ri.defaults = { ticks: { callback: Gs.formatters.logarithmic, major: { enabled: !0 } } };
function vr(i) {
    let t = i.ticks;
...
function Tf(i, t, e) {
    return (e = B(e) ? e : [e]), { w: Yo(i, t.string, e), h: e.length * t.lineHeight };
}
...
function vf(i) {
    ...
    i.setCenterPoint(t.l - e.l, e.r - t.r, t.t - e.t, e.b - t.b), (i._pointLabelItems = Df(i, s, n));
}
function Of(i, t, e, s, n) {
    ...
    s.start < t.l
        ...
        : s.end > t.r && ((a = (s.end - t.r) / r), (i.r = Math.max(i.r, t.r + a))),
        n.start < t.t
            ? ((l = (t.t - n.start) / o), (i.t = Math.min(i.t, t.t - l)))
            : n.end > t.b && ((l = (n.end - t.b) / o), (i.b = Math.max(i.b, t.b + l)));
}
function Df(i, t, e) {
    let s = [],
    ...
    for (let c = 0; c < n; c++) {
        let h = i.getPointPosition(c, a + o + e[c], l),
            ...
            m = Ef(u),
            g = If(h.x, d.w, m);
        s.push({ x: h.x, y: f, textAlign: m, left: g, top: f, right: g + d.w, bottom: f + d.h });
    }
    return s;
}
function Ef(i) {
...
function Ff(i, t) {
    ...
    for (let n = t - 1; n >= 0; n--) {
        let r = s.setContext(i.getPointLabelContext(n)),
            o = Q(r.font),
            { x: a, y: l, textAlign: c, left: h, top: u, right: d, bottom: f } = i._pointLabelItems[n],
            { backdropColor: m } = r;
        if (!P(m)) {
            ...
            Object.values(g).some(x => x !== 0)
                ? (e.beginPath(), Re(e, { x: y, y: b, w: _, h: w, radius: g }), e.fill())
                : e.fillRect(y, b, _, w);
        }
        Qt(e, i._pointLabels[n], a, l + o.lineHeight / 2, o, { color: r.color, textAlign: c, textBaseline: 'middle' });
    }
}
function pl(i, t, e, s) {
    let { ctx: n } = i;
    if (e) n.arc(i.xCenter, i.yCenter, t, 0, H);
        ...
        n.moveTo(r.x, r.y);
        for (let o = 1; o < s; o++) (r = i.getPointPosition(o, t)), n.lineTo(r.x, r.y);
    }
}
function Af(i, t, e, s) {
    let n = i.ctx,
...
var _e = class extends Je {
    ...
    drawBackground() {
        ...
        if (t) {
            ...
            s.save(),
                s.beginPath(),
                pl(this, this.getDistanceFromCenterForValue(this._endValue), e, this._pointLabels.length),
                s.closePath(),
                (s.fillStyle = t),
                s.fill(),
                s.restore();
...
function qa(i, t) {
    ...
    return (
        ...
        o === null
            ? null
            : (n && (o = n === 'week' && (ge(r) || r === !0) ? e.startOf(o, 'isoWeek', r) : e.startOf(o, n)), +o)
    );
}
function Ga(i, t, e, s) {
    let n = ht.length;
...
function Rf(i) {
    for (let t = ht.indexOf(i) + 1, e = ht.length; t < e; ++t) if (Xs[ht[t]].common) return ht[t];
}
function Xa(i, t, e) {
    if (!e) i[t] = !0;
    else if (e.length) {
...
function Wf(i, t, e, s) {
    let n = i._adapter,
        ...
        a,
        l;
    for (a = r; a <= o; a = +n.add(a, 1, s)) (l = e[a]), l >= 0 && (t[l].major = !0);
    return t;
}
function Ka(i, t, e) {
    let s = [],
        ...
        o,
        a;
    for (o = 0; o < r; ++o) (a = t[o]), (n[a] = o), s.push({ value: a, major: !1 });
...
var we = class extends be {
    ...
    determineDataLimits() {
        let t = this.options,
            e = this._adapter,
            s = t.time.unit || 'day',
            { min: n, max: r, minDefined: o, maxDefined: a } = this.getUserBounds();
        function l(c) {
    ...
    buildTicks() {
        ...
        return (
            (this._unit =
                e.unit ||
                (s.autoSkip
                    ? Ga(e.minUnit, this.min, this.max, this._getLabelCapacity(r))
                    : Nf(this, a.length, e.minUnit, this.min, this.max))),
            (this._majorUnit = !s.major.enabled || this._unit === 'year' ? void 0 : Rf(this._unit)),
            this.initOffsets(n),
            t.reverse && a.reverse(),
    ...
    initOffsets(t) {
        ...
        this.options.offset &&
            ...
            t.length === 1 ? (s = r) : (s = (r - this.getDecimalForValue(t[t.length - 2])) / 2));
        let o = t.length < 3 ? 0.5 : 0.25;
        (e = tt(e, 0, o)), (s = tt(s, 0, o)), (this._offsets = { start: e, end: s, factor: 1 / (e + 1 + s) });
    }
    _generate() {
        let t = this._adapter,
            e = this.min,
    ...
    _getLabelCapacity(t) {
        let e = this.options.time,
            ...
            r = this._tickFormatFunction(t, 0, Ka(this, [t], this._majorUnit), n),
...
function Hs(i, t, e) {
    let s = 0,
        ...
        l;
    e
        ? (t >= i[s].pos && t <= i[n].pos && ({ lo: s, hi: n } = Ct(i, 'pos', t)),
          ({ pos: r, time: a } = i[s]),
          ({ pos: o, time: l } = i[n]))
        : (t >= i[s].time && t <= i[n].time && ({ lo: s, hi: n } = Ct(i, 'time', t)),
          ({ time: r, pos: a } = i[s]),
          ({ time: o, pos: l } = i[n]));
    let c = o - r;
...
var Wi = class extends we {
    ...
    initOffsets() {
        ...
        (this._minPos = Hs(e, this.min)), (this._tableRange = Hs(e, this.max) - this._minPos), super.initOffsets(t);
    }
    buildLookupTable(t) {
        let { min: e, max: s } = this,
            ...
            c,
            h;
        for (o = 0, a = t.length; o < a; ++o) (c = t[o]), c >= e && c <= s && n.push(c);
        if (n.length < 2)
            return [
                { time: e, pos: 0 },
                { time: s, pos: 1 },
        ...
        for (o = 0, a = n.length; o < a; ++o)
            (h = n[o + 1]),
                (l = n[o - 1]),
                (c = n[o]),
                Math.round((h + l) / 2) !== c && r.push({ time: c, pos: o / (a - 1) });
        return r;
    }
...
var M = 'numeric',
    ...
    is = { year: M, month: yt, day: M, hour: M, minute: M, second: M, timeZoneName: Ot },
    ss = { year: M, month: yt, day: M, weekday: yt, hour: M, minute: M, timeZoneName: yt },
    ns = { year: M, month: yt, day: M, weekday: yt, hour: M, minute: M, second: M, timeZoneName: yt };
var ut = class {
    get type() {
        throw new vt();
    }
...
var sn = {},
    at = class i extends ut {
        ...
        offset(t) {
            ...
            a === 'BC' && (n = -Math.abs(n) + 1);
            let d = ti({ year: n, month: r, day: o, hour: l === 24 ? 0 : l, minute: c, second: h, millisecond: 0 }),
                f = +e,
                m = f % 1e3;
...
function Xf(i, t, e) {
    return (e || t) && (i.includes('-u-') || (i += '-u'), e && (i += `-ca-${e}`), t && (i += `-nu-${t}`)), i;
}
function Kf(i) {
    let t = [];
    for (let e = 1; e <= 12; e++) {
...
function Qf(i) {
    return i.numberingSystem && i.numberingSystem !== 'latn'
        ...
        : i.numberingSystem === 'latn' ||
              ...
              new Intl.DateTimeFormat(i.intl).resolvedOptions().numberingSystem === 'latn';
}
var Nr = class {
        constructor(t, e, s) {
            ...
            if (!e || Object.keys(o).length > 0) {
                ...
                s.padTo > 0 && (a.minimumIntegerDigits = s.padTo), (this.inf = Uf(t, a));
            }
        }
        format(t) {
            if (this.inf) {
    ...
    Wr = class {
        constructor(t, e, s) {
            (this.opts = { style: 'long', ...s }), !e && on() && (this.rtf = Yf(t, s));
        }
        format(t, e) {
            return this.rtf ? this.rtf.format(t, e) : _l(e, t, this.opts.numeric, this.opts.style !== 'long');
        }
        formatToParts(t, e) {
    ...
    W = class i {
        static fromOpts(t) {
            return i.create(t.locale, t.numberingSystem, t.outputCalendar, t.weekSettings, t.defaultToEN);
        }
        ...
        static fromObject({ locale: t, numberingSystem: e, outputCalendar: s, weekSettings: n } = {}) {
        ...
        constructor(t, e, s, n, r) {
            ...
            (this.locale = o),
                ...
                (this.weekSettings = n),
                (this.intl = Xf(this.locale, this.numberingSystem, this.outputCalendar)),
        ...
        get fastNumbers() {
            return this.fastNumbersCached == null && (this.fastNumbersCached = Qf(this)), this.fastNumbersCached;
        }
        listingMode() {
        ...
        months(t, e = !1) {
            return rn(this, t, zr, () => {
                ...
                return (
                    this.monthsCache[n][t] || (this.monthsCache[n][t] = Kf(r => this.extract(r, s, 'month'))),
        ...
        weekdays(t, e = !1) {
            return rn(this, t, Vr, () => {
                let s = e ? { weekday: t, year: 'numeric', month: 'long', day: 'numeric' } : { weekday: t },
                    n = e ? 'format' : 'standalone';
                return (
                    this.weekdaysCache[n][t] || (this.weekdaysCache[n][t] = Jf(r => this.extract(r, s, 'weekday'))),
            ...
            return rn(
                ...
                () => {
                    if (!this.meridiemCache) {
                        ...
                        this.meridiemCache = [I.utc(2016, 11, 13, 9), I.utc(2016, 11, 13, 19)].map(e =>
        ...
        eras(t) {
            return rn(this, t, Br, () => {
                ...
                return (
                    this.eraCache[t] ||
                        (this.eraCache[t] = [I.utc(-40, 1, 1), I.utc(2017, 1, 1)].map(s => this.extract(s, e, 'era'))),
                    this.eraCache[t]
                );
            });
        }
        ...
        getWeekSettings() {
            return this.weekSettings ? this.weekSettings : an() ? qf(this.locale) : tm;
        }
        getStartOfWeek() {
...
function Dt(i, t) {
    ...
    if (wl(i)) {
        ...
        return Et(i)
            ? et.instance(i)
            : typeof i == 'object' && 'offset' in i && typeof i.offset == 'function'
              ? i
              : new ii(i);
}
var Ur = {
...
function wt({ numberingSystem: i }, t = '') {
    let e = i || 'latn';
    return si[e] || (si[e] = {}), si[e][t] || (si[e][t] = new RegExp(`${Ur[e]}${t}`)), si[e][t];
}
var Tl = () => Date.now(),
    vl = 'system',
    Ol = null,
...
function St(i, t) {
    return new it('unit out of range', `you specified ${t} (of type ${typeof t}) as a ${i}, which is invalid`);
}
function ln(i, t, e) {
...
function as(i, t = 4, e = 1) {
    let { year: s, month: n, day: r } = i,
        ...
        c;
    return (
        l < 1 ? ((c = s - 1), (l = ke(c, t, e))) : l > ke(s, t, e) ? ((c = s + 1), (l = 1)) : (c = s),
...
function Yr(i, t = 4, e = 1) {
    let { weekYear: s, weekNumber: n, weekday: r } = i,
        ...
        l = n * 7 + r - o - 7 + t,
        c;
    l < 1 ? ((c = s - 1), (l += le(c))) : l > a ? ((c = s + 1), (l -= le(s))) : (c = s);
...
function qr(i, t) {
    if (!O(i.localWeekday) || !O(i.localWeekNumber) || !O(i.localWeekYear)) {
        if (!O(i.weekday) || !O(i.weekNumber) || !O(i.weekYear))
            throw new Tt('Cannot mix locale-based week fields with ISO-based week fields');
        return (
...
function Rl(i, t = 4, e = 1) {
    let s = ls(i.weekYear),
        ...
        r = bt(i.weekday, 1, 7);
    return s ? (n ? (r ? !1 : St('weekday', i.weekday)) : St('week', i.weekNumber)) : St('weekYear', i.weekYear);
}
function Wl(i) {
    let t = ls(i.year),
...
function Gr(i) {
    ...
    return t ? (e ? (s ? !1 : St('day', i.day)) : St('month', i.month)) : St('year', i.year);
}
function Xr(i) {
    let { hour: t, minute: e, second: s, millisecond: n } = i,
        ...
        a = bt(s, 0, 59),
        l = bt(n, 0, 999);
    return r ? (o ? (a ? (l ? !1 : St('millisecond', n)) : St('second', s)) : St('minute', e)) : St('hour', t);
}
function O(i) {
    return typeof i > 'u';
}
...
function os(i) {
    ...
    return { firstDay: i.firstDay, minimalDays: i.minimalDays, weekend: Array.from(i.weekend) };
}
function bt(i, t, e) {
    return ls(i) && i >= t && i <= e;
}
...
function Y(i, t = 2) {
    let e = i < 0,
        s;
    return e ? (s = '-' + ('' + -i).padStart(t, '0')) : (s = ('' + i).padStart(t, '0')), s;
}
function Ut(i) {
...
function ni(i, t) {
    let e = im(t - 1, 12) + 1,
        s = i + (t - e) / 12;
    return e === 2 ? (Me(s) ? 29 : 28) : [31, null, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][e - 1];
}
function ti(i) {
    let t = Date.UTC(i.year, i.month - 1, i.day, i.hour, i.minute, i.second, i.millisecond);
    return i.year < 100 && i.year >= 0 && ((t = new Date(t)), t.setUTCFullYear(i.year, i.month - 1, i.day)), +t;
}
function zl(i, t, e) {
...
function en(i, t, e, s = null) {
    let n = new Date(i),
        r = { hourCycle: 'h23', year: 'numeric', month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit' };
    s && (r.timeZone = s);
    let o = { timeZoneName: t, ...r },
        a = new Intl.DateTimeFormat(e, o).formatToParts(n).find(l => l.type.toLowerCase() === 'timezonename');
...
function Jr(i) {
    let t = Number(i);
    if (typeof i == 'boolean' || i === '' || Number.isNaN(t)) throw new G(`Invalid unit value ${i}`);
    return t;
}
function ri(i, t) {
    let e = {};
...
var sm = [
    ...
    Qr = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
...
var to = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'],
    ...
    st = class i {
        ...
        static parseFormat(t) {
            ...
            for (let o = 0; o < t.length; o++) {
                let a = t.charAt(o);
                a === "'"
                    ? (s.length > 0 && r.push({ literal: n || /^\s+$/.test(s), val: s }),
                      (e = null),
                      (s = ''),
                      (n = !n))
                    : n || a === e
                      ? (s += a)
                      : (s.length > 0 && r.push({ literal: /^\s+$/.test(s), val: s }), (s = a), (e = a));
            }
            return s.length > 0 && r.push({ literal: n || /^\s+$/.test(s), val: s }), r;
        }
                ...
                o = f =>
                    t.isOffsetFixed && t.offset === 0 && f.allowZ
                        ...
                        : t.isValid
                          ...
                          : '',
                a = () => (s ? $l(t) : r({ hour: 'numeric', hourCycle: 'h12' }, 'dayperiod')),
                l = (f, m) => (s ? Ul(t, f) : r(m ? { month: f } : { month: f, day: 'numeric' }, 'month')),
                c = (f, m) =>
                    s ? jl(t, f) : r(m ? { weekday: f } : { weekday: f, month: 'long', day: 'numeric' }, 'weekday'),
                h = f => {
                ...
                d = f => {
                    switch (f) {
                        ...
                        case 'EEEEE':
                            return c('narrow', !1);
                        case 'L':
                            return n ? r({ month: 'numeric', day: 'numeric' }, 'month') : this.num(t.month);
                        case 'LL':
                            return n ? r({ month: '2-digit', day: 'numeric' }, 'month') : this.num(t.month, 2);
                        case 'LLL':
                            return l('short', !0);
                        case 'LLLL':
                            return l('long', !0);
                        ...
                        case 'yy':
                            return n ? r({ year: '2-digit' }, 'year') : this.num(t.year.toString().slice(-2), 2);
                        case 'yyyy':
        ...
        formatDurationFromString(t, e) {
            let s = l => {
                ...
                r = i.parseFormat(e),
                o = r.reduce((l, { literal: c, val: h }) => (c ? l : l.concat(h)), []),
                a = t.shiftTo(...o.map(s).filter(l => l));
            return Zl(r, n(a));
        }
    };
var Gl = /[A-Za-z_+-]{1,256}(?::?\/[A-Za-z0-9_+-]{1,256}(?:\/[A-Za-z0-9_+-]{1,256})?)?/;
function ai(...i) {
...
function bm(i, t) {
    return [{ year: oi(i, t), month: oi(i, t + 1, 1), day: oi(i, t + 2, 1) }, null, t + 3];
}
function hi(i, t) {
    return [
        { hours: oi(i, t, 0), minutes: oi(i, t + 1, 0), seconds: oi(i, t + 2, 0), milliseconds: hs(i[t + 3]) },
        null,
        t + 4,
    ];
}
...
function no(i, t, e, s, n, r, o) {
    ...
    return o && (a.second = Ut(o)), i && (a.weekday = i.length > 3 ? to.indexOf(i) + 1 : eo.indexOf(i) + 1), a;
}
var km =
...
var ac = 'Invalid Duration',
    ...
    Te = ['years', 'quarters', 'months', 'weeks', 'days', 'hours', 'minutes', 'seconds', 'milliseconds'],
...
var Z = class i {
    ...
    static fromISO(t, e) {
        let [s] = nc(t);
        return s ? i.fromObject(s, e) : i.invalid('unparsable', `the input "${t}" can't be parsed as ISO 8601`);
    }
    ...
    toFormat(t, e = {}) {
        ...
        return this.isValid ? st.create(this.loc, s).formatDurationFromString(this, t) : ac;
    }
    toHuman(t = {}) {
        ...
        let e = Te.map(s => {
            ...
            return O(n)
                ? null
                : this.loc
                      .numberFormatter({ style: 'unit', unitDisplay: 'long', ...t, unit: s.slice(0, -1) })
                      .format(n);
        }).filter(s => s);
    ...
    plus(t) {
        ...
        let e = i.fromDurationLike(t),
            s = {};
        for (let n of Te) (ce(e.values, n) || ce(this.values, n)) && (s[n] = e.get(n) + this.get(n));
    ...
    reconfigure({ locale: t, numberingSystem: e, conversionAccuracy: s, matrix: n } = {}) {
        let o = { loc: this.loc.clone({ locale: t, numberingSystem: e }), matrix: n, conversionAccuracy: s };
        return ue(this, o);
    }
    as(t) {
    ...
    shiftTo(...t) {
        ...
        for (let o in s) s[o] !== 0 && (e[r] += o === r ? s[o] : s[o] / this.matrix[r][o]);
...
var Yt = class i {
    ...
    static fromISO(t, e) {
        ...
        return i.invalid('unparsable', `the input "${t}" can't be parsed as ISO 8601`);
    }
    static isInterval(t) {
    ...
    count(t = 'milliseconds', e) {
        ...
        let s = this.start.startOf(t, e),
            n;
        return (
            e?.useLocaleWeeks ? (n = this.end.reconfigure({ locale: s.locale })) : (n = this.end),
            (n = n.startOf(t, e)),
            Math.floor(n.diff(s, t).get(t)) + (n.valueOf() !== this.end.valueOf())
        );
    }
    hasSame(t) {
    ...
    splitBy(t) {
        ...
        for (; s < this.e; ) {
            ...
            (r = +a > +this.e ? this.e : a), o.push(i.fromDateTimes(s, r)), (s = r), (n += 1);
        }
        return o;
    }
    divideEqually(t) {
    ...
    static merge(t) {
        let [e, s] = t
            .sort((n, r) => n.s - r.s)
            .reduce(
                ([n, r], o) => (r ? (r.overlaps(o) || r.abutsStart(o) ? [n, r.union(o)] : [n.concat([r]), o]) : [n, o]),
                [[], null]
            );
        return s && e.push(s), e;
    }
    static xor(t) {
        ...
        for (let l of a)
            (s += l.type === 's' ? 1 : -1),
                s === 1 ? (e = l.time) : (e && +e != +l.time && n.push(i.fromDateTimes(e, l.time)), (e = null));
        return i.merge(n);
    }
    difference(...t) {
        return i
    ...
    toString() {
        return this.isValid ? `[${this.s.toISO()} \u2013 ${this.e.toISO()})` : di;
    }
    [Symbol.for('nodejs.util.inspect.custom')]() {
        return this.isValid
    ...
    toLocaleString(t = re, e = {}) {
        return this.isValid ? st.create(this.s.loc.clone(e), t).formatInterval(this) : di;
    }
    toISO(t) {
    ...
    toISOTime(t) {
        return this.isValid ? `${this.s.toISOTime(t)}/${this.e.toISOTime(t)}` : di;
    }
    toFormat(t, { separator: e = ' \u2013 ' } = {}) {
        return this.isValid ? `${this.s.toFormat(t)}${e}${this.e.toFormat(t)}` : di;
    }
    toDuration(t, e) {
        return this.isValid ? this.e.diff(this.s, t, e) : Z.invalid(this.invalidReason);
    }
    mapEndpoints(t) {
...
var Zt = class {
    ...
    static months(
        t = 'long',
        { locale: e = null, numberingSystem: s = null, locObj: n = null, outputCalendar: r = 'gregory' } = {}
    ) {
    ...
    static weekdays(t = 'long', { locale: e = null, numberingSystem: s = null, locObj: n = null } = {}) {
        return (n || W.create(e, s, null)).weekdays(t);
    }
    static weekdaysFormat(t = 'long', { locale: e = null, numberingSystem: s = null, locObj: n = null } = {}) {
...
function Ym(i, t, e) {
    ...
    for (let [l, c] of s)
        e.indexOf(l) >= 0 &&
            ...
            (n[l] = c(i, t)),
            (a = r.plus(n)),
            a > t ? (n[l]--, (i = r.plus(n)), i > t && ((a = i), n[l]--, (i = r.plus(n)))) : (i = a));
    return [i, n, a, o];
}
function dc(i, t, e, s) {
    ...
    c.length === 0 && (o < t && (o = n.plus({ [a]: 1 })), o !== n && (r[a] = (r[a] || 0) + l / (o - n)));
...
function It(i, t) {
    return i === null
        ? null
        : { regex: RegExp(i.map(Gm).join('|')), deser: ([e]) => i.findIndex(s => fc(e) === fc(s)) + t };
}
function mc(i, t) {
...
function Km(i, t) {
    let e = wt(t),
        ...
        u = wt(t, '{2,4}'),
        d = wt(t, '{4,6}'),
        f = p => ({ regex: RegExp(Xm(p.val)), deser: ([y]) => y, literal: !0 }),
        g = (p => {
...
function tg(i) {
    return [`^${i.map(e => e.regex).reduce((e, s) => `${e}(${s.source})`, '')}$`, i];
}
function eg(i, t, e) {
    let s = i.match(t);
    if (s) {
        ...
        for (let o in e)
            if (ce(e, o)) {
                ...
                !a.literal && a.token && (n[a.token.val[0]] = a.deser(s.slice(r, r + l))), (r += l);
            }
        return [s, n];
    } else return [s, {}];
}
function ig(i) {
    ...
    return (
        ...
        O(i.q) || (i.M = (i.q - 1) * 3 + 1),
        O(i.h) || (i.h < 12 && i.a === 1 ? (i.h += 12) : i.h === 12 && i.a === 0 && (i.h = 0)),
        i.G === 0 && i.y && (i.y = -i.y),
        O(i.u) || (i.S = hs(i.u)),
        [
...
var ms = class {
    ...
    explainFromTokens(t) {
        if (this.isValid) {
            ...
            if (ce(s, 'a') && ce(s, 'H')) throw new Tt("Can't include meridiem when specifying 24-hour format");
            return {
                input: t,
                tokens: this.tokens,
                regex: this.regex,
...
function yc(i, t, e) {
    let { result: s, zone: n, specificOffset: r, invalidReason: o } = ao(i, t, e);
    return [s, n, r, o];
}
function lo(i, t) {
    if (!i) return null;
...
function uo(i) {
    return (
        i.localWeekData === null && (i.localWeekData = as(i.c, i.loc.getMinDaysInFirstWeek(), i.loc.getStartOfWeek())),
        i.localWeekData
    );
}
function ve(i, t) {
    let e = { ts: i.ts, zone: i.zone, c: i.c, o: i.o, loc: i.loc, invalid: i.invalid };
...
function xc(i, t) {
    let e = i.o,
        ...
        r = {
            ...
            year: s,
            month: n,
            day: Math.min(i.c.day, ni(s, n)) + Math.trunc(t.days) + Math.trunc(t.weeks) * 7,
        },
        o = Z.fromObject({
...
function mi(i, t, e, s, n, r) {
    ...
    } else return I.invalid(new it('unparsable', `the input "${n}" can't be parsed as ${s}`));
}
function fn(i, t, e = !0) {
    return i.isValid
        ? st.create(W.create('en-US'), { allowZ: e, forceSimple: !0 }).formatDateTimeFromString(i, t)
        : null;
}
function fo(i, t) {
    ...
    return (
        e && i.c.year >= 0 && (s += '+'),
        (s += Y(i.c.year, e ? 6 : 4)),
        t ? ((s += '-'), (s += Y(i.c.month)), (s += '-'), (s += Y(i.c.day))) : ((s += Y(i.c.month)), (s += Y(i.c.day))),
        s
    );
}
function _c(i, t, e, s, n, r) {
    ...
    return (
        t
            ? ((o += ':'), (o += Y(i.c.minute)), (i.c.millisecond !== 0 || i.c.second !== 0 || !e) && (o += ':'))
            : (o += Y(i.c.minute)),
        (i.c.millisecond !== 0 || i.c.second !== 0 || !e) &&
            ((o += Y(i.c.second)), (i.c.millisecond !== 0 || !s) && ((o += '.'), (o += Y(i.c.millisecond, 3)))),
        n &&
            (i.isOffsetFixed && i.offset === 0 && !r
                ? (o += 'Z')
                : i.o < 0
                  ? ((o += '-'), (o += Y(Math.trunc(-i.o / 60))), (o += ':'), (o += Y(Math.trunc(-i.o % 60))))
                  : ((o += '+'), (o += Y(Math.trunc(i.o / 60))), (o += ':'), (o += Y(Math.trunc(i.o % 60))))),
        r && (o += '[' + i.zone.ianaName + ']'),
        o
    );
...
var vc = { month: 1, day: 1, hour: 0, minute: 0, second: 0, millisecond: 0 },
    rg = { weekNumber: 1, weekday: 1, hour: 0, minute: 0, second: 0, millisecond: 0 },
...
function hg(i) {
    return pn[i] || (gn === void 0 && (gn = R.now()), (pn[i] = i.offset(gn))), pn[i];
}
function Sc(i, t) {
...
function kc(i, t, e) {
    let s = O(e.round) ? !0 : e.round,
        n = (o, a) => ((o = ei(o, s || e.calendary ? 0 : 2, !0)), t.loc.clone(e).relFormatter(e).format(o, a)),
        r = o =>
            e.calendary ? (t.hasSame(i, o) ? 0 : t.startOf(o).diff(i.startOf(o), o).get(o)) : t.diff(i, o).get(o);
    ...
    I = class i {
        constructor(t) {
            let e = t.zone || R.defaultZone,
                s = t.invalid || (Number.isNaN(t.ts) ? new it('invalid input') : null) || (e.isValid ? null : gs(e));
        ...
        static local() {
            let [t, e] = Mc(arguments),
                [s, n, r, o, a, l, c] = e;
            return Sc({ year: s, month: n, day: r, hour: o, minute: a, second: l, millisecond: c }, t);
        }
        static utc() {
            let [t, e] = Mc(arguments),
                [s, n, r, o, a, l, c] = e;
            return (
                ...
                Sc({ year: s, month: n, day: r, hour: o, minute: a, second: l, millisecond: c }, t)
            );
        }
        static fromJSDate(t, e = {}) {
            ...
            return n.isValid ? new i({ ts: s, zone: n, loc: W.fromObject(e) }) : i.invalid(gs(n));
        }
        static fromMillis(t, e = {}) {
            if (Et(t))
                return t < -bc || t > bc
                    ? i.invalid('Timestamp out of range')
                    : new i({ ts: t, zone: Dt(e.zone, R.defaultZone), loc: W.fromObject(e) });
            throw new G(`fromMillis requires a numerical input, but received a ${typeof t} with value ${t}`);
        }
        static fromSeconds(t, e = {}) {
            if (Et(t)) return new i({ ts: t * 1e3, zone: Dt(e.zone, R.defaultZone), loc: W.fromObject(e) });
        ...
        static fromObject(t, e = {}) {
            ...
            if ((f || h) && m) throw new Tt("Can't mix weekYear/weekNumber units with year/month/day or ordinals");
            if (d && h) throw new Tt("Can't mix ordinal dates with month/day");
            let g = m || (r.weekday && !f),
                p,
                y,
                b = dn(l, c);
            g ? ((p = ag), (y = rg), (b = as(b, o, a))) : h ? ((p = lg), (y = og), (b = hn(b))) : ((p = Oc), (y = vc));
            let _ = !1;
            for (let C of p) {
                let N = r[C];
        ...
        static fromFormat(t, e, s = {}) {
            if (O(t) || O(e)) throw new G('fromFormat requires an input string and a format');
            let { locale: n = null, numberingSystem: r = null } = s,
                o = W.fromOpts({ locale: n, numberingSystem: r, defaultToEN: !0 }),
                [a, l, c, h] = yc(o, t, e);
        ...
        get weeksInLocalWeekYear() {
            return this.isValid
                ? ke(this.localWeekYear, this.loc.getMinDaysInFirstWeek(), this.loc.getStartOfWeek())
                : NaN;
        }
        resolvedLocaleOptions(t = {}) {
            let { locale: e, numberingSystem: s, calendar: n } = st.create(this.loc.clone(t), t).resolvedOptions(this);
        ...
        reconfigure({ locale: t, numberingSystem: e, outputCalendar: s } = {}) {
            let n = this.loc.clone({ locale: t, numberingSystem: e, outputCalendar: s });
        ...
        set(t) {
            ...
            if ((c || o) && h) throw new Tt("Can't mix weekYear/weekNumber units with year/month/day or ordinals");
            if (l && o) throw new Tt("Can't mix ordinal dates with month/day");
            let u;
            r
                ? (u = Yr({ ...as(this.c, s, n), ...e }, s, n))
                : O(e.ordinal)
                  ? ((u = { ...this.toObject(), ...e }), O(e.day) && (u.day = Math.min(ni(u.year, u.month), u.day)))
                  : (u = Zr({ ...hn(this.c), ...e }));
        ...
        toFormat(t, e = {}) {
            return this.isValid ? st.create(this.loc.redefaultToEN(e)).formatDateTimeFromString(this, t) : co;
        }
        toLocaleString(t = re, e = {}) {
            return this.isValid ? st.create(this.loc.clone(e), t).formatDateTime(this) : co;
        }
        toLocaleParts(t = {}) {
        ...
        toISOTime({
            ...
            return this.isValid ? (n ? 'T' : '') + _c(this, o === 'extended', e, t, s, r) : null;
        }
        toRFC2822() {
        ...
        toSQLTime({ includeOffset: t = !0, includeZone: e = !1, includeOffsetSpace: s = !0 } = {}) {
            let n = 'HH:mm:ss.SSS';
            return (e || t) && (s && (n += ' '), e ? (n += 'z') : t && (n += 'ZZ')), fn(this, n, !0);
        }
        toSQL(t = {}) {
        ...
        diff(t, e = 'milliseconds', s = {}) {
            if (!this.isValid || !t.isValid) return Z.invalid('created by diffing an invalid DateTime');
            let n = { locale: this.locale, numberingSystem: this.numberingSystem, ...s },
        ...
        toRelative(t = {}) {
            ...
            return (
                ...
                kc(e, this.plus(s), { ...t, numeric: 'always', units: n, unit: r })
            );
        }
        ...
        static min(...t) {
            if (!t.every(i.isDateTime)) throw new G('min requires all arguments be DateTimes');
            return Kr(t, e => e.valueOf(), Math.min);
        }
        static max(...t) {
            if (!t.every(i.isDateTime)) throw new G('max requires all arguments be DateTimes');
        ...
        static buildFormatParser(t, e = {}) {
            let { locale: s = null, numberingSystem: n = null } = e,
                r = W.fromOpts({ locale: s, numberingSystem: n, defaultToEN: !0 });
            return new ms(r, t);
        }
        static fromFormatParser(t, e, s = {}) {
            if (O(t) || O(e)) throw new G('fromFormatParser requires an input string and a format parser');
            let { locale: n = null, numberingSystem: r = null } = s,
                o = W.fromOpts({ locale: n, numberingSystem: r, defaultToEN: !0 });
            ...
            let { result: a, zone: l, specificOffset: c, invalidReason: h } = e.explainFromTokens(t);
        ...
        return i === null || s === 'undefined'
            ...
            : (s === 'number'
                  ...
                  : s === 'string'
                    ...
                    : i instanceof Date
                      ? (i = I.fromJSDate(i, e))
                      : s === 'object' && !(i instanceof I) && (i = I.fromObject(i, e)),
    ...
    return {
        init: function () {
            this.initChart(),
                ...
                Alpine.effect(() => {
                    Alpine.store('theme'),
                        this.$nextTick(() => {
                            this.getChart() && (this.getChart().destroy(), this.initChart());
                        });
                }),
        ...
        initChart: function (s = null) {
            ...
            (Rt.defaults.animation.duration = 0),
                (Rt.defaults.backgroundColor = getComputedStyle(this.$refs.backgroundColorElement).color);
            let n = getComputedStyle(this.$refs.borderColorElement).color;
            (Rt.defaults.borderColor = n),
                (Rt.defaults.color = getComputedStyle(this.$refs.textColorElement).color),
                (Rt.defaults.font.family = getComputedStyle(this.$el).fontFamily),
