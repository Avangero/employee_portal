...
function rn(i, t, e, s) {
    ...
    for (l = 0; l < r; l++)
        ...
        else if (I(d)) for (c = 0, h = d.length; c < h; c++) (u = d[c]), u != null && !I(u) && (a = pe(i, n, o, a, u));
    i.restore();
    let f = o.length / 2;
    if (f > e.length) {
...
var te = class extends et {
    ...
    _calculateBarValuePixels(t) {
        ...
        u !== h && ((d = u - h), (u = h)),
            c &&
                ((h = l.barStart), (u = l.barEnd - l.barStart), h !== 0 && ot(h) !== ot(l.barEnd) && (d = 0), (d += h));
        let p = !T(n) && !c ? n : d,
...
function Hn(i, t, e) {
    ...
    return (
        o ||
            ((o = { resolver: Qe(t, e), subPrefixes: e.filter(r => !r.toLowerCase().includes('hover')) }), s.set(n, o)),
        o
    );
}
